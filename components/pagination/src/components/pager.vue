<template>
  <ul :class="nsPager.b()" @click="onPagerClick" @keyup.enter="onEnter">
    <li
      ...
      aria-label="currentPage pager: 1"
      :tabindex="tabindex"
    >
      1
    </li>
    <li
      ...
      :class="prevMoreKls"
      :tabindex="tabindex"
      aria-label="prevPages pager: pagerCount - 2"
    ...
    <li
      ...
      :aria-label="`currentPage pager: ${pager}`"
      :tabindex="tabindex"
    >
      {{ pager }}
    </li>
    <li
      ...
      :class="nextMoreKls"
      :tabindex="tabindex"
      :aria-label="`nextPages pager: ${pagerCount - 2}`"
    ...
    <li
      ...
      :aria-label="`currentPage pager: ${pageCount}`"
      :tabindex="tabindex"
    >
      {{ pageCount }}
    </li>
