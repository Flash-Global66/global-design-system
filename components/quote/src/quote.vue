  ...
  <div :class="ns.b()">
    ...
    <div :class="ns.e('card-group')">
      <div
        :class="[
          ns.e('card'),
          ns.is('error', hasCardError),
          ns.is('error-with-action', shouldShowAction),
        ]"
      >
        <div v-if="!singleInput" :class="ns.e('input-from')">
          <quote-input
            :label="fromLabel"
            :value="fromAmount"
        ...
        <div v-if="!singleInput && showSwap" :class="ns.e('divider')">
          ...
          >
            <span
              :class="ns.e('swap-icon')"
              :style="{ transform: swapTransform }"
            >
      ...
      <p v-if="errorMessage" :class="ns.e('error-message')">
        {{ errorMessage }}
      </p>
    </div>
  </div>
