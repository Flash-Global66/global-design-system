...
/**
 * Arma los métodos imperativos que la tabla expone al consumidor (`setCurrentRow`,
 * `clearSelection`, `sort`…). No guarda estado propio: cada uno delega en el store.
 */
export function createTableMethods<T>(store: Store<T>) {
