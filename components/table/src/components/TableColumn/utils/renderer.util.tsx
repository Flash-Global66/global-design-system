...
// @ts-nocheck
// h() y no un .vue: el renderer lo elige `column.type`/`cellType` en runtime y lo consume
// `column.renderHeader`/`column.renderCell`, un contrato de función heredado de Element Plus.
import { h } from 'vue';
import {
  getProp,
  isBoolean,
...
import type { TreeNode } from '../../../shared/types/table.type';
