  ...
  >
    ...
    >
      <slot name="decrease-icon">
        <GIconFont v-if="controlsAtRight" name="regular chevron-down" />
        <GIconFont v-else name="regular minus" />
      </slot>
    </span>
    <span
      v-if="controls"
    ...
    >
      <slot name="increase-icon">
        <GIconFont v-if="controlsAtRight" name="regular chevron-up" />
        <GIconFont v-else name="regular plus" />
      </slot>
    </span>
    <GInput
      :id="id"
