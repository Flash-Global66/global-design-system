import{d as ne,r as I,H as le,c as d,x as b,w as V,e as h,m as q,s as B,u,l as x,k as A,n as me,F as ce,z as de,A as pe,y as F,t as ge,o as ue}from"./vue.esm-bundler-C43JrhH2.js";import{I as E,_ as z,a as v}from"./Image-Bg-hllqb.js";import{u as fe,Y as xe,G as ve,H as ye}from"./index-DH2w0SzE.js";import{b as be,a as he}from"./index-BDKGuxIf.js";import{f as Ie}from"./install-CfJGiCvs.js";import{u as Ee}from"./index-CdSB2Bdf.js";import{u as Se}from"./index-D5bIuBCX.js";import{U as R,C as X}from"./event-BB_Ol6Sd.js";import{r as ze}from"./index-CA6S_qzr.js";import{y as Ge}from"./index-C3gUrHC2.js";import{F as Ae}from"./index-B1PxvDbZ.js";import{G as T}from"./ConfigProvider-Br84NlF7.js";import"./error-Cq9Fpw4b.js";import"./index-fhkPmQjX.js";import"./index-DmfABaPz.js";import"./_arrayPush-BhjrZnJY.js";import"./index-BjhK0CHr.js";import"./index-D_xYoXKA.js";import"./index-Bn_3zeFh.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";/**
* @vue/shared v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Me=Object.prototype.hasOwnProperty,H=(e,r)=>Me.call(e,r),Y=e=>typeof e=="string",S=e=>e!==null&&typeof e=="object";const $=e=>typeof e=="boolean",D=e=>typeof e=="number",W="__epPropKey",M=e=>e,je=e=>S(e)&&!!e[W],_e=(e,r)=>{if(!S(e)||je(e))return e;const{values:s,required:m,default:i,type:y,validator:p}=e,l={type:y,required:!!m,validator:s||p?f=>{let t=!1,n=[];if(s&&(n=Array.from(s),H(e,"default")&&n.push(i),t||(t=n.includes(f))),p&&(t||(t=p(f))),!t&&n.length>0){const C=[...new Set(n)].map(o=>JSON.stringify(o)).join(", ");ge(`Invalid prop: validation failed${r?` for prop "${r}"`:""}. Expected one of [${C}], got value ${JSON.stringify(f)}.`)}return t}:void 0,[W]:!0};return H(e,"default")&&(l.default=i),l},we=e=>Ie(Object.entries(e).map(([r,s])=>[r,_e(s,r)])),Ne=(e,r)=>{if(e.install=s=>{for(const m of[e,...Object.values(r??{})])s.component(m.name,m)},r)for(const[s,m]of Object.entries(r))e[s]=m;return e},Te=we({variant:{type:M(String),default:"default"},rounded:{type:M(String),default:"md"},classItem:{type:String,default:""},options:{type:M(Array),default:()=>[]},modelValue:{type:[String,Number,Boolean,null],default:void 0},block:Boolean,size:{type:M(String),default:"md"},disabled:Boolean,validateEvent:{type:Boolean,default:!0},messageError:{type:String,default:""},helpText:{type:String,default:""},id:String,name:String,...Ee(["ariaLabel"])}),Ce={[R]:e=>Y(e)||D(e)||$(e),[X]:e=>Y(e)||D(e)||$(e)},ke={class:"flex flex-col gap-xs"},Le=["id","aria-label","aria-labelledby"],Oe=["name","disabled","checked","onChange"],U=ne({__name:"Segmented",props:Te,emits:Ce,setup(e,{emit:r}){const s=e,m=r,i=Se("segmented"),y=fe(),p=xe(),{formItem:l}=ve(),{inputId:f,isLabeledByFormItem:t}=ye(s,{formItemContext:l}),n=I(null),C=be(),o=le({isInit:!1,width:0,height:0,translateX:0,translateY:0,focusVisible:!1}),G=d(()=>l?.shouldShowErrorChild||!!s?.messageError),J=d(()=>[i.e("help"),{[i.e("help-error")]:G.value}]),k=d(()=>s?.messageError?s.messageError:l?.validateMessage);d(()=>k.value||l?.$el);const K=a=>{const g=L(a);m(R,g),m(X,g)},L=a=>S(a)?a?.value:a,Q=a=>S(a)?a?.label:a,O=a=>!!(p.value||S(a)&&a?.disabled),Z=a=>s.modelValue===L(a),ee=a=>s.options.find(g=>L(g)===a),ae=a=>[i.e("item"),i.is("selected",Z(a)),i.is("disabled",O(a)),s.classItem],P=()=>{if(!n.value)return;const a=n.value.querySelector(".is-selected"),g=n.value.querySelector(".is-selected input");if(!a||!g){o.width=0,o.height=0,o.translateX=0,o.translateY=0,o.focusVisible=!1;return}const c=a.getBoundingClientRect();o.isInit=!0,o.width=c.width,o.translateX=a.offsetLeft;try{o.focusVisible=g.matches(":focus-visible")}catch{}},se=d(()=>[i.b(),i.m(s.size),i.m(s.variant),i.is("block",s.block),i.m(`rounded-${s.rounded}`)]),ie=d(()=>({width:`${o.width}px`,height:"100%",transform:`translateX(${o.translateX}px)`,display:o.isInit?"block":"none"})),te=d(()=>[i.e("item-selected"),i.is("disabled",O(ee(s.modelValue))),i.is("focus-visible",o.focusVisible)]),re=d(()=>s.name||y.value);return he(n,P),V(C,P),V(()=>s.modelValue,()=>{P(),s.validateEvent&&l?.validate?.("change").catch(a=>void 0)},{flush:"post"}),(a,g)=>(h(),b("div",ke,[a.options.length?(h(),b("div",{key:0,class:x(se.value),id:u(f),ref_key:"segmentedRef",ref:n,role:"radiogroup","aria-label":u(t)?void 0:a.ariaLabel||"segmented","aria-labelledby":u(t)?u(l).labelId:void 0},[A("div",{class:x([u(i).e("group")])},[A("div",{style:me(ie.value),class:x(te.value)},null,6),(h(!0),b(ce,null,de(a.options,(c,oe)=>(h(),b("label",{key:oe,class:x(ae(c))},[A("input",{class:x(u(i).e("item-input")),type:"radio",name:re.value,disabled:O(c),checked:Z(c),onChange:Pe=>K(c)},null,42,Oe),A("div",{class:x(u(i).e("item-label"))},[B(a.$slots,"default",{item:c,isActive:Z(c)},()=>[pe(F(Q(c)),1)])],2)],2))),128))],2)],10,Le)):q("",!0),B(a.$slots,"help",{error:k.value,isError:G.value},()=>[u(l)||a.helpText?(h(),b("p",{key:G.value?"error":"help",class:x(J.value)},F(G.value?k.value:a.helpText),3)):q("",!0)])]))}}),Ze=Ne(U,{Segmented:U}),ra={title:"Basic/Image",component:z,parameters:{docs:{description:{component:`
# Image Component
