import{G as n}from"./ConfigProvider-7dg58IlU.js";import"./iframe-Dct5CHxr.js";import"./preload-helper-Dch09mLN.js";import"./useEmptyValues-BnYvcW4O.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const p={title:"Colores/Foundations",parameters:{docs:{description:{component:`
...
Al hacer click en el color automáticamente se copia la variante de tailwind en el portapapeles. 📋
        `}}}},d=()=>({components:{GConfigProvider:n},template:`
  <g-config-provider>
    <div>
  ...
  `,setup(){return{handleColorClick:async i=>{const l=[...i.target.classList].find(e=>e.startsWith("bg-")&&!e.startsWith("bg-[#")).split("-").slice(1).join("-");try{await navigator.clipboard.writeText(l)}catch(e){console.error("Error al copiar:",e)}}}}}),o=d.bind({}),v=["Default"];o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => ({
  components: {
    GConfigProvider
  },
  template: \`
...
})`,...o.parameters?.docs?.source}}};export{o as Default,v as __namedExportsOrder,p as default};
