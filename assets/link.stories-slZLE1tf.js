...
<\/script>
\`\`\`
`}}},args:{type:"primary",size:"md",underline:!1,disabled:!1,href:"https://empresas.global66.com/",target:"_blank",iconLeft:void 0,iconRight:void 0}},t={name:"Default link",args:{default:"default link"},render:o=>({components:{GLink:n,GConfigProvider:r},setup(){return{args:o}},template:`
      <g-config-provider>
...
<g-link href="https://empresas.global66.com/">link por defecto</g-link>`,language:"html",type:"auto"}}}},c={name:"Links con íconos",render:()=>({components:{GLink:n,GConfigProvider:r},template:`
      <g-config-provider>
...
</g-link>`,language:"html",type:"auto"}}}},d={name:"Tamaños de link",render:()=>({components:{GLink:n,GConfigProvider:r},template:`
      <g-config-provider>
        <div class="flex flex-col space-y-4">
          <div>
...
<g-link size="lg" href="https://empresas.global66.com/">link grande</g-link>`,language:"html",type:"auto"}}}},g={name:"Tipos de link",render:()=>({components:{GLink:n,GConfigProvider:r},template:`
      <g-config-provider>
        <div class="flex flex-col space-y-4">
          <div>
...
<g-link type="secondary" underline href="https://empresas.global66.com/">Link secundario con underline</g-link>`,language:"html",type:"auto"}}}},m={name:"Links con íconos y underline",render:()=>({components:{GLink:n,GConfigProvider:r},template:`
      <g-config-provider>
        <div class="flex flex-col space-y-4">
          <div>
...
>
  Link secundario con íconos y underline
</g-link>`,language:"html",type:"auto"}}}},p={name:"Link deshabilitado",args:{disabled:!0,default:"link deshabilitado",iconRight:"regular chevron-right"},render:o=>({components:{GLink:n,GConfigProvider:r},setup(){return{args:o}},template:`
      <g-config-provider>
        <g-link v-bind="args">{{ args.default }}</g-link>
      </g-config-provider>
...
</g-link>`,language:"html",type:"auto"}}}},u={name:"Links externos",render:()=>({components:{GLink:n,GConfigProvider:r},template:`
      <g-config-provider>
...
<g-link href="https://empresas.global66.com/" target="_self">
  Abre en la misma pestaña
</g-link>`,language:"html",type:"auto"}}}},h={name:"Estados del link",render:()=>({components:{GLink:n,GConfigProvider:r},template:`
      <g-config-provider>
        <div class="flex flex-col space-y-4">
          <div>
...
<p>Este es un ejemplo de un párrafo con un <g-link status="inline" href="https://empresas.global66.com/">link inline</g-link> que está integrado dentro del texto.</p>`,language:"html",type:"auto"}}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  name: 'Default link',
  args: {
...
}`,...h.parameters?.docs?.source}}};const $=["Default","WithIcons","Sizes","Types","IconsWithUnderline","DisabledState","ExternalLinks","LinkStatus"];export{t as Default,p as DisabledState,u as ExternalLinks,m as IconsWithUnderline,h as LinkStatus,d as Sizes,g as Types,c as WithIcons,$ as __namedExportsOrder,W as default};
