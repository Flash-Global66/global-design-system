import{r as G,c as B,d as D,a as f,e as F,u as e,T as L,b as a,t as c,l as d,j as x,k as r,f as N,x as q,q as R,z,F as $,y as W}from"./vue.esm-bundler-C6DRpX4R.js";import{R as g}from"./index-DEGGxn4j.js";import{d as _}from"./useEmptyValues-8bO_IQ4-.js";import{b as O,d as p}from"./props.util-DQIcYPkU.js";import{B as U}from"./index-BnOtqFZS.js";import{u as H}from"./useNamespace-D200ZTkz.js";import{w as J}from"./install.util-cBz1HN_T.js";import{G as l}from"./ConfigProvider-CHVLgL_2.js";import{v as K,p as T}from"./package-WhySoqGZ.js";import{g as Q,a as X,b as P}from"./documentation-stories-0qKiiCdD.js";import"./error.util-CtUs3PUB.js";import"./useId-BGX2ZA7H.js";import"./index-OmpdNH0g.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-fKX7T4ju.js";const Y=O({title:{type:String,default:""},description:{type:String,default:""},hideClose:{type:Boolean,default:!1},icon:{type:p(String),default:""},type:{type:p(String),default:"success"},size:{type:p(String),default:"md"},links:{type:p(Array),default:()=>[]},shadow:{type:Boolean,default:!1},border:{type:Boolean,default:!0},iconAlign:{type:p(String),default:"medium"},iconFill:{type:Boolean,default:!1},showArrow:{type:Boolean,default:!0},..._(["ariaLabel"])}),Z={close:i=>i instanceof MouseEvent};function ee(i,k){const m=G(!0),s=H("inline"),S=U(),o=G(null),j=B(()=>[s.b(),s.m(S.value),s.m(i.type),i.shadow&&s.m("shadow"),!i.border&&s.m("no-border"),s.m(`icon-align-${i.iconAlign}`)]);function E(A){m.value=!1,k("close",A)}return{visible:m,ns:s,inlineRef:o,inlineClass:j,onClose:E}}const oe=["aria-label"],ne=["onClick","aria-label"],V=D({__name:"index",props:Y,emits:Z,setup(i,{emit:k}){const m=i,s=k,{visible:S,ns:o,inlineRef:j,inlineClass:E,onClose:A}=ee(m,s);return(n,ie)=>(a(),f(L,{name:e(o).m("fade")},{default:F(()=>[e(S)?(a(),c("div",{key:0,class:r(e(E)),ref_key:"inlineRef",ref:j,"aria-label":n.ariaLabel||"inline"},[n.iconFill?(a(),c("div",{key:0,class:r(e(o).e("icon-fill"))},[N(e(g),{"aria-label":"icon informative",class:r(e(o).e("icon")),name:n.icon},null,8,["class","name"])],2)):(a(),f(e(g),{key:1,"aria-label":"icon informative",class:r(e(o).e("icon")),name:n.icon},null,8,["class","name"])),x("div",null,[n.title?(a(),c("h3",{key:0,class:r([e(o).e("title")])},q(n.title),3)):d("",!0),x("p",{class:r([e(o).e("description")])},[R(n.$slots,"default",{},()=>[z(q(n.description),1)])],2),n.links.length?(a(),c("div",{key:1,role:"group",class:r([e(o).e("links")])},[(a(!0),c($,null,W(n.links,(u,M)=>(a(),c("button",{key:M,onClick:ae=>u.action(),class:r([e(o).e("link"),n.showArrow&&e(o).em("link","arrow")]),"aria-label":u.ariaLabel||u.label,type:"button"},[z(q(u.label)+" ",1),n.showArrow?(a(),f(e(g),{key:0,name:"regular chevron-right",class:r(e(o).e("link-arrow"))},null,8,["class"])):d("",!0)],10,ne))),128))],2)):d("",!0)]),n.hideClose?d("",!0):(a(),f(e(g),{key:2,role:"button","aria-label":"close inline",onClick:e(A),class:r(e(o).e("close")),name:"regular times"},null,8,["onClick","class"]))],10,oe)):d("",!0)]),_:3},8,["name"]))}});V.__docgenInfo={exportName:"default",displayName:"Inline",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/inline/src/Inline/index.vue"]};const t=J(V,{Inline:V}),Ce={title:"Data/Inline",component:t,parameters:{docs:{description:{component:`
...
}`,...w.parameters?.docs?.source}}};const Ie=["Primary","AllTypes","Sizes","WithoutClose","WithoutIcon","Card","WithIconFillAndShadow"];export{b as AllTypes,I as Card,y as Primary,v as Sizes,w as WithIconFillAndShadow,h as WithoutClose,C as WithoutIcon,Ie as __namedExportsOrder,Ce as default};
