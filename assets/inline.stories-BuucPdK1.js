import{d as V,r as I,c as M,b as E,f as w,u as i,T as L,e as o,x as t,m as d,h as _,k as S,l as s,y as v,s as B,A as N,F as R,z as $}from"./vue.esm-bundler-BQ5MY6wY.js";import{f as j}from"./index-CqyTLt6u.js";import{z as F,p,a as W,B as O,G as c}from"./ConfigProvider-C-g_q7t3.js";import{u as U}from"./index-Zf8ggd1d.js";import{u as H}from"./use-form-common-props-CapjGx9q.js";import{v as J,p as b}from"./package-CjbQN2-7.js";import{g as K,a as Q,b as k}from"./documentation-stories-B5LZhktk.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./_arrayPush-Dd5JSu8W.js";import"./constants-Dnj8X3EN.js";import"./index-D3vNJlXT.js";import"./index-CFVVBxWq.js";import"./index.es-DRG_Ro19.js";import"./index-CHFUNSwa.js";import"./index-wqKiBS4Z.js";import"./error-Cq9Fpw4b.js";const X=F({title:{type:String,default:""},description:{type:String,required:!0,default:""},hideClose:{type:Boolean,default:!1},icon:{type:p(String),default:""},type:{type:p(String),default:"success"},size:{type:p(String),default:"md"},links:{type:p(Array),default:()=>[]},...U(["ariaLabel"])}),Y={close:a=>a instanceof MouseEvent},Z=["aria-label"],ee={class:""},ne=["onClick","aria-label"],h=V({__name:"inline",props:X,emits:Y,setup(a,{emit:T}){const x=a,z=T,C=I(!0),n=W("inline"),q=H(),G=I(null),P=M(()=>[n.b(),n.m(q.value),n.m(x.type)]);async function A(e){C.value=!1,z("close",e)}return(e,ie)=>(o(),E(L,{name:i(n).m("fade")},{default:w(()=>[C.value?(o(),t("div",{key:0,class:s(P.value),ref_key:"inlineRef",ref:G,"aria-label":e.ariaLabel||"inline"},[_(i(j),{"aria-label":"icon informative",class:s([i(n).e("icon")]),name:e.icon},null,8,["class","name"]),S("div",ee,[e.title?(o(),t("h3",{key:0,class:s([i(n).e("title")])},v(e.title),3)):d("",!0),S("p",{class:s([i(n).e("description")])},[B(e.$slots,"default",{},()=>[N(v(e.description),1)])],2),e.links.length?(o(),t("div",{key:1,role:"group",class:s([i(n).e("links")])},[(o(!0),t(R,null,$(e.links,(l,D)=>(o(),t("button",{key:D,onClick:l.action,class:s([i(n).e("link")]),"aria-label":l.ariaLabel||l.label,type:"button"},v(l.label),11,ne))),128))],2)):d("",!0)]),e.hideClose?d("",!0):(o(),E(i(j),{key:0,role:"button","aria-label":"close inline",onClick:A,class:s(i(n).e("close")),name:"regular times"},null,8,["class"]))],10,Z)):d("",!0)]),_:3},8,["name"]))}});h.__docgenInfo={exportName:"default",displayName:"inline",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/inline/src/inline.vue"]};const r=O(h,{Inline:h}),he={title:"Data/Inline",component:r,parameters:{docs:{description:{component:`
