import{d as le,r as I,H as ne,c as d,x as b,w as V,e as h,m as q,s as B,u,l as x,k as A,n as me,F as ce,z as de,A as pe,y as Y,t as ge,o as ue}from"./vue.esm-bundler-C43JrhH2.js";import{I as E,_ as z,a as v}from"./Image-CmXJ-Qwt.js";import{u as fe,C as xe,Z as ve,Y as ye}from"./index-3IKRmSQk.js";import{b as be,a as he}from"./index-BDKGuxIf.js";import{f as Ie}from"./install-CfJGiCvs.js";import{u as Ee}from"./index-D7z0E8nu.js";import{u as Se}from"./index-IKXR5Yi8.js";import{U as R,C as X}from"./event-HEVJa2N9.js";import{s as ze}from"./index-CDvOhgku.js";import{m as Ge}from"./index-BeNbOwT_.js";import{v as Ae}from"./index-BIUJGY5W.js";import{G as N}from"./ConfigProvider-Bm0JlQoM.js";import"./error-Cq9Fpw4b.js";import"./index-fhkPmQjX.js";import"./index-DmfABaPz.js";import"./_arrayPush-Bf091UU2.js";import"./index-BjhK0CHr.js";import"./index-Dv8hH079.js";import"./aria-BjPBxY_p.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";/**
* @vue/shared v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Me=Object.prototype.hasOwnProperty,D=(e,r)=>Me.call(e,r),F=e=>typeof e=="string",S=e=>e!==null&&typeof e=="object",H=e=>typeof e=="boolean",$=e=>typeof e=="number",W="__epPropKey",M=e=>e,je=e=>S(e)&&!!e[W],Ce=(e,r)=>{if(!S(e)||je(e))return e;const{values:s,required:m,default:i,type:y,validator:p}=e,n={type:y,required:!!m,validator:s||p?f=>{let t=!1,l=[];if(s&&(l=Array.from(s),D(e,"default")&&l.push(i),t||(t=l.includes(f))),p&&(t||(t=p(f))),!t&&l.length>0){const T=[...new Set(l)].map(o=>JSON.stringify(o)).join(", ");ge(`Invalid prop: validation failed${r?` for prop "${r}"`:""}. Expected one of [${T}], got value ${JSON.stringify(f)}.`)}return t}:void 0,[W]:!0};return D(e,"default")&&(n.default=i),n},_e=e=>Ie(Object.entries(e).map(([r,s])=>[r,Ce(s,r)])),we=(e,r)=>{if(e.install=s=>{for(const m of[e,...Object.values(r??{})])s.component(m.name,m)},r)for(const[s,m]of Object.entries(r))e[s]=m;return e},Ne=_e({variant:{type:M(String),default:"default"},rounded:{type:M(String),default:"md"},classItem:{type:String,default:""},options:{type:M(Array),default:()=>[]},modelValue:{type:[String,Number,Boolean,null],default:void 0},block:Boolean,size:{type:M(String),default:"md"},disabled:Boolean,validateEvent:{type:Boolean,default:!0},messageError:{type:String,default:""},helpText:{type:String,default:""},id:String,name:String,...Ee(["ariaLabel"])}),Te={[R]:e=>F(e)||$(e)||H(e),[X]:e=>F(e)||$(e)||H(e)},ke={class:"flex flex-col gap-xs"},Oe=["id","aria-label","aria-labelledby"],Le=["name","disabled","checked","onChange"],U=le({__name:"Segmented",props:Ne,emits:Te,setup(e,{emit:r}){const s=e,m=r,i=Se("segmented"),y=fe(),p=xe(),{formItem:n}=ve(),{inputId:f,isLabeledByFormItem:t}=ye(s,{formItemContext:n}),l=I(null),T=be(),o=ne({isInit:!1,width:0,height:0,translateX:0,translateY:0,focusVisible:!1}),G=d(()=>n?.shouldShowErrorChild||!!s?.messageError),J=d(()=>[i.e("help"),{[i.e("help-error")]:G.value}]),k=d(()=>s?.messageError?s.messageError:n?.validateMessage);d(()=>k.value||n?.$el);const K=a=>{const g=O(a);m(R,g),m(X,g)},O=a=>S(a)?a?.value:a,Q=a=>S(a)?a?.label:a,L=a=>!!(p.value||S(a)&&a?.disabled),Z=a=>s.modelValue===O(a),ee=a=>s.options.find(g=>O(g)===a),ae=a=>[i.e("item"),i.is("selected",Z(a)),i.is("disabled",L(a)),s.classItem],P=()=>{if(!l.value)return;const a=l.value.querySelector(".is-selected"),g=l.value.querySelector(".is-selected input");if(!a||!g){o.width=0,o.height=0,o.translateX=0,o.translateY=0,o.focusVisible=!1;return}const c=a.getBoundingClientRect();o.isInit=!0,o.width=c.width,o.translateX=a.offsetLeft;try{o.focusVisible=g.matches(":focus-visible")}catch{}},se=d(()=>[i.b(),i.m(s.size),i.m(s.variant),i.is("block",s.block),i.m(`rounded-${s.rounded}`)]),ie=d(()=>({width:`${o.width}px`,height:"100%",transform:`translateX(${o.translateX}px)`,display:o.isInit?"block":"none"})),te=d(()=>[i.e("item-selected"),i.is("disabled",L(ee(s.modelValue))),i.is("focus-visible",o.focusVisible)]),re=d(()=>s.name||y.value);return he(l,P),V(T,P),V(()=>s.modelValue,()=>{P(),s.validateEvent&&n?.validate?.("change").catch(a=>{})},{flush:"post"}),(a,g)=>(h(),b("div",ke,[a.options.length?(h(),b("div",{key:0,class:x(se.value),id:u(f),ref_key:"segmentedRef",ref:l,role:"radiogroup","aria-label":u(t)?void 0:a.ariaLabel||"segmented","aria-labelledby":u(t)?u(n).labelId:void 0},[A("div",{class:x([u(i).e("group")])},[A("div",{style:me(ie.value),class:x(te.value)},null,6),(h(!0),b(ce,null,de(a.options,(c,oe)=>(h(),b("label",{key:oe,class:x(ae(c))},[A("input",{class:x(u(i).e("item-input")),type:"radio",name:re.value,disabled:L(c),checked:Z(c),onChange:Pe=>K(c)},null,42,Le),A("div",{class:x(u(i).e("item-label"))},[B(a.$slots,"default",{item:c,isActive:Z(c)},()=>[pe(Y(Q(c)),1)])],2)],2))),128))],2)],10,Oe)):q("",!0),B(a.$slots,"help",{error:k.value,isError:G.value},()=>[u(n)||a.helpText?(h(),b("p",{key:G.value?"error":"help",class:x(J.value)},Y(G.value?k.value:a.helpText),3)):q("",!0)])]))}}),Ze=we(U,{Segmented:U}),ra={title:"Basic/Image",component:z,parameters:{docs:{description:{component:`
# Image Component
...
import { GImage } from '@flash-global66/g-image';
<\/script>
`,language:"html"}}}},C={name:"Tamaños disponibles",render:e=>({components:{GImage:z,GConfigProvider:N},setup(){const r=Object.keys(v);return{args:e,sizes:r,IMAGE_SIZES:v}},template:`
      <g-config-provider>
...
import { GImage } from '@flash-global66/g-image';
<\/script>
`,language:"html"}}}},_={name:"Galería de ilustraciones",parameters:{docs:{description:{story:"Galería completa de ilustraciones disponibles en el sistema. Haz clic en cualquier ilustración para copiar su nombre. 📋"},source:{code:`
...
`,language:"html"}}},render:()=>({components:{GImage:z,GConfigProvider:N,GSegmented:Ze,GInput:ze,GButton:Ge,GIconFont:Ae},setup(){const e=I("md"),r=I(""),s=I(null),m=Object.keys(v).map(t=>({label:t.toUpperCase(),value:t})),i=I([...E]),y=d(()=>{switch(e.value){case"xs":case"sm":return"grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8";case"md":return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6";case"lg":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"xl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"xxl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3";case"xxxl":return"grid-cols-1 sm:grid-cols-2";default:return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6"}}),p=()=>{if(!r.value.trim()){i.value=[...E];return}const t=r.value.toLowerCase().trim();i.value=E.filter(l=>l.toLowerCase().includes(t))},n=()=>{r.value="",p()},f=t=>{navigator.clipboard.writeText(t).then(()=>{s.value=t,setTimeout(()=>{s.value=null},1500),console.log("Nombre de la ilustración copiado al portapapeles")}).catch(()=>{alert("No se pudo copiar el nombre de la ilustración")})};return ue(()=>{const t=document.createElement("style");return t.textContent=`
          .copy-animation {
        ...
        `,document.head.appendChild(t),()=>{t.parentNode&&t.parentNode.removeChild(t)}}),{IMAGE_NAMES:E,IMAGE_SIZES:v,selectedSize:e,sizeOptions:m,searchTerm:r,clearSearch:n,copyImageName:f,filteredImages:i,updateFilteredImages:p,copiedImage:s,gridColumns:y}},template:`
      <g-config-provider>
        <div class="space-y-8">
          <g-segmented
            block
    ...
    `})},w={name:"Manejo de errores",parameters:{docs:{description:{story:"Demostración de cómo el componente maneja los errores cuando una imagen no puede cargarse."},source:{code:`
...
import { GImage } from '@flash-global66/g-image';
<\/script>
`,language:"html"}}},render:()=>({components:{GImage:z,GConfigProvider:N},setup(){return{IMAGE_SIZES:v}},template:`
      <g-config-provider>
        <div class="space-y-8">
...
}`,...w.parameters?.docs?.source}}};const oa=["Primary","Sizes","Gallery","ErrorHandling"];export{w as ErrorHandling,_ as Gallery,j as Primary,C as Sizes,oa as __namedExportsOrder,ra as default};
