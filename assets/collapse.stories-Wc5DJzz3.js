...
Props disponibles:
{
  ...
  focusing: boolean;
    ...
    `})},w={name:"Prevención de collapse",parameters:{docs:{description:{story:"Puedes prevenir el colapso de un elemento utilizando el hook `before-collapse`. Si este hook devuelve `false` o una `Promise` que se rechaza, el colapso no ocurrirá."}}},render:()=>({components:{GConfigProvider:P,GCollapse:v,GCollapseItem:E},setup(){const a=b(["1"]),s=b(!1),o=b([{title:"Consistencia",name:"1",disabled:!1,description:"La consistencia es clave para una buena experiencia de usuario.",content:"Este cliente es el representante legal de la empresa. Puede editar sus datos o eliminarlo si ya no es necesario. También puede agregar más representantes legales si es necesario."},{title:"Feedback",name:"2",disabled:!1,description:"El feedback es importante para mejorar la experiencia del usuario.",content:"Este cliente es el representante legal de la empresa. Puede editar sus datos o eliminarlo si ya no es necesario. También puede agregar más representantes legales si es necesario."},{title:"Eficiencia",name:"3",disabled:!1,description:"La eficiencia es fundamental para una buena experiencia de usuario.",content:"Este cliente es el representante legal de la empresa. Puede editar sus datos o eliminarlo si ya no es necesario. También puede agregar más representantes legales si es necesario."}]);return{items:o,activeNames:a,beforeCollapse:e=>(o.value[parseInt(e)-1].iconsLeft=[{icon:"regular arrows-rotate",spin:!0}],new Promise(l=>{setTimeout(()=>(o.value[parseInt(e)-1].iconsLeft=[],l(!0)),1500)})),loading:s}},template:`
      <g-config-provider>
        <g-collapse v-model="activeNames" :items="items" class="flex flex-col gap-4" :before-collapse="(name) => beforeCollapse(name)" />
      </g-config-provider>
    `})},q={name:"Slot Default",parameters:{docs:{description:{story:"Puedes utilizar el slot `default` para agregar contenido dentro de cada elemento del collapse. Este slot se renderiza dentro de cada `g-collapse-item`."}}},render:()=>({components:{GConfigProvider:P,GCollapse:v,GCollapseItem:E,GForm:ve,GFormItem:be,GInput:ye,GButton:Me,GTag:Ue},setup(){const a=b(["1"]),s=me({name:"Juan Pérez",email:"juan@ejemplo.com",phone:"+51 999888777",address:"Av. Principal 123",ciudad:"Lima",country:"Perú"}),o=[{icon:"regular trash-xmark",onClick:l=>{t.value=t.value.filter(p=>p.name!==l)}}],t=b([{title:"Representante Legal 1",name:"1",iconsLeft:[{icon:"regular user"}],description:"CUIL 1902945728",iconsRight:o},{title:"Representante Legal 2",name:"2",iconsLeft:[{icon:"regular user"}],description:"CUIL 1902945728",iconsRight:o},{title:"Representante Legal 3",name:"3",iconsLeft:[{icon:"regular user"}],description:"CUIL 1902945728",iconsRight:o}]);return{items:t,formData:s,activeNames:a,handleSaveRepresentative:l=>{a.value=a.value.filter(p=>p!==l)}}},template:`
      <g-config-provider>
    ...
    `})},z={name:"Collapse item con formularios",parameters:{docs:{description:{story:"Ejemplo de uso de GCollapseItem con un formulario."}}},render:()=>({components:{GConfigProvider:P,GCollapse:v,GCollapseItem:E,GForm:ve,GFormItem:be,GInput:ye},setup(){const a=b(1),s=me({name:"Pepito",lastName:"Perez",phone:"999888777",email:"pepito@ejemplo.com",city:"Lima",address:""});return{activeNames:a,formData:s}},template:`
      <g-config-provider>
    ...
    `})},O={name:"Header solo click",parameters:{docs:{description:{story:"Ejemplo de uso de las props `headerOnly` y `hideIcon` en GCollapseItem. \n        \n- **headerOnly**: El item solo ejecuta un evento sin expandirse, pero mantiene el icono de flecha.\n- **hideIcon**: Solo oculta el icono de flecha, el collapse sigue funcionando normalmente."}}},render:()=>({components:{GConfigProvider:P,GCollapse:v,GCollapseItem:E,GIconFont:B},setup(){const a=b(["1"]),s=b("");return{activeNames:a,message:s,handleHeaderClick:t=>{s.value=`Se hizo clic en el header: ${t} a las ${new Date().toLocaleTimeString()}`,console.log("Header clickeado:",t)}}},template:`
      <g-config-provider>
        <div class="space-y-4">
...
}`,...F.parameters?.docs?.source}}};const qa=["Basic","accordionExample","CustomIcons","positionIcon","preventCollpsing","slotDefault","simpleDifferentContent","headerOnlyExample","slotDefaultWithProps"];export{N as Basic,R as CustomIcons,qa as __namedExportsOrder,j as accordionExample,wa as default,O as headerOnlyExample,H as positionIcon,w as preventCollpsing,z as simpleDifferentContent,q as slotDefault,F as slotDefaultWithProps};
