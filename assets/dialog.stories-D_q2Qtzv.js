import{o as ue,B as De,C as xe,g as Ve,r as d,c as x,w as ie,D as ke,d as pe,a as ne,x as I,e as y,m as q,k as oe,l as C,u as a,s as F,h as ae,y as re,F as Ae,z as Be,b as te,f as w,A as Ee,n as me,T as we,j as ze,p as Se,q as Me,v as Te,E as Ie}from"./vue.esm-bundler-BCWWDzSy.js";import{a as Fe,O as Ge,z as Pe}from"./index-Chx1QtW8.js";import{u as Le,G as je,a as Oe}from"./index-Corq57P2.js";import{b as fe,d as de}from"./install-CHjgJfcB.js";import{m as Ne,a as $e,u as qe}from"./index-CU2PSoyO.js";import{U as be}from"./event-BB_Ol6Sd.js";import{u as We,f as Xe,G}from"./ConfigProvider-BAdTAJXu.js";import{u as ce}from"./index-DJArRuUx.js";import{b as le}from"./style-B-OtozZQ.js";import{i as Re}from"./index-lV95ywNu.js";import{u as ge}from"./index-tMAtNoGV.js";import{q as Ue}from"./index-Bz0y6LhV.js";import{y as Ye}from"./index-HX2jAHe6.js";import{c as Ke}from"./refs-DUcXoBRl.js";import{G as P}from"./index-CyadN433.js";import"./aria-BUADUvnR.js";import"./error-Cq9Fpw4b.js";import"./vnode-Bi-i9bxn.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-B9DYlcmC.js";import"./_arrayPush-DXBsyDbg.js";const He=(e,o,i,l)=>{let p={offsetX:0,offsetY:0};const n=z=>{const c=z.clientX,S=z.clientY,{offsetX:g,offsetY:f}=p,b=e.value.getBoundingClientRect(),A=b.left,h=b.top,B=b.width,W=b.height,s=document.documentElement.clientWidth,L=document.documentElement.clientHeight,D=-A+g,j=-h+f,_=s-A-B+g,ee=L-h-W+f,O=M=>{let u=g+M.clientX-c,E=f+M.clientY-S;l?.value||(u=Math.min(Math.max(u,D),_),E=Math.min(Math.max(E,j),ee)),p={offsetX:u,offsetY:E},e.value&&(e.value.style.transform=`translate(${le(u)}, ${le(E)})`)},N=()=>{document.removeEventListener("mousemove",O),document.removeEventListener("mouseup",N)};document.addEventListener("mousemove",O),document.addEventListener("mouseup",N)},k=()=>{o.value&&e.value&&o.value.addEventListener("mousedown",n)},m=()=>{o.value&&e.value&&o.value.removeEventListener("mousedown",n)},r=()=>{p={offsetX:0,offsetY:0},e.value&&(e.value.style.transform="none")};return ue(()=>{De(()=>{i.value?k():m()})}),xe(()=>{m()}),{resetPosition:r}},ve=Symbol("dialogInjectionKey"),Ce=fe({fullscreen:Boolean,draggable:Boolean,overflow:{type:Boolean,default:!0},alignCenter:{type:Boolean,default:!1},sizeMode:{type:String,values:["default","fixed","adaptive"],default:"default"},title:{type:String,default:""},headerClass:String,bodyClass:String,footerClass:String,showClose:{type:Boolean,default:!0},width:{type:[String,Number]},ariaLevel:{type:String,default:"2"},footerButtons:{type:Array,default:()=>[]}}),Ze=e=>{const{sizeMode:o,width:i}=e;o==="fixed"&&(!i||i==="")&&console.warn('[g-dialog] When sizeMode is set to "fixed", width must be defined.')},Je={close:()=>!0},Qe=fe({...Ce,appendToBody:{type:Boolean,default:!1},appendTo:{type:de([String,Object]),default:"body"},beforeClose:{type:de(Function)},destroyOnClose:{type:Boolean,default:!1},closeOnClickModal:{type:Boolean,default:!0},closeOnPressEscape:{type:Boolean,default:!0},lockScroll:{type:Boolean,default:!0},modal:{type:Boolean,default:!0},openDelay:{type:Number,default:0},closeDelay:{type:Number,default:0},top:{type:String},modelValue:Boolean,modalClass:String,headerClass:String,bodyClass:String,footerClass:String,width:{type:[String,Number]},zIndex:{type:Number},trapFocus:{type:Boolean,default:!0},ariaLevel:{type:String,default:"2"}}),_e={open:()=>!0,opened:()=>!0,close:()=>!0,closed:()=>!0,[be]:e=>Ne(e),openAutoFocus:()=>!0,closeAutoFocus:()=>!0},eo=(e,o,{closeOnClickModal:i,closeOnPressEscape:l})=>{const n=Ve().emit,{nextZIndex:k}=We();let m="";const r=ce(),z=ce(),c=d(!1),S=d(!1),g=d(!1),f=d(e.zIndex??k()),b=x(()=>e.footerButtons?.slice(0,3)||[]),A=x(()=>b.value.length===3?"layout-dual-row":"layout-single-column");let h,B;const s=Xe("namespace","gui"),L=x(()=>{const v={},se=`--${s.value}-dialog`;return e.fullscreen||(e.top&&(v[`${se}-margin-top`]=e.top),e.width&&(v[`${se}-width`]=le(e.width))),v}),D=x(()=>e.alignCenter?{display:"flex"}:{});function j(){n("opened")}function _(){n("closed"),n(be,!1),e.destroyOnClose&&(g.value=!1)}function ee(){n("close")}function O(){B?.(),h?.(),e.openDelay&&e.openDelay>0?{stop:h}=ge(()=>E(),e.openDelay):E()}function N(){h?.(),B?.(),e.closeDelay&&e.closeDelay>0?{stop:B}=ge(()=>X(),e.closeDelay):X()}const M=()=>{e.showClose&&(e.beforeClose?e.beforeClose(X):X())};function u(){i.value&&M()}function E(){$e&&(c.value=!0)}function X(){c.value=!1}function t(){n("openAutoFocus")}function T(){n("closeAutoFocus")}function $(v){v.detail?.focusReason==="pointer"&&v.preventDefault()}e.lockScroll&&Le(c);function he(){l.value&&M()}return ie(()=>e.modelValue,v=>{v?(S.value=!1,O(),g.value=!0,f.value=Re(e.zIndex)?k():f.value++,ke(()=>{n("open"),o.value&&(o.value.parentElement.scrollTop=0,o.value.parentElement.scrollLeft=0,o.value.scrollTop=0)})):c.value&&N()}),ie(()=>e.fullscreen,v=>{o.value&&(v?(m=o.value.style.transform,o.value.style.transform=""):o.value.style.transform=m)}),ue(()=>{e.modelValue&&(c.value=!0,g.value=!0,O())}),{afterEnter:j,afterLeave:_,beforeLeave:ee,handleClose:M,onModalClick:u,close:N,doClose:X,onOpenAutoFocus:t,onCloseAutoFocus:T,onCloseRequested:he,onFocusoutPrevented:$,titleId:r,bodyId:z,closed:S,style:L,overlayDialogStyle:D,rendered:g,visible:c,zIndex:f,displayButtons:b,buttonLayoutClass:A}},oo={key:0,class:"header-content"},ao=["id"],to=["aria-level"],ye=pe({__name:"dialog-content",props:Ce,emits:Je,setup(e,{expose:o,emit:i}){const l=e,p=i;Ze(l);const{dialogRef:n,headerRef:k,bodyId:m,ns:r,style:z,displayButtons:c,buttonLayoutClass:S}=ne(ve),{focusTrapRef:g}=ne(Fe,{focusTrapRef:n,onKeydown:()=>{}}),f=x(()=>{const s=l.fullscreen?"fullscreen":l.sizeMode||"default";return[r.b(),r.is("draggable",l.draggable),r.is("align-center",l.alignCenter),r.is(s)]}),b=Ke(g,n),A=x(()=>l.draggable&&!l.fullscreen),h=x(()=>l.overflow),{resetPosition:B}=He(n,n,A,h);o({resetPosition:B});const W=()=>{p("close")};return(s,L)=>(y(),I("div",{ref:a(b),class:C(f.value),style:me(a(z)),tabindex:"-1"},[s.showClose||s.$slots.header?(y(),I("header",{key:0,ref_key:"headerRef",ref:k,class:C([a(r).e("header"),s.headerClass])},[s.$slots.header?(y(),I("div",oo,[F(s.$slots,"header")])):q("",!0),s.showClose?(y(),I("button",{key:1,"aria-label":"Close",class:C(a(r).e("headerbtn")),type:"button",onClick:W},[ae(a(Ue),{name:"regular times",class:C(a(r).e("close"))},null,8,["class"])],2)):q("",!0)],2)):q("",!0),oe("div",{id:a(m),class:C([a(r).e("body"),s.bodyClass])},[oe("div",null,[s.$slots.image?(y(),I("div",{key:0,class:C(a(r).e("image"))},[F(s.$slots,"image")],2)):q("",!0),s.title?(y(),I("span",{key:1,class:C(a(r).e("title")),role:"heading","aria-level":s.ariaLevel},re(s.title),11,to)):q("",!0),oe("div",{class:C(a(r).e("content"))},[F(s.$slots,"default")],2)])],10,ao),oe("footer",{class:C([a(r).e("footer"),s.footerClass])},[F(s.$slots,"footer",{},()=>[l.footerButtons?.length?(y(),I("div",{key:0,class:C([a(r).e("footer-buttons"),a(S)])},[(y(!0),I(Ae,null,Be(a(c),(D,j)=>(y(),te(a(Ye),{key:j,variant:D.variant,disabled:D.disabled,full:"",onClick:D.onClick},{default:w(()=>[Ee(re(D.text),1)]),_:2},1032,["variant","disabled","onClick"]))),128))],2)):q("",!0)])],2)],6))}});ye.__docgenInfo={exportName:"default",displayName:"dialog-content",description:"",tags:{},expose:[{name:"resetPosition"}],slots:[{name:"header"},{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog-content.vue"]};const lo=["aria-label","aria-labelledby","aria-describedby"],V=pe({__name:"dialog",props:Qe,emits:_e,setup(e,{expose:o,emit:i}){const l=e,p=qe("dialog"),n=d(),k=d(),m=d(),r=x(()=>l.showClose&&l.closeOnClickModal),z=x(()=>l.showClose&&l.closeOnPressEscape),{visible:c,titleId:S,bodyId:g,style:f,overlayDialogStyle:b,rendered:A,zIndex:h,afterEnter:B,afterLeave:W,beforeLeave:s,handleClose:L,onModalClick:D,onOpenAutoFocus:j,onCloseAutoFocus:_,onCloseRequested:ee,onFocusoutPrevented:O,displayButtons:N,buttonLayoutClass:M}=eo(l,n,{closeOnClickModal:r,closeOnPressEscape:z});Ie(ve,{dialogRef:n,headerRef:k,bodyId:g,ns:p,rendered:A,style:f,displayButtons:N,buttonLayoutClass:M});const u=Oe(D),E=x(()=>l.draggable&&!l.fullscreen);return o({visible:c,dialogContentRef:m,resetPosition:()=>{m.value?.resetPosition()}}),(t,T)=>(y(),te(a(Pe),{to:t.appendTo,disabled:t.appendTo!=="body"?!1:!t.appendToBody},{default:w(()=>[ae(we,{name:"dialog-fade",onAfterEnter:a(B),onAfterLeave:a(W),onBeforeLeave:a(s)},{default:w(()=>[ze(ae(a(je),{"custom-mask-event":"",mask:t.modal,"overlay-class":t.modalClass,"z-index":a(h)},{default:w(()=>[oe("div",{role:"dialog","aria-modal":"true","aria-label":t.title||void 0,"aria-labelledby":t.title?void 0:a(S),"aria-describedby":a(g),class:C(`${a(p).namespace.value}-overlay-dialog`),style:me(a(b)),onClick:T[0]||(T[0]=(...$)=>a(u).onClick&&a(u).onClick(...$)),onMousedown:T[1]||(T[1]=(...$)=>a(u).onMousedown&&a(u).onMousedown(...$)),onMouseup:T[2]||(T[2]=(...$)=>a(u).onMouseup&&a(u).onMouseup(...$))},[ae(a(Ge),{loop:"",trapped:a(c),"focus-start-el":"container",onFocusAfterTrapped:a(j),onFocusAfterReleased:a(_),onFocusoutPrevented:a(O),onReleaseRequested:a(ee)},{default:w(()=>[a(A)?(y(),te(ye,Se({key:0,ref_key:"dialogContentRef",ref:m},t.$attrs,{"align-center":t.alignCenter,draggable:E.value,overflow:t.overflow,fullscreen:t.fullscreen,"header-class":t.headerClass,"body-class":t.bodyClass,"footer-class":t.footerClass,"show-close":t.showClose,title:t.title,"aria-level":t.ariaLevel,width:t.width,"size-mode":t.sizeMode,"footer-buttons":t.footerButtons,onClose:a(L)}),Me({default:w(()=>[F(t.$slots,"default")]),_:2},[t.$slots.header?{name:"header",fn:w(()=>[F(t.$slots,"header")]),key:"0"}:void 0,t.$slots.image?{name:"image",fn:w(()=>[F(t.$slots,"image")]),key:"1"}:void 0,t.$slots.footer?{name:"footer",fn:w(()=>[F(t.$slots,"footer")]),key:"2"}:void 0]),1040,["align-center","draggable","overflow","fullscreen","header-class","body-class","footer-class","show-close","title","aria-level","width","size-mode","footer-buttons","onClose"])):q("",!0)]),_:3},8,["trapped","onFocusAfterTrapped","onFocusAfterReleased","onFocusoutPrevented","onReleaseRequested"])],46,lo)]),_:3},8,["mask","overlay-class","z-index"]),[[Te,a(c)]])]),_:3},8,["onAfterEnter","onAfterLeave","onBeforeLeave"])]),_:3},8,["to","disabled"]))}});V.__docgenInfo={exportName:"default",displayName:"dialog",description:"",tags:{},expose:[{name:"visible",tags:[{title:"description",content:"whether the dialog is visible"}]},{name:"dialogContentRef"},{name:"resetPosition"}],slots:[{name:"header"},{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog.vue"]};const so="1.2.0",Po={title:"Data/Dialog",component:V,argTypes:{modelValue:{control:"boolean",description:"Controla la visibilidad del dialog",table:{defaultValue:{summary:"false"}}},title:{control:"text",description:"Título del dialog",table:{defaultValue:{summary:""}}},width:{control:"text",description:"Ancho del dialog. Requiere size-mode='fixed'.",table:{defaultValue:{summary:"undefined"}}},sizeMode:{control:"select",options:["default","fixed","adaptive"],description:`Controla el comportamiento del ancho del dialog:
...
<\/script>`,language:"html",type:"auto"}}};const no=e=>({components:{GDialog:V,GConfigProvider:G,GButton:P},setup(){const o=d(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`}}};const ro=e=>({components:{GDialog:V,GConfigProvider:G,GButton:P},setup(){const o=d(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const co=e=>({components:{GDialog:V,GConfigProvider:G,GButton:P},setup(){const o=d(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const go=e=>({components:{GDialog:V,GConfigProvider:G,GButton:P},setup(){const o=d(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const uo=e=>({components:{GDialog:V,GConfigProvider:G,GButton:P},setup(){const o=d(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const po=e=>({components:{GDialog:V,GConfigProvider:G,GButton:P},setup(){const o=d(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const mo=e=>({components:{GDialog:V,GConfigProvider:G,GButton:P},setup(){const o=d(!1),i=d(!1),l=d(!1);return{args:e,defaultDialogVisible:o,fixedDialogVisible:i,adaptiveDialogVisible:l,closeDefaultDialog:()=>{o.value=!1},closeFixedDialog:()=>{i.value=!1},closeAdaptiveDialog:()=>{l.value=!1}}},template:`
    <g-config-provider>
