import{l as de,aA as me,p as ve,k as G,L,d as ue,c as x,r as n,s as X,t as pe,o as l,y as h,f as q,ac as ge,u as r,g as u,a as b,j as v,z as M,i as Z,n as fe,R as xe,C as he,aB as _,a0 as be,M as we,E as ye,Y as Se}from"./iframe-Dct5CHxr.js";import{R as w}from"./index-1T7U7QlS.js";import{L as Ce,B as De,z as Ae,M as Ne}from"./index-CZoNQBHQ.js";import{e as Ee,f as H,u as Fe,c as Pe}from"./useEmptyValues-BnYvcW4O.js";import{w as Ie}from"./install.util-cBz1HN_T.js";import{G as m}from"./ConfigProvider-7dg58IlU.js";import{G as Te,a as Ve}from"./index-DOcpSnVP.js";import{G as ke}from"./index-BeqF1NXI.js";import{G as Oe}from"./index-CiBki8_N.js";import{g as D,a as ze,b as ee}from"./documentation-stories-DmJzCMmf.js";import"./preload-helper-Dch09mLN.js";import"./useId-MLHLvdkG.js";import"./index-pMiYc9r3.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-CRx4dHSJ.js";import"./index-DWhPhD7W.js";import"./useAttrs-BZi71rd1.js";import"./event.constant-LtAI3-H4.js";import"./index-GU5Cqqg3.js";const j="update:modelValue",$="change",K="input",Re=de({modelValue:{type:[Boolean,String,Number],default:!1},disabled:Boolean,loading:Boolean,size:{type:String,validator:me},width:{type:[String,Number],default:""},inlinePrompt:Boolean,inactiveActionIcon:{type:String},activeActionIcon:{type:String},activeIcon:{type:String},inactiveIcon:{type:String},activeText:{type:String,default:""},inactiveText:{type:String,default:""},activeValue:{type:[Boolean,String,Number],default:!0},inactiveValue:{type:[Boolean,String,Number],default:!1},name:{type:String,default:""},validateEvent:{type:Boolean,default:!0},beforeChange:{type:ve(Function)},id:String,tabindex:{type:[String,Number]},...Ee(["ariaLabel"])}),Ge={[j]:a=>G(a)||L(a)||H(a),[$]:a=>G(a)||L(a)||H(a),[K]:a=>G(a)||L(a)||H(a)},Be=["id","aria-checked","aria-disabled","aria-label","name","true-value","false-value","disabled","tabindex"],Le=["aria-hidden"],qe=["aria-hidden"],Me=["aria-hidden"],ae="GSwitch",ne=ue({name:ae,__name:"switch",props:Re,emits:Ge,setup(a,{expose:t,emit:c}){const i=a,p=c,{formItem:g}=Ce(),B=De(),o=Fe("switch"),{inputId:te}=Ae(i,{formItemContext:g}),S=Ne(x(()=>i.loading)),W=n(i.modelValue!==!1),y=n(),ie=n(),oe=x(()=>[o.b(),o.m(B.value),o.is("disabled",S.value),o.is("checked",s.value)]),se=x(()=>[o.e("label"),o.em("label","left"),o.is("active",!s.value)]),re=x(()=>[o.e("label"),o.em("label","right"),o.is("active",s.value)]),ce=x(()=>({width:Pe(i.width)}));X(()=>i.modelValue,()=>{W.value=!0});const Y=x(()=>W.value?i.modelValue:!1),s=x(()=>Y.value===i.activeValue);[i.activeValue,i.inactiveValue].includes(Y.value)||(p(j,i.inactiveValue),p($,i.inactiveValue),p(K,i.inactiveValue)),X(s,e=>{y.value.checked=e,i.validateEvent&&g?.validate?.("change").catch(f=>we())});const C=()=>{const e=s.value?i.inactiveValue:i.activeValue;p(j,e),p($,e),p(K,e),he(()=>{y.value.checked=s.value})},J=()=>{if(S.value)return;const{beforeChange:e}=i;if(!e){C();return}const f=e();[_(f),G(f)].includes(!0)||be(ae,"beforeChange must return type `Promise<boolean>` or `boolean`"),_(f)?f.then(Q=>{Q&&C()}).catch(Q=>{}):f&&C()},le=()=>{y.value?.focus?.()};return pe(()=>{y.value.checked=s.value}),t({focus:le,checked:s}),(e,f)=>(l(),h("div",{class:u(oe.value),onClick:xe(J,["prevent"])},[q("input",{id:r(te),ref_key:"input",ref:y,class:u(r(o).e("input")),type:"checkbox",role:"switch","aria-checked":s.value,"aria-disabled":r(S),"aria-label":e.ariaLabel,name:e.name,"true-value":e.activeValue,"false-value":e.inactiveValue,disabled:r(S),tabindex:e.tabindex,onChange:C,onKeydown:ge(J,["enter"])},null,42,Be),!e.inlinePrompt&&(e.inactiveIcon||e.inactiveText)?(l(),h("span",{key:0,class:u(se.value)},[e.inactiveIcon?(l(),b(r(w),{key:0,name:e.inactiveIcon},null,8,["name"])):v("",!0),!e.inactiveIcon&&e.inactiveText?(l(),h("span",{key:1,"aria-hidden":s.value},M(e.inactiveText),9,Le)):v("",!0)],2)):v("",!0),q("span",{ref_key:"core",ref:ie,class:u(r(o).e("core")),style:fe(ce.value)},[e.inlinePrompt?(l(),h("div",{key:0,class:u(r(o).e("inner"))},[e.activeIcon||e.inactiveIcon?(l(),b(r(w),{key:0,name:s.value?e.activeIcon:e.inactiveIcon,class:u(r(o).is("icon"))},null,8,["name","class"])):e.activeText||e.inactiveText?(l(),h("span",{key:1,class:u(r(o).is("text")),"aria-hidden":!s.value},M(s.value?e.activeText:e.inactiveText),11,qe)):v("",!0)],2)):v("",!0),q("div",{class:u(r(o).e("action"))},[e.loading?(l(),b(r(w),{key:0,name:"solid spinner",spin:"",class:u(r(o).is("loading"))},null,8,["class"])):s.value?Z(e.$slots,"active-action",{key:1},()=>[e.activeActionIcon?(l(),b(r(w),{key:0,name:e.activeActionIcon},null,8,["name"])):v("",!0)]):s.value?v("",!0):Z(e.$slots,"inactive-action",{key:2},()=>[e.inactiveActionIcon?(l(),b(r(w),{key:0,name:e.inactiveActionIcon},null,8,["name"])):v("",!0)])],2)],6),!e.inlinePrompt&&(e.activeIcon||e.activeText)?(l(),h("span",{key:1,class:u(re.value)},[e.activeIcon?(l(),b(r(w),{key:0,name:e.activeIcon},null,8,["name"])):v("",!0),!e.activeIcon&&e.activeText?(l(),h("span",{key:1,"aria-hidden":!s.value},M(e.activeText),9,Me)):v("",!0)],2)):v("",!0)],2))}}),d=Ie(ne,{Switch:ne}),He="1.1.28",U={"@flash-global66/g-form":"^0.2.0","@flash-global66/g-icon-font":"^0.10.0",vue:"^3.2.0"},la={title:"Form/Switch",component:d,parameters:{docs:{description:{component:`
...
`}}},argTypes:{modelValue:{description:"Valor de enlace del Switch (v-model). Debe ser equivalente a active-value o inactive-value.",control:"boolean",table:{category:"Principales",type:{summary:"boolean | string | number"},defaultValue:{summary:"false"}}},activeValue:{description:"Valor del switch cuando está en estado activo.",control:"text",table:{category:"Principales",type:{summary:"boolean | string | number"},defaultValue:{summary:"true"}}},inactiveValue:{description:"Valor del switch cuando está en estado inactivo.",control:"text",table:{category:"Principales",type:{summary:"boolean | string | number"},defaultValue:{summary:"false"}}},size:{description:"Tamaño del Switch.",control:"select",options:["","large","default","small"],table:{category:"Apariencia",type:{summary:"'large' | 'default' | 'small'"},defaultValue:{summary:"default"}}},width:{description:"Ancho personalizado del Switch.",control:"text",table:{category:"Apariencia",type:{summary:"number | string"},defaultValue:{summary:"auto"}}},inlinePrompt:{description:"Si el icono o texto se muestra dentro del punto del switch.",control:"boolean",table:{category:"Apariencia",type:{summary:"boolean"},defaultValue:{summary:"false"}}},activeIcon:{description:"Icono mostrado cuando está en estado activo.",control:"select",options:["",...D()],table:{category:"Iconos",type:{summary:"IconString"},defaultValue:{summary:"—"}}},inactiveIcon:{description:"Icono mostrado cuando está en estado inactivo.",control:"select",options:["",...D()],table:{category:"Iconos",type:{summary:"IconString"},defaultValue:{summary:"—"}}},activeActionIcon:{description:"Icono mostrado en la acción cuando está en estado activo.",control:"select",options:["",...D()],table:{category:"Iconos",type:{summary:"IconString"},defaultValue:{summary:"—"}}},inactiveActionIcon:{description:"Icono mostrado en la acción cuando está en estado inactivo.",control:"select",options:["",...D()],table:{category:"Iconos",type:{summary:"IconString"},defaultValue:{summary:"—"}}},activeText:{description:"Texto mostrado cuando está en estado activo.",control:"text",table:{category:"Texto",type:{summary:"string"},defaultValue:{summary:""}}},inactiveText:{description:"Texto mostrado cuando está en estado inactivo.",control:"text",table:{category:"Texto",type:{summary:"string"},defaultValue:{summary:""}}},disabled:{description:"Si el Switch está deshabilitado.",control:"boolean",table:{category:"Estados",type:{summary:"boolean"},defaultValue:{summary:"false"}}},loading:{description:"Si el Switch está en estado de carga.",control:"boolean",table:{category:"Estados",type:{summary:"boolean"},defaultValue:{summary:"false"}}},validateEvent:{description:"Si debe activar la validación del formulario cuando cambia el valor.",control:"boolean",table:{category:"Validación y Formularios",type:{summary:"boolean"},defaultValue:{summary:"true"}}},beforeChange:{description:"Función ejecutada antes del cambio. Si retorna false o una Promise rechazada, previene el cambio.",table:{category:"Validación y Formularios",type:{summary:"() => boolean | Promise<boolean>"},defaultValue:{summary:"—"}}},name:{description:"Atributo name nativo del input del Switch.",control:"text",table:{category:"Atributos HTML",type:{summary:"string"},defaultValue:{summary:""}}},id:{description:"ID para el input del Switch.",control:"text",table:{category:"Atributos HTML",type:{summary:"string"},defaultValue:{summary:"auto-generado"}}},tabindex:{description:"Orden de tabulación del input.",control:"text",table:{category:"Atributos HTML",type:{summary:"string | number"},defaultValue:{summary:"—"}}},ariaLabel:{description:"Etiqueta ARIA para accesibilidad cuando no hay texto visible.",control:"text",table:{category:"Accesibilidad",type:{summary:"string"},defaultValue:{summary:"—"}}},onChange:{description:"Se dispara cuando el valor del switch cambia.",table:{category:"Eventos",type:{summary:"(value: boolean | string | number) => void"}}},"onUpdate:modelValue":{description:"Se dispara para actualizar el v-model.",table:{category:"Eventos",type:{summary:"(value: boolean | string | number) => void"}}},"active-action":{description:"Contenido personalizado para la acción cuando está activo.",table:{category:"Slots",type:{summary:"slot"}}},"inactive-action":{description:"Contenido personalizado para la acción cuando está inactivo.",table:{category:"Slots",type:{summary:"slot"}}}},args:{modelValue:!1,disabled:!1,loading:!1,size:"",width:"",inlinePrompt:!1,activeIcon:"",inactiveIcon:"",activeActionIcon:"",inactiveActionIcon:"",activeText:"",inactiveText:"",activeValue:!0,inactiveValue:!1,name:"",validateEvent:!0,id:"",tabindex:"",ariaLabel:""}},A={name:"Uso básico",parameters:{docs:{description:{story:"El uso más básico del Switch. Vincula v-model a una variable de tipo Boolean. Las variables CSS --el-switch-on-color y --el-switch-off-color deciden el color de fondo en dos estados."},source:{code:'<g-switch v-model="value" />'}}},render:a=>({components:{GSwitch:d,GConfigProvider:m},setup(){const t=Se(a,"modelValue");return{args:a,value:t}},template:`
    ...
    `})},N={name:"Tamaños",parameters:{docs:{description:{story:"El Switch está disponible en diferentes tamaños: large, default (por defecto) y small."},source:{code:`<g-switch v-model="value" size="large" />
<g-switch v-model="value" />
<g-switch v-model="value" size="small" />`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!0),c=n(!0);return{valueLarge:a,valueDefault:t,valueSmall:c}},template:`
      <g-config-provider>
        <div class="space-y-4">
    ...
    `})},E={name:"Descripción de texto",parameters:{docs:{description:{story:"Puedes agregar los atributos active-text e inactive-text para mostrar textos. Usa el atributo inline-prompt para controlar si el texto se muestra dentro del punto."},source:{code:`<!-- Con texto -->
<g-switch
  v-model="value"
...
<g-switch
  ...
  inactive-text="Off"
  inline-prompt
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!0),c=n(!0),i=n(!0);return{value1:a,value2:t,value3:c,value4:i}},template:`
      <g-config-provider>
        <div class="space-y-4">
          <div class="flex items-center gap-4">
    ...
    `})},F={name:"Iconos personalizados",parameters:{docs:{description:{story:"Puedes agregar los atributos active-icon e inactive-icon para mostrar iconos. Usa el atributo inline-prompt para controlar si el icono se muestra dentro del punto."},source:{code:`<!-- Aprobado/Rechazado -->
<g-switch
  v-model="value"
  active-icon="solid check"
  inactive-icon="solid times"
...
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!0),c=n(!0),i=n(!0);return{value1:a,value2:t,value3:c,value4:i}},template:`
    ...
    `})},P={name:"Tipos de valor extendidos",parameters:{docs:{description:{story:"Puedes configurar los atributos active-value e inactive-value. Ambos reciben un valor de tipo Boolean, String o Number."},source:{code:`<!-- Números -->
<g-switch
  v-model="value"
  :active-value="100"
  :inactive-value="0"
...
<g-switch
  ...
  active-text="On"
  inactive-text="Off"
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(100),t=n("yes"),c=n(1);return{value1:a,value2:t,value3:c}},template:`
      <g-config-provider>
        <div class="space-y-4">
          <div class="flex items-center gap-4">
    ...
    `})},I={name:"Deshabilitado",parameters:{docs:{description:{story:"Agregar el atributo disabled deshabilita el Switch."},source:{code:`<g-switch v-model="value" disabled />
...
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!1);return{value1:a,value2:t}},template:`
      <g-config-provider>
        <div class="space-y-4">
          <div class="flex items-center gap-4">
    ...
    `})},T={name:"Estado de carga",parameters:{docs:{description:{story:"Configurar el atributo loading a true indica un estado de carga en el Switch."},source:{code:`<g-switch v-model="value" loading />
...
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!1);return{value1:a,value2:t}},template:`
    ...
    `})},V={name:"Prevenir cambio",parameters:{docs:{description:{story:"Configura la propiedad before-change. Si se devuelve false o se devuelve una Promise que luego es rechazada, se detendrá el cambio."},source:{code:`<!-- Con confirmación -->
<g-switch
  v-model="value"
...
<\/script>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!1),t=n(!1);return{value1:a,value2:t,beforeChange1:()=>confirm("¿Estás seguro de que quieres cambiar el estado?"),beforeChange2:()=>new Promise(p=>{setTimeout(()=>{p(confirm("¿Confirmar cambio después de 1 segundo?"))},1e3)})}},template:`
      <g-config-provider>
        <div class="space-y-4">
          <div class="flex items-center gap-4">
    ...
    `})},k={name:"Iconos de acción personalizados",parameters:{docs:{description:{story:"Puedes agregar los atributos active-action-icon e inactive-action-icon para mostrar iconos en las acciones."},source:{code:`<!-- Encendido/Apagado -->
<g-switch
  v-model="value"
...
<g-switch
  ...
  inactive-action-icon="regular circle-xmark"
  width="60px"
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!1),c=n(!0);return{value1:a,value2:t,value3:c}},template:`
      <g-config-provider>
        <div class="space-y-4">
          <div class="flex items-center gap-4">
...
</g-switch>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!1);return{value1:a,value2:t}},template:`
      <g-config-provider>
        <div class="space-y-4">
          <div class="flex items-center gap-4">
...
<g-switch
  ...
  inline-prompt
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=n(!0),t=n(!0),c=n(!0);return{value1:a,value2:t,value3:c}},template:`
      <g-config-provider>
        <div class="space-y-4">
          <div class="flex items-center gap-4">
    ...
    `})},R={name:"Validación de formulario",parameters:{docs:{description:{story:"Ejemplo completo de Switch con validación de formulario usando g-form, g-form-item, g-input y g-button. Muestra cómo integrar el switch con el sistema de formularios del design system para validación automática."},source:{code:`<g-form 
  ref="formRef"
  :model="formData" 
  :rules="formRules"
  label-width="auto"
...
<\/script>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m,GForm:Ve,GFormItem:Te,GInput:Oe,GButton:ke},setup(){const a=n(),t=ye({username:"",acceptTerms:!1,enableNotifications:!0});return{formRef:a,formData:t,formRules:{username:[{required:!0,message:"El nombre de usuario es requerido",trigger:"blur"},{min:3,message:"El nombre de usuario debe tener al menos 3 caracteres",trigger:"blur"}],acceptTerms:[{validator:(g,B,o)=>{B===!0?o():o(new Error("Debes aceptar los términos y condiciones"))},trigger:"change",required:!0}]},submitForm:async()=>{if(a.value)try{const g=await a.value.validate();alert(g?`¡Formulario válido!
Usuario: ${t.username}
Términos: ${t.acceptTerms?"Aceptados":"No aceptados"}
Notificaciones: ${t.enableNotifications?"Habilitadas":"Deshabilitadas"}`:"Por favor, corrige los errores del formulario antes de continuar.")}catch(g){console.log("📋 ERRORES DE VALIDACIÓN:",g),alert("Por favor, corrige los errores del formulario antes de continuar.")}},resetForm:()=>{a.value?.resetFields()}}},template:`
      <g-config-provider>
    ...
    `})},da=["Primary","Sizes","TextDescription","CustomIcons","ExtendedValueTypes","Disabled","Loading","PreventSwitching","CustomActionIcons","CustomActionSlots","CustomWidth","FormValidation"];A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  name: 'Uso básico',
  parameters: {
    docs: {
      description: {
...
}`,...R.parameters?.docs?.source}}};export{k as CustomActionIcons,O as CustomActionSlots,F as CustomIcons,z as CustomWidth,I as Disabled,P as ExtendedValueTypes,R as FormValidation,T as Loading,V as PreventSwitching,A as Primary,N as Sizes,E as TextDescription,da as __namedExportsOrder,la as default};
