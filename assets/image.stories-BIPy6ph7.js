import{r as t,c as I,o as h}from"./vue.esm-bundler-C6DRpX4R.js";import{I as r,_ as o,a as i}from"./Image-BMvtnlfw.js";import{k as z}from"./index-j0O9UhHW.js";import{Y as E}from"./index-D3Qnyw_e.js";import{c as S}from"./index-Bt0rM6Wu.js";import{R as G}from"./index-DEGGxn4j.js";import{G as d}from"./ConfigProvider-CHVLgL_2.js";import"./props.util-DQIcYPkU.js";import"./error.util-CtUs3PUB.js";import"./index-B8Dg1tZU.js";import"./index-OmpdNH0g.js";import"./useNamespace-D200ZTkz.js";import"./useId-BGX2ZA7H.js";import"./useEmptyValues-8bO_IQ4-.js";import"./index-BnOtqFZS.js";import"./install.util-cBz1HN_T.js";import"./event.constant-LtAI3-H4.js";import"./useAttrs-Dmae7bQW.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const H={title:"Basic/Image",component:o,parameters:{docs:{description:{component:`
# Image Component
...
import { GImage } from '@flash-global66/g-image';
<\/script>
`,language:"html"}}}},m={name:"Tamaños disponibles",render:a=>({components:{GImage:o,GConfigProvider:d},setup(){const s=Object.keys(i);return{args:a,sizes:s,IMAGE_SIZES:i}},template:`
      <g-config-provider>
...
`,language:"html"}}},render:()=>({components:{GImage:o,GConfigProvider:d,GSegmented:z,GInput:E,GButton:S,GIconFont:G},setup(){const a=t("md"),s=t(""),g=t(null),f=Object.keys(i).map(e=>({label:e.toUpperCase(),value:e})),p=t([...r]),x=I(()=>{switch(a.value){case"xs":case"sm":return"grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8";case"md":return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6";case"lg":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"xl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"2xl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3";case"3xl":return"grid-cols-1 sm:grid-cols-2";default:return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6"}}),u=()=>{if(!s.value.trim()){p.value=[...r];return}const e=s.value.toLowerCase().trim();p.value=r.filter(b=>b.toLowerCase().includes(e))},v=()=>{s.value="",u()},y=e=>{navigator.clipboard.writeText(e).then(()=>{g.value=e,setTimeout(()=>{g.value=null},1500),console.log("Nombre de la ilustración copiado al portapapeles")}).catch(()=>{alert("No se pudo copiar el nombre de la ilustración")})};return h(()=>{const e=document.createElement("style");return e.textContent=`
          .copy-animation {
        ...
        `,document.head.appendChild(e),()=>{e.parentNode&&e.parentNode.removeChild(e)}}),{IMAGE_NAMES:r,IMAGE_SIZES:i,selectedSize:a,sizeOptions:f,searchTerm:s,clearSearch:v,copyImageName:y,filteredImages:p,updateFilteredImages:u,copiedImage:g,gridColumns:x}},template:`
      <g-config-provider>
        <div class="space-y-8">
          <g-segmented
            block
...
}`,...c.parameters?.docs?.source}}};const R=["Primary","Sizes","Gallery","ErrorHandling"];export{c as ErrorHandling,l as Gallery,n as Primary,m as Sizes,R as __namedExportsOrder,H as default};
