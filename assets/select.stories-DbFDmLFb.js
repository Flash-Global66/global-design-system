import{r as n,E as F}from"./iframe-Dct5CHxr.js";import{G as a}from"./index-BYFu75cy.js";import{G as o}from"./ConfigProvider-7dg58IlU.js";import{g as D}from"./documentation-stories-DmJzCMmf.js";import"./preload-helper-Dch09mLN.js";import"./useEmptyValues-BnYvcW4O.js";import"./useCalcInputWidth-BGo-O_zj.js";import"./index-DWhPhD7W.js";import"./index-pMiYc9r3.js";import"./index-BpP4et0s.js";import"./index-CZoNQBHQ.js";import"./useId-MLHLvdkG.js";import"./install.util-cBz1HN_T.js";import"./index-DxlLUiSm.js";import"./event.constant-LtAI3-H4.js";import"./index-BgdLHs-h.js";import"./index-1T7U7QlS.js";import"./index-pWeg55FS.js";import"./index-CTQoWvO3.js";import"./debounce-B22JU7A-.js";import"./isEqual-D4JTyA6f.js";import"./hasIn-CMXABBS8.js";import"./index-DR8mscXh.js";import"./useAttrs-BZi71rd1.js";import"./Skeleton-8SKRGv7V.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./useLocale-pH4k1Kvj.js";import"./clickOutside.directive-DcIDdwE1.js";import"./index-GU5Cqqg3.js";const te={title:"Form/Select",component:a,parameters:{docs:{description:{component:`✨ \`GSelect\` - Componente de selección interactivo y personalizable
...
- Evita desajustes de espacio/scroll al abrir y cerrar el dropdown con listas grandes.`}}},render:()=>({components:{GSelect:a,GConfigProvider:o},setup(){const t=["a","b","c","d","e","f","g","h","i","j"],e=n(),s=n(),r=Array.from({length:1e3}).map((S,l)=>({value:`Option ${l+1}`,title:`${t[l%10]}${l} - option ${l+1}`,description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris in enim elementum, sagittis velit eu, feugiat sem. Sed lacinia tincidunt lacinia.",icon:l%2===0?"regular bolt":"regular user",disabled:l%3===0&&l!==0}));return{value:e,options:r,value2:s}},template:`
      <g-config-provider>
...
- Búsqueda de opciones
- Mapeo de propiedades`}}},render:()=>({components:{GSelect:a,GConfigProvider:o},setup(){const t=n(),e=n(!1),s=n([]),r={title:"title",description:"body",value:"id"},S=async c=>{try{return e.value=!0,await(await fetch(`https://jsonplaceholder.typicode.com/posts?q=${c}`)).json()}catch(C){return console.error("Error fetching data:",C),[]}finally{e.value=!1}};return{value:t,options:s,handleSearch:async c=>{s.value=await S(c)},loading:e,mappingProps:r}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
...
- Permite borrar la selección actual`}}},render:()=>({components:{GSelect:a,GConfigProvider:o},setup(){return{value:n(),options:[{value:"1",title:"Opción 1"},{value:"2",title:"Opción 2"},{value:"3",title:"Opción 3"},{value:"4",title:"Opción 4"},{value:"5",title:"Opción 5"},{value:"6",title:"Opción 6"},{value:"7",title:"Opción 7"}]}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
    ...
    `})},w=()=>{alert("Click en el input")},v={name:"Estados",parameters:{docs:{description:{story:`Los selects pueden tener diferentes estados que indican su comportamiento y apariencia:
...
- **Loading**: Estado de carga durante operaciones asíncronas`}}},render:()=>({components:{GSelect:a,GConfigProvider:o},setup(){return{states:F({enabled:"",completed:"2",disabled:"Select deshabilitado",event:"",error:"",loading:""}),handleClick:w,options:[{value:"1",title:"Opción 1",description:"Descripción de la opción 1",icon:"regular bolt"},{value:"2",title:"Opción 2",description:"Descripción de la opción 2",icon:"regular user"},{value:"3",title:"Opción 3",description:"Descripción de la opción 3",icon:"regular bolt"},{value:"4",title:"Opción 4",description:"Descripción de la opción 4",icon:"regular user"},{value:"5",title:"Opción 5",description:"Descripción de la opción 5",icon:"regular bolt"}]}},template:`
    ...
    `})},f={name:"Selección múltiple con tags colapsados",parameters:{docs:{description:{story:"Cuando hay muchos valores seleccionados, los tags se pueden colapsar en uno solo.\n\n- `collapseTags`: muestra un solo tag con el número de seleccionados\n- `collapseTagsTooltip`: al hacer hover se ven todos los tags\n- `maxCollapseTags`: cuántos tags mostrar antes de colapsar (por defecto 1)"}}},render:()=>({components:{GSelect:a,GConfigProvider:o},setup(){return{value:n(["react","vue","angular"]),options:[{value:"react",title:"React"},{value:"vue",title:"Vue"},{value:"angular",title:"Angular"},{value:"svelte",title:"Svelte"},{value:"solid",title:"Solid"}]}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
    ...
    `})},h={name:"Agrupación + selección múltiple",parameters:{docs:{description:{story:"Combinación de opciones agrupadas con selección múltiple. Ideal para elegir varios ítems de distintas categorías."}}},render:()=>({components:{GSelect:a,GConfigProvider:o},setup(){return{value:n([]),optionsWithGroups:[{title:"Frontend",options:[{value:"html",title:"HTML"},{value:"css",title:"CSS"},{value:"js",title:"JavaScript"}]},{title:"Backend",options:[{value:"node",title:"Node.js"},{value:"python",title:"Python"},{value:"go",title:"Go"}]},{title:"Database",options:[{value:"mysql",title:"MySQL"},{value:"postgresql",title:"PostgreSQL"},{value:"mongodb",title:"MongoDB"}]},{title:"DevOps",options:[{value:"docker",title:"Docker"},{value:"kubernetes",title:"Kubernetes"},{value:"terraform",title:"Terraform"}]}]}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
          label="Tecnologías"
    ...
    `})},E={name:"Límite de líneas en opciones",parameters:{docs:{description:{story:`Las props title-lines y description-lines permiten controlar cuántas líneas se muestran en el título y la descripción de cada opción del dropdown.
...
- Si el contenido ocupa más altura, recuerda ajustar item-height para evitar cortes visuales durante la virtualización.`}}},render:()=>({components:{GSelect:a,GConfigProvider:o},setup(){const t=n(),e=n(),s=n();return{value0:t,value1:e,value2:s,longDescriptionOptions:[{value:"1",title:"Transporte de carga nacional e internacional con servicios complementarios",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris in enim elementum, sagittis velit eu, feugiat sem. Sed lacinia tincidunt lacinia. Donec molestie lacus nec risus semper lobortis.",icon:"regular bolt"},{value:"2",title:"Servicios de asesoría tributaria y contable para empresas medianas y grandes",description:"Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, rhoncus id, erat. Fusce rhoncus, massa sed semper.",icon:"regular user"},{value:"3",title:"Comercialización y distribución de equipos tecnológicos para operaciones críticas",description:"Aenean ut eros et nisl sagittis vestibulum. Nullam nulla eros, ultricies sit amet, nonummy ac, gravida a, est. Proin eget sem. Sed viverra viverra nisl. Curabitur suscipit suscipit tellus.",icon:"regular bolt"},{value:"4",title:"Gestión logística integral para abastecimiento, almacenamiento y última milla",description:"Phasellus lacinia, magna a ullamcorper laoreet, lectus arcu pulvinar risus, vitae facilisis libero dolor a purus. Sed dignissim, metus nec consectetuer malesuada, ipsum augue molestie justo, sed accumsan nisi nunc sit amet erat.",icon:"regular user"}]}},template:`
    ...
    `})},ae=["Basic","withAllProps","remoteSearch","selectorCountries","clearable","states","multiple","multipleEmptyDisplay","multipleCollapseTags","grouped","groupedMultiple","optionLinesLimit"];p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: 'Básico',
  render: args => ({
    components: {
      GSelect,
...
}`,...E.parameters?.docs?.source}}};export{p as Basic,ae as __namedExportsOrder,g as clearable,te as default,x as grouped,h as groupedMultiple,y as multiple,f as multipleCollapseTags,b as multipleEmptyDisplay,E as optionLinesLimit,u as remoteSearch,m as selectorCountries,v as states,d as withAllProps};
