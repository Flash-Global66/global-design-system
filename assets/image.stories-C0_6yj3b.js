import{r,c as I,o as z}from"./vue.esm-bundler-Deokl1F5.js";import{I as t,_ as o,a as i}from"./Image--71F9F6b.js";import{k as h}from"./index-BSlT5vNE.js";import{Y as E}from"./index-lPLfKK5e.js";import{c as S}from"./index-Ds4yDDWZ.js";import{$ as G}from"./index-Dm8NAQRh.js";import{G as d}from"./ConfigProvider-DiWOjIRd.js";import"./props.util-Dtwzmmnf.js";import"./error.util-CmMZjXeT.js";import"./index-Cla1j_Lq.js";import"./index-D9lthdDW.js";import"./useEmptyValues-S5EffpHc.js";import"./index-_KM9XPN4.js";import"./event.constant-LtAI3-H4.js";import"./useAttrs-DWFI2ZT4.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const D={title:"Basic/Image",component:o,parameters:{docs:{description:{component:`
# Image Component
...
`,language:"html"}}},render:()=>({components:{GImage:o,GConfigProvider:d,GSegmented:h,GInput:E,GButton:S,GIconFont:G},setup(){const a=r("md"),s=r(""),g=r(null),f=Object.keys(i).map(e=>({label:e.toUpperCase(),value:e})),p=r([...t]),x=I(()=>{switch(a.value){case"xs":case"sm":return"grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8";case"md":return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6";case"lg":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"xl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"xxl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3";case"xxxl":return"grid-cols-1 sm:grid-cols-2";default:return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6"}}),u=()=>{if(!s.value.trim()){p.value=[...t];return}const e=s.value.toLowerCase().trim();p.value=t.filter(b=>b.toLowerCase().includes(e))},v=()=>{s.value="",u()},y=e=>{navigator.clipboard.writeText(e).then(()=>{g.value=e,setTimeout(()=>{g.value=null},1500),console.log("Nombre de la ilustración copiado al portapapeles")}).catch(()=>{alert("No se pudo copiar el nombre de la ilustración")})};return z(()=>{const e=document.createElement("style");return e.textContent=`
          .copy-animation {
        ...
        `,document.head.appendChild(e),()=>{e.parentNode&&e.parentNode.removeChild(e)}}),{IMAGE_NAMES:t,IMAGE_SIZES:i,selectedSize:a,sizeOptions:f,searchTerm:s,clearSearch:v,copyImageName:y,filteredImages:p,updateFilteredImages:u,copiedImage:g,gridColumns:x}},template:`
      <g-config-provider>
        <div class="space-y-8">
          <g-segmented
            block
...
}`,...c.parameters?.docs?.source}}};const B=["Primary","Sizes","Gallery","ErrorHandling"];export{c as ErrorHandling,l as Gallery,n as Primary,m as Sizes,B as __namedExportsOrder,D as default};
