import{d as ne,r as I,H as le,c as d,x as b,w as V,e as h,m as q,s as B,u,l as x,k as A,n as me,F as ce,z as de,A as pe,y as H,t as ge,o as ue}from"./vue.esm-bundler-DNj4lB-B.js";import{I as E,_ as z,a as v}from"./Image-BYNNeYEH.js";import{u as fe,Y as xe,G as ve,H as ye}from"./index-CKHqQBpj.js";import{b as be,a as he}from"./index-CP3_1Uby.js";import{f as Ie,u as Ee}from"./install-B47IWttr.js";import{u as Se}from"./index-DG2QIyoI.js";import{U as R,C as X}from"./event-HEVJa2N9.js";import{r as ze}from"./index-t0DH7S_u.js";import{y as Ge}from"./index-Yq5lagKs.js";import{C as Ae}from"./index-BJCEAk-P.js";import{G as N}from"./ConfigProvider-Dyindn-M.js";import"./error-Cq9Fpw4b.js";import"./index-C0ZH0EVy.js";import"./index-BkReybPT.js";import"./_arrayPush-BERo1YoZ.js";import"./index-tPx7VOd5.js";import"./index-DxdbiDHw.js";import"./index-CJz6wvsP.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";/**
* @vue/shared v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Me=Object.prototype.hasOwnProperty,Y=(e,r)=>Me.call(e,r),$=e=>typeof e=="string",S=e=>e!==null&&typeof e=="object";const D=e=>typeof e=="boolean",F=e=>typeof e=="number",W="__epPropKey",M=e=>e,je=e=>S(e)&&!!e[W],Ce=(e,r)=>{if(!S(e)||je(e))return e;const{values:s,required:m,default:i,type:y,validator:p}=e,l={type:y,required:!!m,validator:s||p?f=>{let t=!1,n=[];if(s&&(n=Array.from(s),Y(e,"default")&&n.push(i),t||(t=n.includes(f))),p&&(t||(t=p(f))),!t&&n.length>0){const T=[...new Set(n)].map(o=>JSON.stringify(o)).join(", ");ge(`Invalid prop: validation failed${r?` for prop "${r}"`:""}. Expected one of [${T}], got value ${JSON.stringify(f)}.`)}return t}:void 0,[W]:!0};return Y(e,"default")&&(l.default=i),l},_e=e=>Ie(Object.entries(e).map(([r,s])=>[r,Ce(s,r)])),we=(e,r)=>{if(e.install=s=>{for(const m of[e,...Object.values(r??{})])s.component(m.name,m)},r)for(const[s,m]of Object.entries(r))e[s]=m;return e},Ne=_e({variant:{type:M(String),default:"default"},rounded:{type:M(String),default:"md"},classItem:{type:String,default:""},options:{type:M(Array),default:()=>[]},modelValue:{type:[String,Number,Boolean,null],default:void 0},block:Boolean,size:{type:M(String),default:"md"},disabled:Boolean,validateEvent:{type:Boolean,default:!0},messageError:{type:String,default:""},helpText:{type:String,default:""},id:String,name:String,...Se(["ariaLabel"])}),Te={[R]:e=>$(e)||F(e)||D(e),[X]:e=>$(e)||F(e)||D(e)},ke={class:"flex flex-col gap-xs"},Le=["id","aria-label","aria-labelledby"],Oe=["name","disabled","checked","onChange"],U=ne({__name:"Segmented",props:Ne,emits:Te,setup(e,{emit:r}){const s=e,m=r,i=Ee("segmented"),y=fe(),p=xe(),{formItem:l}=ve(),{inputId:f,isLabeledByFormItem:t}=ye(s,{formItemContext:l}),n=I(null),T=be(),o=le({isInit:!1,width:0,height:0,translateX:0,translateY:0,focusVisible:!1}),G=d(()=>l?.shouldShowErrorChild||!!s?.messageError),J=d(()=>[i.e("help"),{[i.e("help-error")]:G.value}]),k=d(()=>s?.messageError?s.messageError:l?.validateMessage);d(()=>k.value||l?.$el);const K=a=>{const g=L(a);m(R,g),m(X,g)},L=a=>S(a)?a?.value:a,Q=a=>S(a)?a?.label:a,O=a=>!!(p.value||S(a)&&a?.disabled),Z=a=>s.modelValue===L(a),ee=a=>s.options.find(g=>L(g)===a),ae=a=>[i.e("item"),i.is("selected",Z(a)),i.is("disabled",O(a)),s.classItem],P=()=>{if(!n.value)return;const a=n.value.querySelector(".is-selected"),g=n.value.querySelector(".is-selected input");if(!a||!g){o.width=0,o.height=0,o.translateX=0,o.translateY=0,o.focusVisible=!1;return}const c=a.getBoundingClientRect();o.isInit=!0,o.width=c.width,o.translateX=a.offsetLeft;try{o.focusVisible=g.matches(":focus-visible")}catch{}},se=d(()=>[i.b(),i.m(s.size),i.m(s.variant),i.is("block",s.block),i.m(`rounded-${s.rounded}`)]),ie=d(()=>({width:`${o.width}px`,height:"100%",transform:`translateX(${o.translateX}px)`,display:o.isInit?"block":"none"})),te=d(()=>[i.e("item-selected"),i.is("disabled",O(ee(s.modelValue))),i.is("focus-visible",o.focusVisible)]),re=d(()=>s.name||y.value);return he(n,P),V(T,P),V(()=>s.modelValue,()=>{P(),s.validateEvent&&l?.validate?.("change").catch(a=>void 0)},{flush:"post"}),(a,g)=>(h(),b("div",ke,[a.options.length?(h(),b("div",{key:0,class:x(se.value),id:u(f),ref_key:"segmentedRef",ref:n,role:"radiogroup","aria-label":u(t)?void 0:a.ariaLabel||"segmented","aria-labelledby":u(t)?u(l).labelId:void 0},[A("div",{class:x([u(i).e("group")])},[A("div",{style:me(ie.value),class:x(te.value)},null,6),(h(!0),b(ce,null,de(a.options,(c,oe)=>(h(),b("label",{key:oe,class:x(ae(c))},[A("input",{class:x(u(i).e("item-input")),type:"radio",name:re.value,disabled:O(c),checked:Z(c),onChange:Pe=>K(c)},null,42,Oe),A("div",{class:x(u(i).e("item-label"))},[B(a.$slots,"default",{item:c,isActive:Z(c)},()=>[pe(H(Q(c)),1)])],2)],2))),128))],2)],10,Le)):q("",!0),B(a.$slots,"help",{error:k.value,isError:G.value},()=>[u(l)||a.helpText?(h(),b("p",{key:G.value?"error":"help",class:x(J.value)},H(G.value?k.value:a.helpText),3)):q("",!0)])]))}}),Ze=we(U,{Segmented:U}),ta={title:"Basic/Image",component:z,parameters:{docs:{description:{component:`
# Image Component
...
}`,...w.parameters?.docs?.source}}};const ra=["Primary","Sizes","Gallery","ErrorHandling"];export{w as ErrorHandling,_ as Gallery,j as Primary,C as Sizes,ra as __namedExportsOrder,ta as default};
