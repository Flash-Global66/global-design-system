import{e as U,r as i,g as C,a8 as se,W as F,t as I,O as le,q as E,H as Z,D as ee,j as T,S as ie,a3 as ce,k as V,v as W,p as N,h as te,K as de,I as X,w as Y,Q as pe,b as me,ac as ue,o as ve,n as Q,ad as ge,l as fe,M as be,a7 as ye,m as he}from"./vue.esm-bundler-BmNPGRkA.js";import{b as $,u as Se}from"./index-CSx2dOih.js";import{x as K,u as re,b as we,i as H,l as ze,z as xe,G as P}from"./ConfigProvider-DXUgDH9p.js";import{t as Ce}from"./error-Cq9Fpw4b.js";import{u as ke}from"./index-BBJgTkeT.js";import{a as J}from"./style-CWH1CnyT.js";import"./index-BHYX4iOF.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./_arrayPush-BTZjb8bE.js";const x=4,Ee={vertical:{offset:"offsetHeight",scroll:"scrollTop",scrollSize:"scrollHeight",size:"height",key:"vertical",axis:"Y",client:"clientY",direction:"top"},horizontal:{offset:"offsetWidth",scroll:"scrollLeft",scrollSize:"scrollWidth",size:"width",key:"horizontal",axis:"X",client:"clientX",direction:"left"}},He=({move:a,size:c,bar:n})=>({[n.size]:c,transform:`translate${n.axis}(${a}%)`}),q=Symbol("scrollbarContextKey"),Te=K({vertical:Boolean,size:String,move:Number,ratio:{type:Number,required:!0},always:Boolean}),Ne="Thumb",D=U({__name:"thumb",props:Te,setup(a){const c=a,n=ee(q),r=re("scrollbar");n||Ce(Ne,"can not inject scrollbar context");const p=i(),l=i(),y=i({}),u=i(!1);let m=!1,v=!1,S=we?document.onselectstart:null;const t=C(()=>Ee[c.vertical?"vertical":"horizontal"]),o=C(()=>He({size:c.size,move:c.move,bar:t.value})),s=C(()=>p.value[t.value.offset]**2/n.wrapElement[t.value.scrollSize]/c.ratio/l.value[t.value.offset]),g=e=>{if(e.stopPropagation(),e.ctrlKey||[1,2].includes(e.button))return;window.getSelection()?.removeAllRanges(),z(e);const d=e.currentTarget;d&&(y.value[t.value.axis]=d[t.value.offset]-(e[t.value.client]-d.getBoundingClientRect()[t.value.direction]))},w=e=>{if(!l.value||!p.value||!n.wrapElement)return;const d=Math.abs(e.target.getBoundingClientRect()[t.value.direction]-e[t.value.client]),G=l.value[t.value.offset]/2,j=(d-G)*100*s.value/p.value[t.value.offset];n.wrapElement[t.value.scroll]=j*n.wrapElement[t.value.scrollSize]/100},z=e=>{e.stopImmediatePropagation(),m=!0,document.addEventListener("mousemove",f),document.addEventListener("mouseup",b),S=document.onselectstart,document.onselectstart=()=>!1},f=e=>{if(!p.value||!l.value||m===!1)return;const d=y.value[t.value.axis];if(!d)return;const G=(p.value.getBoundingClientRect()[t.value.direction]-e[t.value.client])*-1,j=l.value[t.value.offset]-d,ne=(G-j)*100*s.value/p.value[t.value.offset];n.wrapElement[t.value.scroll]=ne*n.wrapElement[t.value.scrollSize]/100},b=()=>{m=!1,y.value[t.value.axis]=0,document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",b),h(),v&&(u.value=!1)},M=()=>{v=!1,u.value=!!c.size},O=()=>{v=!0,u.value=m};se(()=>{h(),document.removeEventListener("mouseup",b)});const h=()=>{document.onselectstart!==S&&(document.onselectstart=S)};return $(F(n,"scrollbarElement"),"mousemove",M),$(F(n,"scrollbarElement"),"mouseleave",O),(e,d)=>(T(),I(le,{name:E(r).b("fade")},{default:Z(()=>[ie(V("div",{ref_key:"instance",ref:p,class:N([E(r).e("bar"),E(r).is(t.value.key)]),onMousedown:w},[V("div",{ref_key:"thumb",ref:l,class:N(E(r).e("thumb")),style:W(o.value),onMousedown:g},null,38)],34),[[ce,e.always||u.value]])]),_:1},8,["name"]))}});D.__docgenInfo={exportName:"default",displayName:"thumb",description:"",tags:{},sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/scrollbar/src/thumb.vue"]};const Pe=K({always:{type:Boolean,default:!0},minSize:{type:Number,required:!0}}),ae=U({__name:"bar",props:Pe,setup(a,{expose:c}){const n=a,r=ee(q),p=i(0),l=i(0),y=i(""),u=i(""),m=i(1),v=i(1);return c({handleScroll:o=>{if(o){const s=o.offsetHeight-x,g=o.offsetWidth-x;l.value=o.scrollTop*100/s*m.value,p.value=o.scrollLeft*100/g*v.value}},update:()=>{const o=r?.wrapElement;if(!o)return;const s=o.offsetHeight-x,g=o.offsetWidth-x,w=s**2/o.scrollHeight,z=g**2/o.scrollWidth,f=Math.max(w,n.minSize),b=Math.max(z,n.minSize);m.value=w/(s-w)/(f/(s-f)),v.value=z/(g-z)/(b/(g-b)),u.value=f+x<s?`${f}px`:"",y.value=b+x<g?`${b}px`:""}}),(o,s)=>(T(),te(de,null,[X(D,{move:p.value,ratio:v.value,size:y.value,always:o.always},null,8,["move","ratio","size","always"]),X(D,{move:l.value,ratio:m.value,size:u.value,vertical:"",always:o.always},null,8,["move","ratio","size","always"])],64))}});ae.__docgenInfo={exportName:"default",displayName:"bar",description:"",tags:{},expose:[{name:"handleScroll"},{name:"update"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/scrollbar/src/bar.vue"]};const _e=K({height:{type:[String,Number],default:""},maxHeight:{type:[String,Number],default:""},native:{type:Boolean,default:!1},wrapStyle:{type:ze([String,Object,Array]),default:""},wrapClass:{type:[String,Array],default:""},viewClass:{type:[String,Array],default:""},viewStyle:{type:[String,Array,Object],default:""},noresize:Boolean,tag:{type:String,default:"div"},always:Boolean,minSize:{type:Number,default:20},tabindex:{type:[String,Number],default:void 0},id:String,role:String,...ke(["ariaLabel","ariaOrientation"])}),Le={scroll:({scrollTop:a,scrollLeft:c})=>[a,c].every(H)},Ae=["tabindex"],Re="GScrollbar",oe=U({name:Re,__name:"scrollbar",props:_e,emits:Le,setup(a,{expose:c,emit:n}){const r=a,p=n,l=re("scrollbar");let y,u,m=0,v=0;const S=i(),t=i(),o=i(),s=i(),g=C(()=>{const e={};return r.height&&(e.height=J(r.height)),r.maxHeight&&(e.maxHeight=J(r.maxHeight)),[r.wrapStyle,e]}),w=C(()=>[r.wrapClass,l.e("wrap"),{[l.em("wrap","hidden-default")]:!r.native}]),z=C(()=>[l.e("view"),r.viewClass]),f=()=>{t.value&&(s.value?.handleScroll(t.value),m=t.value.scrollTop,v=t.value.scrollLeft,p("scroll",{scrollTop:t.value.scrollTop,scrollLeft:t.value.scrollLeft}))};function b(e,d){ye(e)?t.value.scrollTo(e):H(e)&&H(d)&&t.value.scrollTo(e,d)}const M=e=>{H(e)&&(t.value.scrollTop=e)},O=e=>{H(e)&&(t.value.scrollLeft=e)},h=()=>{s.value?.update()};return Y(()=>r.noresize,e=>{e?(y?.(),u?.()):({stop:y}=Se(o,h),u=$("resize",h))},{immediate:!0}),Y(()=>[r.maxHeight,r.height],()=>{r.native||Q(()=>{h(),t.value&&s.value?.handleScroll(t.value)})}),pe(q,me({scrollbarElement:S,wrapElement:t})),ue(()=>{t.value&&(t.value.scrollTop=m,t.value.scrollLeft=v)}),ve(()=>{r.native||Q(()=>{h()})}),ge(()=>h()),c({wrapRef:t,update:h,scrollTo:b,setScrollTop:M,setScrollLeft:O,handleScroll:f}),(e,d)=>(T(),te("div",{ref_key:"scrollbarRef",ref:S,class:N(E(l).b())},[V("div",{ref_key:"wrapRef",ref:t,class:N(w.value),style:W(g.value),tabindex:e.tabindex,onScroll:f},[(T(),I(be(e.tag),{id:e.id,ref_key:"resizeRef",ref:o,class:N(z.value),style:W(e.viewStyle),role:e.role,"aria-label":e.ariaLabel,"aria-orientation":e.ariaOrientation},{default:Z(()=>[he(e.$slots,"default")]),_:3},8,["id","class","style","role","aria-label","aria-orientation"]))],46,Ae),e.native?fe("",!0):(T(),I(ae,{key:0,ref_key:"barRef",ref:s,always:e.always,"min-size":e.minSize},null,8,["always","min-size"]))],2))}});oe.__docgenInfo={exportName:"default",displayName:"scrollbar",description:"",tags:{},expose:[{name:"wrapRef",tags:[{title:"description",content:"scrollbar wrap ref"}]},{name:"update",tags:[{title:"description",content:"update scrollbar state manually"}]},{name:"scrollTo",tags:[{title:"description",content:"scrolls to a particular set of coordinates"}]},{name:"setScrollTop",tags:[{title:"description",content:"set distance to scroll top"}]},{name:"setScrollLeft",tags:[{title:"description",content:"set distance to scroll left"}]},{name:"handleScroll",tags:[{title:"description",content:"handle scroll event"}]}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/scrollbar/src/scrollbar.vue"]};const k=xe(oe),De={title:"Basic/Scrollbar",component:k,parameters:{docs:{description:{component:"Componente personalizado de scrollbar que proporciona una barra de desplazamiento personalizable."}}},argTypes:{height:{description:"Altura del contenedor del scrollbar",control:"text",table:{type:{summary:"string | number"}}},maxHeight:{description:"Altura máxima del contenedor del scrollbar",control:"text",table:{type:{summary:"string | number"}}},native:{description:"Usa la barra de desplazamiento nativa del navegador",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},wrapStyle:{description:"Estilos personalizados para el contenedor envolvente",control:"object",table:{type:{summary:"StyleValue"}}},wrapClass:{description:"Clase personalizada para el contenedor envolvente",control:"text",table:{type:{summary:"string"}}},viewClass:{description:"Clase personalizada para la vista del contenido",control:"text",table:{type:{summary:"string"}}},noresize:{description:"No responder a cambios de tamaño del contenedor",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},tag:{description:"Elemento HTML usado para el contenedor de la vista",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"div"}}},always:{description:"Mostrar siempre la barra de desplazamiento",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},minSize:{description:"Tamaño mínimo de la barra de desplazamiento",control:"number",table:{type:{summary:"number"},defaultValue:{summary:"20"}}},role:{description:"Atributo ARIA role",control:"text",table:{type:{summary:"string"}}},ariaLabel:{description:"Etiqueta ARIA para accesibilidad",control:"text",table:{type:{summary:"string"}}},ariaOrientation:{description:"Orientación ARIA (horizontal/vertical)",control:"select",options:["horizontal","vertical",void 0],table:{type:{summary:"string"}}},onScroll:{description:"Se emite cuando ocurre el evento de scroll",table:{type:{summary:"{ scrollTop: number, scrollLeft: number }"},category:"events"}},default:{description:"Contenido dentro del scrollbar",table:{type:{summary:"slot"},category:"slots"}}},args:{height:"",maxHeight:"",native:!1,noresize:!1,tag:"div",always:!1,minSize:20}},_={render:a=>({components:{GScrollbar:k,GConfigProvider:P},setup(){return{args:a}},template:`
      <g-config-provider>
...
}`,...B.parameters?.docs?.source}}};const Ue=["Primary","NativeScrollbar","HorizontalScroll","AlwaysVisible","CustomHeight"];export{R as AlwaysVisible,B as CustomHeight,A as HorizontalScroll,L as NativeScrollbar,_ as Primary,Ue as __namedExportsOrder,De as default};
