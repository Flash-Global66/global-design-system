import{r as y,c as u,D as $,a7 as de,w as R,d as H,h as b,u as o,n as f,p as W,o as v,O as pe,j as T,f as S,F as ge,m as ue,k as fe,l as be,t as P,v as ve}from"./vue.esm-bundler-BUoj5ptC.js";import{v as _e,u as X,f as xe,z as he,G as C}from"./ConfigProvider-CrOhbRZ6.js";import{d as ye}from"./error-Cq9Fpw4b.js";import{b as we,a as Ie,u as Ee}from"./index-Wt8uPs2i.js";import{Y as ze,G as Se,H as Ge}from"./index-Dh3Gw0Zf.js";import{u as Le}from"./index-BcGPpLRa.js";import{a as ke}from"./index-KaGzp0yT.js";import{u as Ae}from"./use-form-common-props-DyLglXeD.js";import{U as K,C as J}from"./event-BB_Ol6Sd.js";import{r as Ce}from"./index-CGH_u4Oy.js";import{b as Me}from"./index-CvOSMUbh.js";import{_ as je}from"./Icon-HxEiN7t9.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./_initCloneObject-MVraUcJR.js";import"./castArray-DceVieY3.js";import"./constants-Dnj8X3EN.js";import"./index-DESZvTKR.js";import"./index-JLKkvi6K.js";import"./index.es-DwVakxBA.js";import"./index-DDVpgGx_.js";import"./index-BOx2y-Jl.js";const w=["at","barrier","bell","bolt","calendar","card","celebration","chat-bubble","check","clock","disconnected-plug","document","dollar-currency","door","email","euro-currency","face-recognition","fingerprint","footsteps","gift-box","global66","globe","headset","id-card-back","id-card-front","information","location-pin","lock","magnifying-glass","otp","paper-airplane","pound-currency","price-tags","prohibited","refresh","sales","scissors","stairs","user","warning-sign","wrench"],I={xs:"44px",sm:"64px",md:"80px",lg:"112px",xl:"160px","2xl":"208px","3xl":"260px"},Ue=_e({name:{type:String,required:!0},size:{type:String,default:"md"},lazyLoad:{type:Boolean,default:!0}});function Ne(e){e.name&&!w.includes(e.name)&&ye("Image",`Invalid image name: "${e.name}". Available image names: ${w.join(", ")}`)}const Te=""+new URL("at-BEDGBG0o.webp",import.meta.url).href,Re=""+new URL("barrier-DqjQ7Ouy.webp",import.meta.url).href,Oe=""+new URL("bell-Bvu5__GY.webp",import.meta.url).href,De=""+new URL("bolt-D0YCAsGC.webp",import.meta.url).href,Be=""+new URL("calendar-Cnv2LVQ6.webp",import.meta.url).href,Pe=""+new URL("card-BsIfVS5g.webp",import.meta.url).href,Ze=""+new URL("celebration-Doif_9D6.webp",import.meta.url).href,Ve=""+new URL("chat-bubble-IwmZIZ49.webp",import.meta.url).href,qe=""+new URL("check-DTdLbdkq.webp",import.meta.url).href,Ye=""+new URL("clock-C6TyRzos.webp",import.meta.url).href,Fe=""+new URL("disconnected-plug-DFM5LMKP.webp",import.meta.url).href,$e=""+new URL("document-CjUwp8mY.webp",import.meta.url).href,He=""+new URL("dollar-currency-DZv1zqPb.webp",import.meta.url).href,We=""+new URL("door-Cxbc8i3c.webp",import.meta.url).href,Xe=""+new URL("email-CHmVGWjw.webp",import.meta.url).href,Ke=""+new URL("euro-currency-0Ny97PCz.webp",import.meta.url).href,Je=""+new URL("face-recognition-7TSbusUk.webp",import.meta.url).href,Qe=""+new URL("fingerprint-DodMIf86.webp",import.meta.url).href,ea=""+new URL("footsteps-DoJqOo3-.webp",import.meta.url).href,aa=""+new URL("gift-box-DKnbawrg.webp",import.meta.url).href,sa=""+new URL("global66-BZnpNLUE.webp",import.meta.url).href,ta=""+new URL("globe-BAr0rlVg.webp",import.meta.url).href,ia=""+new URL("headset-BALiiQWu.webp",import.meta.url).href,ra=""+new URL("id-card-back-Bhx9gVKN.webp",import.meta.url).href,oa=""+new URL("id-card-front-DeKyYfVu.webp",import.meta.url).href,na=""+new URL("information-ClTcDx7p.webp",import.meta.url).href,la=""+new URL("location-pin-CQkuIOkM.webp",import.meta.url).href,ma=""+new URL("lock-DsuKsrl1.webp",import.meta.url).href,ca=""+new URL("magnifying-glass-byF0hIc_.webp",import.meta.url).href,da=""+new URL("otp-CZYzFz0b.webp",import.meta.url).href,pa=""+new URL("paper-airplane-DI2QwMV0.webp",import.meta.url).href,ga=""+new URL("pound-currency-dJeYkU-W.webp",import.meta.url).href,ua=""+new URL("price-tags-BJLThI-M.webp",import.meta.url).href,fa=""+new URL("prohibited-DXrv8kWQ.webp",import.meta.url).href,ba=""+new URL("refresh-H5dt6YA8.webp",import.meta.url).href,va=""+new URL("sales-Bcdf7YN6.webp",import.meta.url).href,_a=""+new URL("scissors-DzGxaEn0.webp",import.meta.url).href,xa=""+new URL("stairs-BqDMG-rw.webp",import.meta.url).href,ha=""+new URL("user-DIu1gwfX.webp",import.meta.url).href,ya=""+new URL("warning-sign-BC-E8AoD.webp",import.meta.url).href,wa=""+new URL("wrench-y7P0B2mR.webp",import.meta.url).href,Ia=e=>{const r=y(!1),a=y(!1),n=y(null);let s=null;const _=u(()=>I[e.size]),d=u(()=>{try{return new URL(Object.assign({"../assets/illustrations/at.webp":Te,"../assets/illustrations/barrier.webp":Re,"../assets/illustrations/bell.webp":Oe,"../assets/illustrations/bolt.webp":De,"../assets/illustrations/calendar.webp":Be,"../assets/illustrations/card.webp":Pe,"../assets/illustrations/celebration.webp":Ze,"../assets/illustrations/chat-bubble.webp":Ve,"../assets/illustrations/check.webp":qe,"../assets/illustrations/clock.webp":Ye,"../assets/illustrations/disconnected-plug.webp":Fe,"../assets/illustrations/document.webp":$e,"../assets/illustrations/dollar-currency.webp":He,"../assets/illustrations/door.webp":We,"../assets/illustrations/email.webp":Xe,"../assets/illustrations/euro-currency.webp":Ke,"../assets/illustrations/face-recognition.webp":Je,"../assets/illustrations/fingerprint.webp":Qe,"../assets/illustrations/footsteps.webp":ea,"../assets/illustrations/gift-box.webp":aa,"../assets/illustrations/global66.webp":sa,"../assets/illustrations/globe.webp":ta,"../assets/illustrations/headset.webp":ia,"../assets/illustrations/id-card-back.webp":ra,"../assets/illustrations/id-card-front.webp":oa,"../assets/illustrations/information.webp":na,"../assets/illustrations/location-pin.webp":la,"../assets/illustrations/lock.webp":ma,"../assets/illustrations/magnifying-glass.webp":ca,"../assets/illustrations/otp.webp":da,"../assets/illustrations/paper-airplane.webp":pa,"../assets/illustrations/pound-currency.webp":ga,"../assets/illustrations/price-tags.webp":ua,"../assets/illustrations/prohibited.webp":fa,"../assets/illustrations/refresh.webp":ba,"../assets/illustrations/sales.webp":va,"../assets/illustrations/scissors.webp":_a,"../assets/illustrations/stairs.webp":xa,"../assets/illustrations/user.webp":ha,"../assets/illustrations/warning-sign.webp":ya,"../assets/illustrations/wrench.webp":wa})[`../assets/illustrations/${e.name}.webp`],import.meta.url).href}catch{return a.value=!0,""}}),p=()=>{a.value=!0},l=()=>{r.value=!0},t=()=>{if(!e.lazyLoad){l();return}if(s&&(s(),s=null),n.value){const{stop:m}=we(n,([{isIntersecting:g}])=>{g&&(l(),m())},{threshold:.1,rootMargin:"50px"});s=m}};return $(()=>{t()}),de(()=>{s&&s()}),R(()=>e.name,()=>{r.value=!1,t()}),{sizeValue:_,isLoaded:r,hasError:a,imageSrc:d,imageContainer:n,handleImageError:p}},Ea=["src","alt"],za=["aria-label"],E=H({__name:"Image",props:Ue,setup(e){const r=e;Ne(r);const a=X("image"),{sizeValue:n,isLoaded:s,imageSrc:_,imageContainer:d,handleImageError:p,hasError:l}=Ia(r);return(t,m)=>(v(),b("figure",{class:f(o(a).b("container")),ref_key:"imageContainer",ref:d,style:W({width:o(n),height:o(n),minWidth:o(n),minHeight:o(n)})},[o(s)&&!o(l)?(v(),b("img",{key:0,src:o(_),alt:t.name,class:f(o(a).b()),onError:m[0]||(m[0]=(...g)=>o(p)&&o(p)(...g))},null,42,Ea)):o(l)?(v(),b("div",{key:2,class:f([o(a).e("placeholder"),`text-size-${t.size}`]),role:"img","aria-label":"Error al cargar la imagen"}," 404 ",2)):(v(),b("div",{key:1,class:f(o(a).e("placeholder")),role:"img","aria-label":`Cargando imagen: ${t.name}`},null,10,za))],6))}});E.__docgenInfo={exportName:"default",displayName:"Image",description:"",tags:{},sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/image/src/Image.vue"]};/**
* @vue/shared v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const Sa=Object.prototype.hasOwnProperty,Z=(e,r)=>Sa.call(e,r),V=e=>typeof e=="string",z=e=>e!==null&&typeof e=="object";const q=e=>typeof e=="boolean",Y=e=>typeof e=="number",Q="__epPropKey",Ga=e=>e,La=e=>z(e)&&!!e[Q],ka=(e,r)=>{if(!z(e)||La(e))return e;const{values:a,required:n,default:s,type:_,validator:d}=e,p={type:_,required:!!n,validator:a||d?l=>{let t=!1,m=[];if(a&&(m=Array.from(a),Z(e,"default")&&m.push(s),t||(t=m.includes(l))),d&&(t||(t=d(l))),!t&&m.length>0){const g=[...new Set(m)].map(M=>JSON.stringify(M)).join(", ");ve(`Invalid prop: validation failed${r?` for prop "${r}"`:""}. Expected one of [${g}], got value ${JSON.stringify(l)}.`)}return t}:void 0,[Q]:!0};return Z(e,"default")&&(p.default=s),p},Aa=e=>xe(Object.entries(e).map(([r,a])=>[r,ka(a,r)])),Ca=(e,r)=>{if(e.install=a=>{for(const n of[e,...Object.values(r??{})])a.component(n.name,n)},r)for(const[a,n]of Object.entries(r))e[a]=n;return e},Ma=Aa({classItem:{type:String,default:""},options:{type:Ga(Array),default:()=>[]},modelValue:{type:[String,Number,Boolean,null],default:void 0},block:Boolean,size:he,disabled:Boolean,validateEvent:{type:Boolean,default:!0},messageError:{type:String,default:""},id:String,name:String,...Le(["ariaLabel"])}),ja={[K]:e=>V(e)||Y(e)||q(e),[J]:e=>V(e)||Y(e)||q(e)},Ua={class:"flex flex-col gap-xs"},Na=["id","aria-label","aria-labelledby"],Ta=["name","disabled","checked","onChange"],Ra={key:0},F=H({__name:"Segmented",props:Ma,emits:ja,setup(e,{emit:r}){const a=e,n=r,s=X("segmented"),_=ke(),d=Ae(),p=ze(),{formItem:l}=Se(),{inputId:t,isLabeledByFormItem:m}=Ge(a,{formItemContext:l}),g=y(null),M=Ie(),c=pe({isInit:!1,width:0,height:0,translateX:0,translateY:0,focusVisible:!1}),O=u(()=>l?.shouldShowErrorChild||!!a?.messageError),ee=u(()=>[s.e("help"),{[s.e("help-error")]:O.value}]),D=u(()=>a?.messageError?a.messageError:l?.validateMessage),ae=u(()=>D.value||l?.$el),se=i=>{const x=j(i);n(K,x),n(J,x)},j=i=>z(i)?i?.value:i,te=i=>z(i)?i?.label:i,U=i=>!!(p.value||z(i)&&i?.disabled),B=i=>a.modelValue===j(i),ie=i=>a.options.find(x=>j(x)===i),re=i=>[s.e("item"),s.is("selected",B(i)),s.is("disabled",U(i)),a.classItem],N=()=>{if(!g.value)return;const i=g.value.querySelector(".is-selected"),x=g.value.querySelector(".is-selected input");if(!i||!x){c.width=0,c.height=0,c.translateX=0,c.translateY=0,c.focusVisible=!1;return}const h=i.getBoundingClientRect();c.isInit=!0,c.width=h.width,c.translateX=i.offsetLeft;try{c.focusVisible=x.matches(":focus-visible")}catch{}},oe=u(()=>[s.b(),s.m(d.value),s.is("block",a.block)]),ne=u(()=>({width:`${c.width}px`,height:"100%",transform:`translateX(${c.translateX}px)`,display:c.isInit?"block":"none"})),le=u(()=>[s.e("item-selected"),s.is("disabled",U(ie(a.modelValue))),s.is("focus-visible",c.focusVisible)]),me=u(()=>a.name||_.value);return Ee(g,N),R(M,N),R(()=>a.modelValue,()=>{N(),a.validateEvent&&l?.validate?.("change").catch(i=>void 0)},{flush:"post"}),(i,x)=>(v(),b("div",Ua,[i.options.length?(v(),b("div",{key:0,class:f(oe.value),id:o(t),ref_key:"segmentedRef",ref:g,role:"radiogroup","aria-label":o(m)?void 0:i.ariaLabel||"segmented","aria-labelledby":o(m)?o(l).labelId:void 0},[S("div",{class:f([o(s).e("group")])},[S("div",{style:W(ne.value),class:f(le.value)},null,6),(v(!0),b(ge,null,ue(i.options,(h,ce)=>(v(),b("label",{key:ce,class:f(re(h))},[S("input",{class:f(o(s).e("item-input")),type:"radio",name:me.value,disabled:U(h),checked:B(h),onChange:Da=>se(h)},null,42,Ta),S("div",{class:f(o(s).e("item-label"))},[fe(i.$slots,"default",{item:h},()=>[be(P(te(h)),1)])],2)],2))),128))],2)],10,Na)):T("",!0),ae.value?(v(),b("div",{key:1,class:f(ee.value)},[O.value?(v(),b("p",Ra,P(D.value),1)):T("",!0)],2)):T("",!0)]))}}),Oa=Ca(F,{Segmented:F}),ns={title:"Basic/Image",component:E,parameters:{docs:{description:{component:`
# Image Component
...
`,language:"html"}}},render:()=>({components:{GImage:E,GConfigProvider:C,GSegmented:Oa,GInput:Ce,GButton:Me,GIconFont:je},setup(){const e=y("md"),r=y(""),a=y(null),n=Object.keys(I).map(t=>({label:t.toUpperCase(),value:t})),s=y([...w]),_=u(()=>{switch(e.value){case"xs":case"sm":return"grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8";case"md":return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6";case"lg":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"xl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4";case"xxl":return"grid-cols-1 sm:grid-cols-2 md:grid-cols-3";case"xxxl":return"grid-cols-1 sm:grid-cols-2";default:return"grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6"}}),d=()=>{if(!r.value.trim()){s.value=[...w];return}const t=r.value.toLowerCase().trim();s.value=w.filter(m=>m.toLowerCase().includes(t))},p=()=>{r.value="",d()},l=t=>{navigator.clipboard.writeText(t).then(()=>{a.value=t,setTimeout(()=>{a.value=null},1500),console.log("Nombre de la ilustración copiado al portapapeles")}).catch(()=>{alert("No se pudo copiar el nombre de la ilustración")})};return $(()=>{const t=document.createElement("style");return t.textContent=`
          .copy-animation {
        ...
        `,document.head.appendChild(t),()=>{t.parentNode&&t.parentNode.removeChild(t)}}),{IMAGE_NAMES:w,IMAGE_SIZES:I,selectedSize:e,sizeOptions:n,searchTerm:r,clearSearch:p,copyImageName:l,filteredImages:s,updateFilteredImages:d,copiedImage:a,gridColumns:_}},template:`
      <g-config-provider>
        <div class="space-y-8">
          <g-segmented
            block
...
}`,...A.parameters?.docs?.source}}};const ls=["Primary","Sizes","Gallery","ErrorHandling"];export{A as ErrorHandling,k as Gallery,G as Primary,L as Sizes,ls as __namedExportsOrder,ns as default};
