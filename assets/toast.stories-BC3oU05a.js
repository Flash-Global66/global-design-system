import{d as ee,r as oe,c as b,o as te,a as W,u as i,T as se,e as ae,b as w,h as $,j as G,n as F,k as g,f as N,l as R,t as E,q as re,x as ne,v as Q,N as ie,i as H,ab as _}from"./vue.esm-bundler-Deokl1F5.js";import{u as ce}from"./index-Cla1j_Lq.js";import{_ as Z}from"./index-B-U0DsHd.js";import{u as le,c as pe,i as de,f as X}from"./useEmptyValues-S5EffpHc.js";import{b as ue,d as j,a as D,g as me}from"./props.util-Dtwzmmnf.js";import{u as fe}from"./index-D9lthdDW.js";import{E as q}from"./event.constant-LtAI3-H4.js";import{G as m}from"./ConfigProvider-DiWOjIRd.js";import{a as ge}from"./index-iviVQk4X.js";import{w as ye,b as he}from"./error.util-CmMZjXeT.js";import{G as y}from"./index-DplprqvC.js";import{a as we,b as ve}from"./documentation-stories-ZyKnmB2F.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-BXyPvuAD.js";const J=["success","info","warning","error"],Te=["sm","md"],be=ue({customClass:{type:String,default:""},dangerouslyUseHTMLString:Boolean,duration:{type:Number,default:5e3},id:{type:String,default:""},message:{type:j([String,Object,Function]),default:""},offset:{type:Number,default:0},onClick:{type:j(Function),default:()=>{}},onClose:{type:j(Function),required:!0},position:{type:String,values:["top-right","top-left","bottom-right","bottom-left"],default:"top-right"},showClose:{type:Boolean,default:!0},showProgress:{type:Boolean,default:!0},size:{type:String,values:Te,default:"md"},type:{type:String,values:J,required:!0},zIndex:Number}),Ge={destroy:()=>!0},Ce=["id"],Pe={key:0},Be=["innerHTML"],z=ee({name:"GToast",__name:"toast",props:be,emits:Ge,setup(e,{expose:s}){const t=e,{nextZIndex:c,currentZIndex:d}=le(),r=pe("toast"),n=oe(!1);let p;const u={success:"solid check-circle",info:"solid info-circle",warning:"solid exclamation-triangle",error:"solid times-circle"},l=b(()=>u[t.type]),f=b(()=>t.position.endsWith("right")?"right":"left"),h=b(()=>t.position.startsWith("top")?"top":"bottom"),I=b(()=>({[h.value]:`${t.offset}px`,zIndex:t.zIndex??d.value}));function A(){if(t.duration>0){const{stop:a}=fe(()=>{n.value&&v()},t.duration);p=a}}function V(){p?.()}function v(){n.value=!1}function Y({code:a}){a===q.delete||a===q.backspace?V():a===q.esc?n.value&&v():A()}return te(()=>{A(),c(),n.value=!0}),ce(document,"keydown",Y),s({visible:n,close:v}),(a,T)=>(w(),W(se,{name:i(r).b("fade"),onBeforeLeave:a.onClose,onAfterLeave:T[1]||(T[1]=U=>a.$emit("destroy"))},{default:ae(()=>[$(G("div",{id:a.id,class:g([i(r).b(),i(r).m(t.type),i(r).m(t.size),a.customClass,f.value]),style:F(I.value),role:"alert",onMouseenter:V,onMouseleave:A,onClick:T[0]||(T[0]=(...U)=>a.onClick&&a.onClick(...U))},[N(i(Z),{class:g([i(r).e("icon"),i(r).m(t.type)]),name:l.value},null,8,["class","name"]),G("div",{class:g(i(r).e("group"))},[$(G("div",{class:g(i(r).e("content"))},[re(a.$slots,"default",{},()=>[a.dangerouslyUseHTMLString?(w(),E("p",{key:1,innerHTML:a.message},null,8,Be)):(w(),E("p",Pe,ne(a.message),1))])],2),[[Q,a.message]])],2),a.showClose?(w(),W(i(Z),{key:0,class:g(i(r).e("closeBtn")),onClick:ie(v,["stop"]),name:"solid times"},null,8,["class"])):R("",!0),a.showProgress&&a.duration>0?(w(),E("div",{key:1,class:g(i(r).e("progress"))},[G("div",{class:g([i(r).e("progress-bar"),i(r).m(t.type)]),style:F({animationDuration:`${a.duration}ms`})},null,6)],2)):R("",!0)],46,Ce),[[Q,n.value]])]),_:3},8,["name","onBeforeLeave"]))}});z.__docgenInfo={name:"GToast",exportName:"default",displayName:"toast",description:"",tags:{},expose:[{name:"visible"},{name:"close",tags:[{title:"description",content:"close notification"}]}],events:[{name:"destroy"}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/toast/src/toast.vue"]};const L={"top-left":[],"top-right":[],"bottom-left":[],"bottom-right":[]},O=16;let xe=1;const o=function(e={},s){if(!de)return{close:()=>{}};(D(e)||H(e))&&(e={message:e});const t=e.position||"top-right";let c=e.offset||0;L[t].forEach(({vm:h})=>{c+=(h.el?.offsetHeight||0)+O}),c+=O;const d=`toast_${xe++}`,r=e.onClose,n={...e,offset:c,id:d,onClose:()=>{Me(d,t,r)}};let p=document.body;X(e.appendTo)?p=e.appendTo:D(e.appendTo)&&(p=document.querySelector(e.appendTo)),X(p)||(p=document.body);const u=document.createElement("div"),l=N(z,n,me(n.message)?n.message:H(n.message)?()=>n.message:null),f=N(m,{},{default:()=>l});return f.appContext=ge(s)?o._context:s,f.props.onDestroy=()=>{_(null,u)},_(f,u),L[t].push({vm:l}),p.appendChild(u.firstElementChild),{close:()=>{l.component.exposed.visible.value=!1}}};J.forEach(e=>{o[e]=(s={},t)=>((D(s)||H(s))&&(s={message:s}),o({...s,type:e},t))});function Me(e,s,t){const c=L[s],d=c.findIndex(({vm:l})=>l.component?.props.id===e);if(d===-1)return;const{vm:r}=c[d];if(!r)return;t?.(r);const n=r.el.offsetHeight,p=s.split("-")[0];c.splice(d,1);const u=c.length;if(!(u<1))for(let l=d;l<u;l++){const{el:f,component:h}=c[l].vm,I=Number.parseInt(f.style[p],10)-n-O;h.props.offset=I}}function Se(){for(const e of Object.values(L))e.forEach(({vm:s})=>{s.component.exposed.visible.value=!1})}o.closeAll=Se;o._context=null;const ke=ye(z,{Toast:z});he(o,"$toastify");const ze="1.1.11",K={"@vueuse/core":"^12.4.0",vue:"^3.2.0"},Fe={title:"Feedback/Toast",component:ke,parameters:{docs:{description:{component:`
...
}`,...k.parameters?.docs?.source}}};const Re=["Playground","Primary","AllTypes","Positions","DurationControl","AdvancedUsage","Sizes"];export{S as AdvancedUsage,B as AllTypes,M as DurationControl,C as Playground,x as Positions,P as Primary,k as Sizes,Re as __namedExportsOrder,Fe as default};
