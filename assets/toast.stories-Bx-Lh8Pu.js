import{d as ee,r as oe,c as b,o as te,b as W,e as w,f as se,j as $,k as G,n as F,l as g,u as i,h as H,m as R,x as E,s as ae,y as re,v as Q,_ as ne,T as ie,J as N,i as D,G as ce,ac as _}from"./vue.esm-bundler-Bl2jagQS.js";import{b as le}from"./index-BReYXkxF.js";import{t as Z}from"./index-C-AGS1Jc.js";import{s as pe,k as j,u as de,i as ue,d as X,z as me,w as fe,A as ge}from"./install-DOXp8ISs.js";import{u as ye,G as m}from"./ConfigProvider-CoDfHLyv.js";import{E as q}from"./aria-BUADUvnR.js";import{u as he}from"./index-CSWWzN0B.js";import{G as y}from"./index-BoDGNchl.js";import{a as we,b as ve}from"./documentation-stories-DmxlK2AD.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./error-Cq9Fpw4b.js";import"./index-DM0Y1YvF.js";import"./index-BKPPtF-j.js";import"./index-1PfsMPBk.js";import"./_arrayPush-JI9VAGEF.js";import"./index.es-6yWc74qv.js";import"./index-DdPf6Guz.js";import"./index-B7B84oAx.js";const K=["success","info","warning","error"],Te=["sm","md"],be=pe({customClass:{type:String,default:""},dangerouslyUseHTMLString:Boolean,duration:{type:Number,default:5e3},id:{type:String,default:""},message:{type:j([String,Object,Function]),default:""},offset:{type:Number,default:0},onClick:{type:j(Function),default:()=>{}},onClose:{type:j(Function),required:!0},position:{type:String,values:["top-right","top-left","bottom-right","bottom-left"],default:"top-right"},showClose:{type:Boolean,default:!0},showProgress:{type:Boolean,default:!0},size:{type:String,values:Te,default:"md"},type:{type:String,values:K,required:!0},zIndex:Number}),Ge={destroy:()=>!0},Ce=["id"],Pe={key:0},Be=["innerHTML"],z=ee({name:"GToast",__name:"toast",props:be,emits:Ge,setup(e,{expose:s}){const t=e,{nextZIndex:c,currentZIndex:d}=ye(),r=de("toast"),n=oe(!1);let p;const u={success:"solid check-circle",info:"solid info-circle",warning:"solid exclamation-triangle",error:"solid times-circle"},l=b(()=>u[t.type]),f=b(()=>t.position.endsWith("right")?"right":"left"),h=b(()=>t.position.startsWith("top")?"top":"bottom"),I=b(()=>({[h.value]:`${t.offset}px`,zIndex:t.zIndex??d.value}));function A(){if(t.duration>0){const{stop:a}=he(()=>{n.value&&v()},t.duration);p=a}}function V(){p?.()}function v(){n.value=!1}function Y({code:a}){a===q.delete||a===q.backspace?V():a===q.esc?n.value&&v():A()}return te(()=>{A(),c(),n.value=!0}),le(document,"keydown",Y),s({visible:n,close:v}),(a,T)=>(w(),W(ie,{name:i(r).b("fade"),onBeforeLeave:a.onClose,onAfterLeave:T[1]||(T[1]=U=>a.$emit("destroy"))},{default:se(()=>[$(G("div",{id:a.id,class:g([i(r).b(),i(r).m(t.type),i(r).m(t.size),a.customClass,f.value]),style:F(I.value),role:"alert",onMouseenter:V,onMouseleave:A,onClick:T[0]||(T[0]=(...U)=>a.onClick&&a.onClick(...U))},[H(i(Z),{class:g([i(r).e("icon"),i(r).m(t.type)]),name:l.value},null,8,["class","name"]),G("div",{class:g(i(r).e("group"))},[$(G("div",{class:g(i(r).e("content"))},[ae(a.$slots,"default",{},()=>[a.dangerouslyUseHTMLString?(w(),E("p",{key:1,innerHTML:a.message},null,8,Be)):(w(),E("p",Pe,re(a.message),1))])],2),[[Q,a.message]])],2),a.showClose?(w(),W(i(Z),{key:0,class:g(i(r).e("closeBtn")),onClick:ne(v,["stop"]),name:"solid times"},null,8,["class"])):R("",!0),a.showProgress&&a.duration>0?(w(),E("div",{key:1,class:g(i(r).e("progress"))},[G("div",{class:g([i(r).e("progress-bar"),i(r).m(t.type)]),style:F({animationDuration:`${a.duration}ms`})},null,6)],2)):R("",!0)],46,Ce),[[Q,n.value]])]),_:3},8,["name","onBeforeLeave"]))}});z.__docgenInfo={name:"GToast",exportName:"default",displayName:"toast",description:"",tags:{},expose:[{name:"visible"},{name:"close",tags:[{title:"description",content:"close notification"}]}],events:[{name:"destroy"}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/toast/src/toast.vue"]};const L={"top-left":[],"top-right":[],"bottom-left":[],"bottom-right":[]},O=16;let xe=1;const o=function(e={},s){if(!ue)return{close:()=>{}};(N(e)||D(e))&&(e={message:e});const t=e.position||"top-right";let c=e.offset||0;L[t].forEach(({vm:h})=>{c+=(h.el?.offsetHeight||0)+O}),c+=O;const d=`toast_${xe++}`,r=e.onClose,n={...e,offset:c,id:d,onClose:()=>{Me(d,t,r)}};let p=document.body;X(e.appendTo)?p=e.appendTo:N(e.appendTo)&&(p=document.querySelector(e.appendTo)),X(p)||(p=document.body);const u=document.createElement("div"),l=H(z,n,ce(n.message)?n.message:D(n.message)?()=>n.message:null),f=H(m,{},{default:()=>l});return f.appContext=me(s)?o._context:s,f.props.onDestroy=()=>{_(null,u)},_(f,u),L[t].push({vm:l}),p.appendChild(u.firstElementChild),{close:()=>{l.component.exposed.visible.value=!1}}};K.forEach(e=>{o[e]=(s={},t)=>((N(s)||D(s))&&(s={message:s}),o({...s,type:e},t))});function Me(e,s,t){const c=L[s],d=c.findIndex(({vm:l})=>l.component?.props.id===e);if(d===-1)return;const{vm:r}=c[d];if(!r)return;t?.(r);const n=r.el.offsetHeight,p=s.split("-")[0];c.splice(d,1);const u=c.length;if(!(u<1))for(let l=d;l<u;l++){const{el:f,component:h}=c[l].vm,I=Number.parseInt(f.style[p],10)-n-O;h.props.offset=I}}function Se(){for(const e of Object.values(L))e.forEach(({vm:s})=>{s.component.exposed.visible.value=!1})}o.closeAll=Se;o._context=null;const ke=fe(z,{Toast:z});ge(o,"$toastify");const ze="1.1.0",J={"@flash-global66/g-icon-font":"^0.10.0","@vueuse/core":"^12.4.0","element-plus":"^2.9.0",vue:"^3.2.0"},Ze={title:"Feedback/Toast",component:ke,parameters:{docs:{description:{component:`
...
}`,...k.parameters?.docs?.source}}};const Xe=["Playground","Primary","AllTypes","Positions","DurationControl","AdvancedUsage","Sizes"];export{S as AdvancedUsage,B as AllTypes,M as DurationControl,C as Playground,x as Positions,P as Primary,k as Sizes,Xe as __namedExportsOrder,Ze as default};
