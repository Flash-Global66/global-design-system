import{k as c,l as p,m as i,G as k,C as P,u as s,D as b,O as G,r as z,o as j,w as A,p as R,z as f,F as w,E as I,J as F,A as N,_,K as C,$ as B,I as V}from"./vue.esm-bundler-ENg2wqJc.js";import{l as D,h as L,k as T,i as U,m as W,D as q,w as H,G as S}from"./ConfigProvider-C0wXp6tN.js";import{p as J}from"./index-DMnPzEbW.js";import{_ as x}from"./plugin-vue_export-helper-CqGSI99y.js";import{_ as O}from"./_plugin-vue_export-helper-DlAUqK2U.js";const K=D({animated:{type:Boolean,default:!1},count:{type:Number,default:1},rows:{type:Number,default:3},loading:{type:Boolean,default:!0},throttle:{type:L([Number,Object])}}),Y=D({variant:{type:String,values:["circle","rect","h1","h3","text","caption","p","image","button"],default:"text"}}),Q=c({name:"ElSkeletonItem"}),X=c({...Q,props:Y,setup(e){const t=T("skeleton");return(a,o)=>(i(),p("div",{class:b([s(t).e("item"),s(t).e(a.variant)])},[a.variant==="image"?(i(),k(s(J),{key:0})):P("v-if",!0)],2))}});var h=x(X,[["__file","skeleton-item.vue"]]);const Z=(e,t=0)=>{if(t===0)return e;const a=G(t)&&!!t.initVal,o=z(a);let r=null;const n=l=>{if(W(l)){o.value=e.value;return}r&&clearTimeout(r),r=setTimeout(()=>{o.value=e.value},l)},m=l=>{l==="leading"?U(t)?n(t):n(t.leading):G(t)?n(t.trailing):o.value=!1};return j(()=>m("leading")),A(()=>e.value,l=>{m(l?"leading":"trailing")}),o},ee=c({name:"ElSkeleton"}),te=c({...ee,props:K,setup(e,{expose:t}){const a=e,o=T("skeleton"),r=Z(R(a,"loading"),a.throttle);return t({uiLoading:r}),(n,m)=>s(r)?(i(),p("div",N({key:0,class:[s(o).b(),s(o).is("animated",n.animated)]},n.$attrs),[(i(!0),p(w,null,I(n.count,l=>(i(),p(w,{key:l},[s(r)?f(n.$slots,"template",{key:l},()=>[F(h,{class:b(s(o).is("first")),variant:"p"},null,8,["class"]),(i(!0),p(w,null,I(n.rows,$=>(i(),k(h,{key:$,class:b([s(o).e("paragraph"),s(o).is("last",$===n.rows&&n.rows>1)]),variant:"p"},null,8,["class"]))),128))]):P("v-if",!0)],64))),128))],16)):f(n.$slots,"default",_(N({key:1},n.$attrs)))}});var ne=x(te,[["__file","skeleton.vue"]]);const oe=H(ne,{SkeletonItem:h}),se=q(h),E=c({name:"GSkeleton",components:{ElSkeleton:oe},props:{animated:{type:Boolean,default:!1},count:{type:Number,default:1},rows:{type:Number,default:3},throttle:{type:Number}}});function ae(e,t,a,o,r,n){const m=V("el-skeleton");return i(),k(m,_(B({...e.$attrs,...e.$props})),{template:C(()=>[f(e.$slots,"template")]),default:C(()=>[f(e.$slots,"default")]),_:3},16)}const v=O(E,[["render",ae]]);E.__docgenInfo={displayName:"GSkeleton",exportName:"default",description:"",tags:{},props:[{name:"animated",description:"whether showing the animation",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"count",description:"how many fake items to render to the DOM",type:{name:"number"},defaultValue:{func:!1,value:"1"}},{name:"rows",description:"numbers of the row, only useful when no template slot were given",type:{name:"number"},defaultValue:{func:!1,value:"3"}},{name:"throttle",description:"Rendering delay in milliseconds",type:{name:"number"}}],slots:[{name:"default",description:"Real rendering DOM"},{name:"template",description:"Custom rendering skeleton template"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/skeleton/Skeleton.vue"]};const M=c({name:"GSkeletonItem",components:{ElSkeletonItem:se},props:{variant:{type:String,default:"text"}}});function re(e,t,a,o,r,n){const m=V("el-skeleton-item");return i(),k(m,_(B({...e.$attrs,...e.$props})),null,16)}const y=O(M,[["render",re]]);M.__docgenInfo={displayName:"GSkeletonItem",exportName:"default",description:"",tags:{},props:[{name:"variant",description:"The current rendering skeleton type\n`'circle' | 'rect' | 'h1' | 'h3' | 'text' | 'caption' | 'p' | 'image' | 'button'`",type:{name:"SkeletonVariant"},defaultValue:{func:!1,value:"'text'"}}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/skeleton/SkeletonItem.vue"]};const fe={title:"Data/Skeleton",component:v,subcomponents:{GSkeletonItem:y},argTypes:{animated:{defaultValue:!0},count:{defaultValue:1},rows:{defaultValue:3}},parameters:{docs:{description:{component:"When loading data, and you need a rich experience for visual and interactions for your end users, you can choose `skeleton`. <br /> <br /> You can configure the row numbers yourself, for more precise rendering effect, the actual rendered row number will always be 1 row more than the given number, that is because we are rendering a title row with 33% width of the other. <br /> We have provided a switch flag indicating whether showing the loading animation, called animated when this is true, all children of g-skeleton will show animation"}}}},le=e=>({components:{GSkeleton:v,GConfigProvider:S,GSkeletonItem:y},template:`
    <g-config-provider>
