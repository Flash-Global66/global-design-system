import{d as de,c as h,r as t,w as Z,o as me,t as b,j as q,l as v,a1 as ve,u as r,k as u,a as x,x as B,q as _,n as ue,N as pe,b as l,A as ge,Q as fe,C as he}from"./vue.esm-bundler-C6DRpX4R.js";import{R as w}from"./index-DEGGxn4j.js";import{B as be,z as xe,M as we,L as ye}from"./index-BnOtqFZS.js";import{c as H,d as Se,b as Ce}from"./useEmptyValues-8bO_IQ4-.js";import{i as G,a as M,b as Ne,d as De,l as Ae,m as ee}from"./props.util-DQIcYPkU.js";import{u as Ie}from"./useNamespace-D200ZTkz.js";import{d as Pe,t as Te}from"./error.util-CtUs3PUB.js";import{w as Ve}from"./install.util-cBz1HN_T.js";import{G as m}from"./ConfigProvider-CHVLgL_2.js";import{G as ke,a as Ee}from"./index-DqZLG4Y7.js";import{G as Fe}from"./index-CZcmyKtl.js";import{G as Oe}from"./index-BYG7qvIZ.js";import{g as N,a as ze,b as ae}from"./documentation-stories-0qKiiCdD.js";import"./useId-BGX2ZA7H.js";import"./index-OmpdNH0g.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-CRx4dHSJ.js";import"./index-B8Dg1tZU.js";import"./useAttrs-Dmae7bQW.js";import"./event.constant-LtAI3-H4.js";import"./index-fKX7T4ju.js";const j="update:modelValue",$="change",K="input",Re=Ne({modelValue:{type:[Boolean,String,Number],default:!1},disabled:Boolean,loading:Boolean,size:{type:String,validator:Ae},width:{type:[String,Number],default:""},inlinePrompt:Boolean,inactiveActionIcon:{type:String},activeActionIcon:{type:String},activeIcon:{type:String},inactiveIcon:{type:String},activeText:{type:String,default:""},inactiveText:{type:String,default:""},activeValue:{type:[Boolean,String,Number],default:!0},inactiveValue:{type:[Boolean,String,Number],default:!1},name:{type:String,default:""},validateEvent:{type:Boolean,default:!0},beforeChange:{type:De(Function)},id:String,tabindex:{type:[String,Number]},...Se(["ariaLabel"])}),Ge={[j]:a=>G(a)||M(a)||H(a),[$]:a=>G(a)||M(a)||H(a),[K]:a=>G(a)||M(a)||H(a)},Le=["id","aria-checked","aria-disabled","aria-label","name","true-value","false-value","disabled","tabindex"],qe=["aria-hidden"],Be=["aria-hidden"],He=["aria-hidden"],te="GSwitch",W=de({name:te,__name:"switch",props:Re,emits:Ge,setup(a,{expose:n,emit:c}){const i=a,p=c,{formItem:g}=ye(),L=be(),o=Ie("switch"),{inputId:ne}=xe(i,{formItemContext:g}),S=we(h(()=>i.loading)),Q=t(i.modelValue!==!1),y=t(),ie=t(),oe=h(()=>[o.b(),o.m(L.value),o.is("disabled",S.value),o.is("checked",s.value)]),se=h(()=>[o.e("label"),o.em("label","left"),o.is("active",!s.value)]),re=h(()=>[o.e("label"),o.em("label","right"),o.is("active",s.value)]),ce=h(()=>({width:Ce(i.width)}));Z(()=>i.modelValue,()=>{Q.value=!0});const J=h(()=>Q.value?i.modelValue:!1),s=h(()=>J.value===i.activeValue);[i.activeValue,i.inactiveValue].includes(J.value)||(p(j,i.inactiveValue),p($,i.inactiveValue),p(K,i.inactiveValue)),Z(s,e=>{y.value.checked=e,i.validateEvent&&g?.validate?.("change").catch(f=>Pe())});const C=()=>{const e=s.value?i.inactiveValue:i.activeValue;p(j,e),p($,e),p(K,e),ge(()=>{y.value.checked=s.value})},X=()=>{if(S.value)return;const{beforeChange:e}=i;if(!e){C();return}const f=e();[ee(f),G(f)].includes(!0)||Te(te,"beforeChange must return type `Promise<boolean>` or `boolean`"),ee(f)?f.then(Y=>{Y&&C()}).catch(Y=>{}):f&&C()},le=()=>{y.value?.focus?.()};return me(()=>{y.value.checked=s.value}),n({focus:le,checked:s}),(e,f)=>(l(),b("div",{class:u(oe.value),onClick:pe(X,["prevent"])},[q("input",{id:r(ne),ref_key:"input",ref:y,class:u(r(o).e("input")),type:"checkbox",role:"switch","aria-checked":s.value,"aria-disabled":r(S),"aria-label":e.ariaLabel,name:e.name,"true-value":e.activeValue,"false-value":e.inactiveValue,disabled:r(S),tabindex:e.tabindex,onChange:C,onKeydown:ve(X,["enter"])},null,42,Le),!e.inlinePrompt&&(e.inactiveIcon||e.inactiveText)?(l(),b("span",{key:0,class:u(se.value)},[e.inactiveIcon?(l(),x(r(w),{key:0,name:e.inactiveIcon},null,8,["name"])):v("",!0),!e.inactiveIcon&&e.inactiveText?(l(),b("span",{key:1,"aria-hidden":s.value},B(e.inactiveText),9,qe)):v("",!0)],2)):v("",!0),q("span",{ref_key:"core",ref:ie,class:u(r(o).e("core")),style:ue(ce.value)},[e.inlinePrompt?(l(),b("div",{key:0,class:u(r(o).e("inner"))},[e.activeIcon||e.inactiveIcon?(l(),x(r(w),{key:0,name:s.value?e.activeIcon:e.inactiveIcon,class:u(r(o).is("icon"))},null,8,["name","class"])):e.activeText||e.inactiveText?(l(),b("span",{key:1,class:u(r(o).is("text")),"aria-hidden":!s.value},B(s.value?e.activeText:e.inactiveText),11,Be)):v("",!0)],2)):v("",!0),q("div",{class:u(r(o).e("action"))},[e.loading?(l(),x(r(w),{key:0,name:"solid spinner",spin:"",class:u(r(o).is("loading"))},null,8,["class"])):s.value?_(e.$slots,"active-action",{key:1},()=>[e.activeActionIcon?(l(),x(r(w),{key:0,name:e.activeActionIcon},null,8,["name"])):v("",!0)]):s.value?v("",!0):_(e.$slots,"inactive-action",{key:2},()=>[e.inactiveActionIcon?(l(),x(r(w),{key:0,name:e.inactiveActionIcon},null,8,["name"])):v("",!0)])],2)],6),!e.inlinePrompt&&(e.activeIcon||e.activeText)?(l(),b("span",{key:1,class:u(re.value)},[e.activeIcon?(l(),x(r(w),{key:0,name:e.activeIcon},null,8,["name"])):v("",!0),!e.activeIcon&&e.activeText?(l(),b("span",{key:1,"aria-hidden":!s.value},B(e.activeText),9,He)):v("",!0)],2)):v("",!0)],2))}});W.__docgenInfo={exportName:"default",displayName:"switch",description:"",tags:{},expose:[{name:"focus",tags:[{title:"description",content:"manual focus to the switch component"}]},{name:"checked",tags:[{title:"description",content:"whether Switch is checked"}]}],slots:[{name:"active-action"},{name:"inactive-action"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/switch/src/switch.vue"]};const d=Ve(W,{Switch:W}),Me="1.1.28",U={"@flash-global66/g-form":"^0.2.0","@flash-global66/g-icon-font":"^0.10.0",vue:"^3.2.0"},ma={title:"Form/Switch",component:d,parameters:{docs:{description:{component:`
...
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=t(!0),n=t(!1);return{value1:a,value2:n}},template:`
    ...
    `})},E={name:"Prevenir cambio",parameters:{docs:{description:{story:"Configura la propiedad before-change. Si se devuelve false o se devuelve una Promise que luego es rechazada, se detendrá el cambio."},source:{code:`<!-- Con confirmación -->
<g-switch
  v-model="value"
...
<\/script>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=t(!1),n=t(!1);return{value1:a,value2:n,beforeChange1:()=>confirm("¿Estás seguro de que quieres cambiar el estado?"),beforeChange2:()=>new Promise(p=>{setTimeout(()=>{p(confirm("¿Confirmar cambio después de 1 segundo?"))},1e3)})}},template:`
    ...
    `})},F={name:"Iconos de acción personalizados",parameters:{docs:{description:{story:"Puedes agregar los atributos active-action-icon e inactive-action-icon para mostrar iconos en las acciones."},source:{code:`<!-- Encendido/Apagado -->
<g-switch
  v-model="value"
...
}`,...R.parameters?.docs?.source}}};const va=["Primary","Sizes","TextDescription","CustomIcons","ExtendedValueTypes","Disabled","Loading","PreventSwitching","CustomActionIcons","CustomActionSlots","CustomWidth","FormValidation"];export{F as CustomActionIcons,O as CustomActionSlots,P as CustomIcons,z as CustomWidth,V as Disabled,T as ExtendedValueTypes,R as FormValidation,k as Loading,E as PreventSwitching,D as Primary,A as Sizes,I as TextDescription,va as __namedExportsOrder,ma as default};
