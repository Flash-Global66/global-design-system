...
<\/script>
\`\`\`
`}}},args:{type:"primary",size:"md",underline:!1,disabled:!1,href:"https://empresas.global66.com/",target:"_blank",iconLeft:void 0,iconRight:void 0}},r={name:"Default link",args:{default:"default link"},render:g=>({components:{GLink:e,GConfigProvider:n},setup(){return{args:g}},template:`
      <g-config-provider>
...
>
  Link secundario con íconos y underline
</g-link>`,language:"html",type:"auto"}}}},s={name:"Link deshabilitado",args:{disabled:!0,default:"link deshabilitado",iconRight:"regular chevron-right"},render:g=>({components:{GLink:e,GConfigProvider:n},setup(){return{args:g}},template:`
      <g-config-provider>
        <g-link v-bind="args">{{ args.default }}</g-link>
      </g-config-provider>
...
}`,...c.parameters?.docs?.source}}};const b=["Default","WithIcons","Sizes","Types","IconsWithUnderline","DisabledState","ExternalLinks","LinkStatus"];export{r as Default,s as DisabledState,t as ExternalLinks,a as IconsWithUnderline,c as LinkStatus,o as Sizes,l as Types,i as WithIcons,b as __namedExportsOrder,f as default};
