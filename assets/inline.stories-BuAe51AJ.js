import{d as V,r as I,c as w,b as E,f as M,u as o,T as L,e as i,x as t,m as d,h as _,k as S,l as s,y as v,s as N,A as B,F as R,z as $}from"./vue.esm-bundler-BCWWDzSy.js";import{q as j}from"./index-Bz0y6LhV.js";import{b as F,d as p,w as W}from"./install-CHjgJfcB.js";import{u as O}from"./index-BoOdRfEY.js";import{u as U}from"./index-CU2PSoyO.js";import{u as H}from"./use-form-common-props-DMcKWkv-.js";import{G as c}from"./ConfigProvider-BAdTAJXu.js";import{v as J,p as b}from"./package-DvbJBKVy.js";import{g as K,a as Q,b as k}from"./documentation-stories-DH-Utv5z.js";import"./_arrayPush-DXBsyDbg.js";import"./constants-Dnj8X3EN.js";import"./index-B9DYlcmC.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-CNqC7f2T.js";import"./error-Cq9Fpw4b.js";const X=F({title:{type:String,default:""},description:{type:String,default:""},hideClose:{type:Boolean,default:!1},icon:{type:p(String),default:""},type:{type:p(String),default:"success"},size:{type:p(String),default:"md"},links:{type:p(Array),default:()=>[]},...O(["ariaLabel"])}),Y={close:a=>a instanceof MouseEvent},Z=["aria-label"],ee={class:""},ne=["onClick","aria-label"],h=V({__name:"inline",props:X,emits:Y,setup(a,{emit:T}){const q=a,x=T,C=I(!0),n=U("inline"),z=H(),G=I(null),P=w(()=>[n.b(),n.m(z.value),n.m(q.type)]);async function A(e){C.value=!1,x("close",e)}return(e,oe)=>(i(),E(L,{name:o(n).m("fade")},{default:M(()=>[C.value?(i(),t("div",{key:0,class:s(P.value),ref_key:"inlineRef",ref:G,"aria-label":e.ariaLabel||"inline"},[_(o(j),{"aria-label":"icon informative",class:s([o(n).e("icon")]),name:e.icon},null,8,["class","name"]),S("div",ee,[e.title?(i(),t("h3",{key:0,class:s([o(n).e("title")])},v(e.title),3)):d("",!0),S("p",{class:s([o(n).e("description")])},[N(e.$slots,"default",{},()=>[B(v(e.description),1)])],2),e.links.length?(i(),t("div",{key:1,role:"group",class:s([o(n).e("links")])},[(i(!0),t(R,null,$(e.links,(l,D)=>(i(),t("button",{key:D,onClick:l.action,class:s([o(n).e("link")]),"aria-label":l.ariaLabel||l.label,type:"button"},v(l.label),11,ne))),128))],2)):d("",!0)]),e.hideClose?d("",!0):(i(),E(o(j),{key:0,role:"button","aria-label":"close inline",onClick:A,class:s(o(n).e("close")),name:"regular times"},null,8,["class"]))],10,Z)):d("",!0)]),_:3},8,["name"]))}});h.__docgenInfo={exportName:"default",displayName:"inline",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/inline/src/inline.vue"]};const r=W(h,{Inline:h}),be={title:"Data/Inline",component:r,parameters:{docs:{description:{component:`
...
}`,...y.parameters?.docs?.source}}};const he=["Primary","AllTypes","Sizes","WithoutClose","WithoutIcon"];export{u as AllTypes,m as Primary,g as Sizes,f as WithoutClose,y as WithoutIcon,he as __namedExportsOrder,be as default};
