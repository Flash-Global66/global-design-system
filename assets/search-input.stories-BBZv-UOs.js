import{r as n,c as D,w as $,d as U,Q as H,x as K,b as g,f as G,u as a,p as W,a1 as F,a0 as Q,l as v,e as h,k as j,h as J,m as x}from"./vue.esm-bundler-CZI_JUT2.js";import{r as O}from"./index-Cj3TRcXy.js";import{G as V,a as Z}from"./SkeletonItem-8Y6In_fP.js";import{Z as M}from"./index-BMYGAyev.js";import{e as _}from"./index-D6D0kIi1.js";import{s as X,u as Y,w as ee}from"./install-C7bOSp5T.js";import{G as y}from"./ConfigProvider-B2uDERVM.js";import{a as d}from"./index-Br0BFi8U.js";import{a as ae,b as T}from"./documentation-stories-CISipaXh.js";import"./index-CCbAt6xy.js";import"./index-CM9gqEks.js";import"./index-CfPCKyCs.js";import"./index-D20av3B9.js";import"./_initCloneObject-CrZ1rfbP.js";import"./_arrayPush-D8-dhSAr.js";import"./castArray-WqZ4o0G1.js";import"./index-CM0fh8S4.js";import"./index-yUHprlUH.js";import"./index-C_YW5NV5.js";import"./index-B_lUqMeV.js";import"./event-BB_Ol6Sd.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-DVGKiGqZ.js";import"./plugin-vue_export-helper-CqGSI99y.js";import"./v4-CtRu48qb.js";import"./index.es-DxGi9Nej.js";import"./index-efoY3Nu-.js";import"./index-B7B84oAx.js";import"./error-Cq9Fpw4b.js";function re(o,r,c){const e=n(),s=n(o.modelValue||""),m=n(!1),t=D(()=>{const{class:l,style:A,modelValue:w,"onUpdate:modelValue":p,disabled:f,initialLoading:L,searchingLoading:ne,debounceTime:le,placeholder:ce,label:ie,helpText:de,messageError:ue,...N}=c;return N}),S=_(l=>{m.value=!1,r("search",l)},o.debounceTime),u=l=>{s.value=l,r("update:modelValue",l),m.value=!0,S(l)},i=()=>{m.value=!1,r("search",s.value)},z=l=>{l?E():e.value?.focus()},E=()=>{s.value="",r("update:modelValue",""),r("clear"),r("search",""),e.value?.focus()};return $(()=>o.modelValue,l=>{l!==s.value&&(s.value=l)},{immediate:!0}),{inputRef:e,searchQuery:s,filteredAttrs:t,handleInput:u,handleEnterKey:i,handleIconClick:z,clearSearch:E,focus:()=>e.value?.focus(),blur:()=>e.value?.blur()}}const se=X({modelValue:{type:String,default:""},placeholder:{type:String,default:""},label:{type:String,default:""},helpText:{type:String,default:""},messageError:{type:String,default:""},disabled:Boolean,initialLoading:Boolean,searchingLoading:Boolean,debounceTime:{type:Number,default:300}}),oe={"update:modelValue":o=>!0,search:o=>!0,clear:()=>!0},k=U({name:"GSearchInput",inheritAttrs:!1,__name:"search-input",props:se,emits:oe,setup(o,{expose:r,emit:c}){const e=o,s=c,m=H(),t=Y("search-input"),S=D(()=>[{[t.is("disabled")]:e.disabled,[t.is("searching")]:e.searchingLoading,[t.is("loading")]:e.initialLoading,[t.is("error")]:!!e.messageError}]),{inputRef:u,searchQuery:i,filteredAttrs:z,handleInput:E,handleEnterKey:l,handleIconClick:A,clearSearch:w}=re(e,s,m);return r({focus:()=>u.value?.focus(),blur:()=>u.value?.blur(),clear:w}),(p,f)=>(h(),K("div",{class:v([a(t).b(),S.value])},[p.initialLoading?(h(),g(a(Z),{key:0,animated:""},{template:G(()=>[j("div",{class:v(a(t).e("skeleton"))},[J(a(V),{variant:"text",class:"h-12 rounded-md"}),p.$attrs["help-text"]||e.helpText?(h(),g(a(V),{key:0,variant:"text"})):x("",!0)],2)]),_:1})):(h(),g(a(O),W({key:1,ref_key:"inputRef",ref:u,"model-value":a(i)},a(z),{class:[a(t).e("input")],disabled:p.disabled,loading:p.searchingLoading,placeholder:e.placeholder,label:e.label,"help-text":e.helpText,"message-error":e.messageError,"onUpdate:modelValue":a(E),onKeydown:F(Q(a(l),["prevent"]),["enter"])}),{suffix:G(()=>[j("div",{class:v(a(t).e("icon-container"))},[!p.searchingLoading&&!a(i)?(h(),g(a(M),{key:0,name:"regular search",class:v(a(t).e("icon")),onClick:f[0]||(f[0]=L=>a(A)(!1))},null,8,["class"])):x("",!0),!p.searchingLoading&&a(i)?(h(),g(a(M),{key:1,name:"regular times",class:v(a(t).e("icon")),onClick:f[1]||(f[1]=L=>a(A)(!0))},null,8,["class"])):x("",!0),p.searchingLoading?(h(),g(a(M),{key:2,name:"regular arrows-rotate",class:v(a(t).e("icon")),spin:""},null,8,["class"])):x("",!0)],2)]),_:1},16,["model-value","class","disabled","loading","placeholder","label","help-text","message-error","onUpdate:modelValue","onKeydown"]))],2))}});k.__docgenInfo={name:"GSearchInput",exportName:"default",displayName:"search-input",description:"",tags:{},expose:[{name:"focus"},{name:"blur"},{name:"clear"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/search-input/src/search-input.vue"]};const b=ee(k,{SearchInput:k}),te="1.1.0",P={"@flash-global66/g-config-provider":"0.0.8","@flash-global66/g-icon-font":"^0.0.8","@flash-global66/g-input":"0.3.0","@flash-global66/g-skeleton":"0.0.7","@vueuse/core":"^12.4.0","element-plus":"^2.9.7",vue:"^3.2.0"},$e={title:"Form/SearchInput",component:b,parameters:{docs:{description:{component:`
...
<g-search-input
  ...
  @clear="onClear"
/>
`,language:"html"}}},render:o=>({components:{GSearchInput:b,GConfigProvider:y},setup(){const r=n("");return{args:o,search:r,onSearch:d("search"),onClear:d("clear")}},template:`
      <g-config-provider>
        <g-search-input
          v-model="search"
          v-bind="args"
...
<g-search-input
  ...
  @clear="onClear"
/>
`,language:"html"}}},render:o=>({components:{GSearchInput:b,GConfigProvider:y},setup(){return{search:n(""),onSearch:d("search"),onClear:d("clear")}},template:`
      <g-config-provider>
        <g-search-input
          v-model="search"
          label="Buscar"
...
<g-search-input
  ...
  initial-loading
/>
`,language:"html"}}},render:()=>({components:{GSearchInput:b,GConfigProvider:y},setup(){return{search:n(""),onSearch:d("search"),onClear:d("clear")}},template:`
      <g-config-provider>
...
<\/script>
`,language:"html"}}},render:()=>({components:{GSearchInput:b,GConfigProvider:y},setup(){const o=n(""),r=n(""),c=n(0);return{search:o,lastSearch:r,searchCount:c,handleSearch:s=>{r.value=s,c.value++,d("search")(s)}}},template:`
      <g-config-provider>
        <div class="space-y-6">
...
}`,...B.parameters?.docs?.source}}};const Ue=["Primary","WithLabel","States","WithDebounce","ApiIntegration"];export{B as ApiIntegration,q as Primary,I as States,R as WithDebounce,C as WithLabel,Ue as __namedExportsOrder,$e as default};
