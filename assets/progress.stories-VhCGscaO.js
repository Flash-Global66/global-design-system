import{d as A,c as n,x as d,m as D,l as t,u as s,k as m,n as p,s as j,e as i,y as I,b as V}from"./vue.esm-bundler-CZI_JUT2.js";import{Z as B}from"./index-BMYGAyev.js";import{s as O,o as G,u as U,w as Z}from"./install-C7bOSp5T.js";import{G as u}from"./ConfigProvider-B2uDERVM.js";import{a as R,b as N}from"./documentation-stories-CISipaXh.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index.es-DxGi9Nej.js";import"./index-efoY3Nu-.js";import"./index-B7B84oAx.js";import"./error-Cq9Fpw4b.js";const H=O({type:{type:String,default:"line",values:["line","circle","dashboard"]},percentage:{type:Number,default:0,validator:a=>a>=0&&a<=100},status:{type:String,default:"primary",values:["primary","success","error","warning"]},indeterminate:Boolean,duration:{type:Number,default:3},strokeWidth:{type:Number,default:6},strokeLinecap:{type:G(String),default:"round"},textInside:Boolean,width:{type:Number,default:126},showText:{type:Boolean,default:!0},loading:{type:Boolean,default:!1},format:{type:G(Function),default:a=>`${a}%`}}),J=["aria-valuenow"],K={viewBox:"0 0 100 100"},Q=["d","stroke","stroke-linecap","stroke-width"],X=["d","stroke","opacity","stroke-linecap","stroke-width"],Y={key:1},T=A({name:"Progress",__name:"progress",props:H,setup(a){const b={primary:"--color-progress-primary",success:"--color-progress-success",error:"--color-progress-error",warning:"--color-progress-warning"},r=a,o=U("progress"),L=n(()=>{const e={width:`${r.percentage}%`,animationDuration:`${r.duration}s`},c=b[r.status]||b.primary;return e.backgroundColor=`var(${c})`,e}),w=n(()=>(r.strokeWidth/r.width*100).toFixed(1)),E=n(()=>["circle","dashboard"].includes(r.type)?Number.parseInt(`${50-Number.parseFloat(w.value)/2}`,10):0),x=n(()=>{const e=E.value,c=r.type==="dashboard";return`
            M 50 50
            m 0 ${c?"":"-"}${e}
            a ${e} ${e} 0 1 1 0 ${c?"-":""}${e*2}
            a ${e} ${e} 0 1 1 0 ${c?"":"-"}${e*2}
            `}),g=n(()=>2*Math.PI*E.value),P=n(()=>r.type==="dashboard"?.75:1),C=n(()=>`${-1*g.value*(1-P.value)/2}px`),M=n(()=>({strokeDasharray:`${g.value*P.value}px, ${g.value}px`,strokeDashoffset:C.value})),q=n(()=>({strokeDasharray:`${g.value*P.value*(r.percentage/100)}px, ${g.value}px`,strokeDashoffset:C.value,transition:"stroke-dasharray 0.6s ease 0s, stroke 0.6s ease, opacity ease 0.6s"})),z=n(()=>{let e;return e=`var(${b[r.status]||b.primary})`,e}),F=n(()=>r.status==="warning"?"solid exclamation-circle":r.type==="line"?r.status==="success"?"regular check-circle":"regular circle-xmark":r.status==="success"?"regular check":"regular times"),W=n(()=>r.type==="line"?12+r.strokeWidth*.4:r.width*.111111+2),S=n(()=>r.format(r.percentage));return(e,c)=>(i(),d("div",{class:t([s(o).b(),s(o).m(e.type),s(o).is(e.status),{[s(o).m("without-text")]:!e.showText,[s(o).m("text-inside")]:e.textInside}]),id:"MAIN-DIV",role:"progressbar","aria-valuenow":e.percentage,"aria-valuemin":"0","aria-valuemax":"100"},[e.type==="line"?(i(),d("div",{key:0,class:t(s(o).b("bar"))},[m("div",{class:t(s(o).be("bar","outer")),style:p({height:`${e.strokeWidth}px`})},[m("div",{class:t([s(o).be("bar","inner"),{[s(o).bem("bar","inner","indeterminate")]:e.indeterminate}]),style:p(L.value)},[(e.showText||e.$slots.default)&&e.textInside?(i(),d("div",{key:0,class:t(s(o).be("bar","innerText"))},[j(e.$slots,"default",{percentage:e.percentage},()=>[m("span",null,I(S.value),1)])],2)):D("",!0)],6)],6)],2)):(i(),d("div",{key:1,class:t(s(o).b("circle")),style:p({height:`${e.width}px`,width:`${e.width}px`})},[(i(),d("svg",K,[m("path",{class:t(s(o).be("circle","track")),d:x.value,stroke:`var(${s(o).cssVarName("fill-color-light")}, #e5e9f2)`,"stroke-linecap":e.strokeLinecap,"stroke-width":w.value,fill:"none",style:p(M.value)},null,14,Q),m("path",{class:t(s(o).be("circle","path")),d:x.value,stroke:z.value,fill:"none",opacity:e.percentage?1:0,"stroke-linecap":e.strokeLinecap,"stroke-width":w.value,style:p(q.value)},null,14,X)]))],6)),(e.showText||e.$slots.default)&&!e.textInside?(i(),d("div",{key:2,class:t(s(o).e("text")),style:p({fontSize:`${W.value}px`})},[j(e.$slots,"default",{percentage:e.percentage},()=>[e.loading?(i(),V(s(B),{key:0,name:"regular spinner",spin:""})):!e.status||e.status==="primary"?(i(),d("span",Y,I(S.value),1)):(i(),V(s(B),{key:2,name:F.value},null,8,["name"]))])],6)):D("",!0)],10,J))}});T.__docgenInfo={name:"Progress",exportName:"default",displayName:"progress",description:"",tags:{},slots:[{name:"default",scoped:!0,bindings:[{name:"percentage",title:"binding"}]}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/progress/src/progress.vue"]};const l=Z(T),_="0.2.0",$={"@flash-global66/g-icon-font":"^0.5.8","element-plus":"^2.9.7",vue:"^3.2.0"},pe={title:"Data/Progress",component:l,parameters:{docs:{description:{component:`
...
}`,...k.parameters?.docs?.source}}};const le=["Basic","States","Types","Ideterminate","Loading"];export{y as Basic,h as Ideterminate,k as Loading,v as States,f as Types,le as __namedExportsOrder,pe as default};
