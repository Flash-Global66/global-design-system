...
<\/script>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m,GForm:Fe,GFormItem:ke,GInput:Oe,GButton:Ee},setup(){const a=t(),n=he({username:"",acceptTerms:!1,enableNotifications:!0});return{formRef:a,formData:n,formRules:{username:[{required:!0,message:"El nombre de usuario es requerido",trigger:"blur"},{min:3,message:"El nombre de usuario debe tener al menos 3 caracteres",trigger:"blur"}],acceptTerms:[{validator:(g,q,o)=>{q===!0?o():o(new Error("Debes aceptar los términos y condiciones"))},trigger:"change",required:!0}]},submitForm:async()=>{if(a.value)try{const g=await a.value.validate();alert(g?`¡Formulario válido!
Usuario: ${n.username}
