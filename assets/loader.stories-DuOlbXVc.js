import{d as h,a as w,e as L,T as y,b as i,t as p,l as u,j as g,x,r as n,w as f}from"./vue.esm-bundler-C6DRpX4R.js";import{_ as j}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{a as M,b as v}from"./documentation-stories-0qKiiCdD.js";import"./index-fKX7T4ju.js";import"./props.util-DQIcYPkU.js";import"./error.util-CtUs3PUB.js";import"./install.util-cBz1HN_T.js";const b=h({name:"Loader",props:{show:{default:!1,type:Boolean},message:{default:"",type:String}}}),C=""+new URL("preloader-C2KrFHCF.gif",import.meta.url).href,E={key:0,class:"gui-loader"},_={class:"flex flex-col items-center justify-center"},I={key:0,class:"mt-md text-inverse-txt text-4 font-medium max-w-96 mx-auto text-center drop-shadow-lg"};function S(e,d,s,z,D,T){return i(),w(y,{name:"fade"},{default:L(()=>[e.show?(i(),p("div",E,[g("div",_,[d[0]||(d[0]=g("img",{src:C,class:"h-20"},null,-1)),e.message?(i(),p("p",I,x(e.message),1)):u("",!0)])])):u("",!0)]),_:1})}const l=j(b,[["render",S]]);b.__docgenInfo={displayName:"Loader",exportName:"default",description:"",tags:{},props:[{name:"show",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"message",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/loader/Loader.vue"]};const a=n(!1),c=n("");n();n(!1);const k="0.2.4",m={vue:"^3.2.0"},N={title:"Feedback/Loader",component:l,parameters:{docs:{description:{component:`
...
}`,...t.parameters?.docs?.source}}};const O=["Default","WithMessage","Interactive"];export{o as Default,t as Interactive,r as WithMessage,O as __namedExportsOrder,N as default};
