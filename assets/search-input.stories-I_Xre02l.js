import{r as t,c as T,s as N,l as U,d as $,a2 as H,o as h,y as O,a as g,w,f as D,g as v,u as a,b as K,j as S,m as _,ac as W,R as Y}from"./iframe-Dct5CHxr.js";import{Y as J}from"./index-DR8mscXh.js";import{G as L,a as Q}from"./Skeleton-8SKRGv7V.js";import{R as F}from"./index-1T7U7QlS.js";import{e as X}from"./index-pMiYc9r3.js";import{u as Z}from"./useEmptyValues-BnYvcW4O.js";import{w as ee}from"./install.util-cBz1HN_T.js";import{G as y}from"./ConfigProvider-7dg58IlU.js";import{a as ae,b as j}from"./documentation-stories-DmJzCMmf.js";import"./preload-helper-Dch09mLN.js";import"./index-DWhPhD7W.js";import"./index-CZoNQBHQ.js";import"./useId-MLHLvdkG.js";import"./useAttrs-BZi71rd1.js";import"./event.constant-LtAI3-H4.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-GU5Cqqg3.js";function ne(s,n,c){const e=t(),r=t(s.modelValue||""),m=t(!1),o=T(()=>{const{class:l,style:z,modelValue:P,"onUpdate:modelValue":p,disabled:f,initialLoading:k,searchingLoading:te,debounceTime:le,placeholder:ce,label:ie,helpText:de,messageError:ue,...V}=c;return V}),x=X(l=>{m.value=!1,n("search",l)},s.debounceTime),u=l=>{r.value=l,n("update:modelValue",l),m.value=!0,x(l)},i=()=>{m.value=!1,n("search",r.value)},B=l=>{l?E():e.value?.focus()},E=()=>{r.value="",n("update:modelValue",""),n("clear"),n("search",""),e.value?.focus()};return N(()=>s.modelValue,l=>{l!==r.value&&(r.value=l)},{immediate:!0}),{inputRef:e,searchQuery:r,filteredAttrs:o,handleInput:u,handleEnterKey:i,handleIconClick:B,clearSearch:E,focus:()=>e.value?.focus(),blur:()=>e.value?.blur()}}const re=U({modelValue:{type:String,default:""},placeholder:{type:String,default:""},label:{type:String,default:""},helpText:{type:String,default:""},messageError:{type:String,default:""},disabled:Boolean,initialLoading:Boolean,searchingLoading:Boolean,debounceTime:{type:Number,default:300}}),se={"update:modelValue":s=>!0,search:s=>!0,clear:()=>!0},G=$({name:"GSearchInput",inheritAttrs:!1,__name:"search-input",props:re,emits:se,setup(s,{expose:n,emit:c}){const e=s,r=c,m=H(),o=Z("search-input"),x=T(()=>[{[o.is("disabled")]:e.disabled,[o.is("searching")]:e.searchingLoading,[o.is("loading")]:e.initialLoading,[o.is("error")]:!!e.messageError}]),{inputRef:u,searchQuery:i,filteredAttrs:B,handleInput:E,handleEnterKey:l,handleIconClick:z,clearSearch:P}=ne(e,r,m);return n({focus:()=>u.value?.focus(),blur:()=>u.value?.blur(),clear:P}),(p,f)=>(h(),O("div",{class:v([a(o).b(),x.value])},[p.initialLoading?(h(),g(a(Q),{key:0,animated:""},{template:w(()=>[D("div",{class:v(a(o).e("skeleton"))},[K(a(L),{variant:"text",class:"h-12 rounded-md"}),p.$attrs["help-text"]||e.helpText?(h(),g(a(L),{key:0,variant:"text"})):S("",!0)],2)]),_:1})):(h(),g(a(J),_({key:1,ref_key:"inputRef",ref:u,"model-value":a(i)},a(B),{class:[a(o).e("input")],disabled:p.disabled,loading:p.searchingLoading,placeholder:e.placeholder,label:e.label,"help-text":e.helpText,"message-error":e.messageError,"onUpdate:modelValue":a(E),onKeydown:W(Y(a(l),["prevent"]),["enter"])}),{suffix:w(()=>[D("div",{class:v(a(o).e("icon-container"))},[!p.searchingLoading&&!a(i)?(h(),g(a(F),{key:0,name:"regular search",class:v(a(o).e("icon")),onClick:f[0]||(f[0]=k=>a(z)(!1))},null,8,["class"])):S("",!0),!p.searchingLoading&&a(i)?(h(),g(a(F),{key:1,name:"regular times",class:v(a(o).e("icon")),onClick:f[1]||(f[1]=k=>a(z)(!0))},null,8,["class"])):S("",!0),p.searchingLoading?(h(),g(a(F),{key:2,name:"regular arrows-rotate",class:v(a(o).e("icon")),spin:""},null,8,["class"])):S("",!0)],2)]),_:1},16,["model-value","class","disabled","loading","placeholder","label","help-text","message-error","onUpdate:modelValue","onKeydown"]))],2))}}),b=ee(G,{SearchInput:G}),oe="1.2.25",M={"@flash-global66/g-config-provider":"0.0.8","@flash-global66/g-icon-font":"^0.0.8","@flash-global66/g-input":"0.3.0","@flash-global66/g-skeleton":"0.0.7","@vueuse/core":"^12.4.0",vue:"^3.2.0"},{action:d}=__STORYBOOK_MODULE_ACTIONS__,ze={title:"Form/SearchInput",component:b,parameters:{docs:{description:{component:`
...
<g-search-input
  ...
  @clear="onClear"
/>
`,language:"html"}}},render:s=>({components:{GSearchInput:b,GConfigProvider:y},setup(){const n=t("");return{args:s,search:n,onSearch:d("search"),onClear:d("clear")}},template:`
      <g-config-provider>
        <g-search-input
          v-model="search"
          v-bind="args"
...
<g-search-input
  ...
  @clear="onClear"
/>
`,language:"html"}}},render:()=>({components:{GSearchInput:b,GConfigProvider:y},setup(){return{search:t(""),onSearch:d("search"),onClear:d("clear")}},template:`
      <g-config-provider>
        <g-search-input
          v-model="search"
          label="Buscar"
...
`,language:"html"}}},render:()=>({components:{GSearchInput:b,GConfigProvider:y},setup(){return{search:t(""),onSearch:d("search"),onClear:d("clear")}},template:`
    ...
    `})},A={name:"Uso de debounce",parameters:{docs:{description:{story:"El componente SearchInput incluye funcionalidad de debounce para optimizar las búsquedas, evitando llamadas innecesarias mientras el usuario está escribiendo."},source:{code:`
<template>
  <g-search-input
    v-model="search"
...
<\/script>
`,language:"html"}}},render:()=>({components:{GSearchInput:b,GConfigProvider:y},setup(){const s=t(""),n=t(""),c=t(0);return{search:s,lastSearch:n,searchCount:c,handleSearch:r=>{n.value=r,c.value++,d("search")(r)}}},template:`
      <g-config-provider>
        <div class="space-y-6">
    ...
    `})},R={name:"Integración con API",parameters:{docs:{description:{story:"Este ejemplo muestra cómo integrar el componente SearchInput con una API, manejando estados de carga, resultados y errores."},source:{code:`
<template>
  <g-search-input
    v-model="search"
...
<\/script>
`,language:"html"}}},render:()=>({components:{GSearchInput:b,GConfigProvider:y},setup(){const s=t(""),n=t(!1),c=t(!1),e=t([]),r=t(""),m=[{id:1,name:"Juan Pérez"},{id:2,name:"María López"},{id:3,name:"Carlos González"},{id:4,name:"Ana Martínez"},{id:5,name:"Ricardo Ruben"},{id:6,name:"Lucía Rodríguez"},{id:7,name:"Alejandro Morales"},{id:8,name:"Valentina Torres"},{id:9,name:"Diego Hernández"},{id:10,name:"Sofía Ramírez"}];return{search:s,isSearching:n,hasError:c,searchResults:e,errorMessage:r,searchInApi:u=>{n.value=!0,c.value=!1,r.value="",e.value=[],setTimeout(()=>{try{if(Math.random()<.2&&u.length>0)throw new Error("Error de conexión al servidor");u?e.value=m.filter(i=>i.name.toLowerCase().includes(u.toLowerCase())):e.value=[],d("API search success")(e.value)}catch(i){c.value=!0,r.value=i.message,d("API search error")(i.message)}finally{n.value=!1}},1e3)},handleClear:()=>{e.value=[],c.value=!1,r.value="",d("clear")()}}},template:`
      <g-config-provider>
        <div class="space-y-6">
          <div class="bg-gray-50 rounded-md p-4">
    ...
    `})},Fe=["Primary","WithLabel","States","WithDebounce","ApiIntegration"];q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
  name: 'Básico',
  parameters: {
    docs: {
      description: {
...
}`,...R.parameters?.docs?.source}}};export{R as ApiIntegration,q as Primary,I as States,A as WithDebounce,C as WithLabel,Fe as __namedExportsOrder,ze as default};
