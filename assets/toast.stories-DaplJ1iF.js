import{d as ee,r as oe,c as b,o as te,b as W,e as w,f as se,j as $,k as G,n as F,l as g,u as i,h as H,m as R,x as E,s as ae,y as re,v as Q,S as ne,T as ie,R as N,i as D,G as ce,am as Z}from"./vue.esm-bundler-BiLMJBXK.js";import{u as le}from"./index-mx_pK5Ly.js";import{S as _}from"./index-jZ5CM1us.js";import{b as pe,d as j,w as de,a as ue}from"./install-BOOPtfBD.js";import{u as me,G as m}from"./ConfigProvider-qZNzJU0u.js";import{u as fe,a as ge,h as X,v as ye}from"./index-BzJBbEF1.js";import{E as q}from"./aria-BUADUvnR.js";import{u as he}from"./index-BBJ4PQcT.js";import{G as y}from"./index-DGYrpcrX.js";import{a as we,b as ve}from"./documentation-stories-CAEV4JNo.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./error-Cq9Fpw4b.js";import"./index-4o8CGBx3.js";import"./index-Bc6e4lZJ.js";import"./_arrayPush-DTRztRsG.js";import"./index-CvPWi8JN.js";import"./index-CX_Dg7_S.js";import"./index-CYijZHa6.js";const J=["success","info","warning","error"],Te=["sm","md"],be=pe({customClass:{type:String,default:""},dangerouslyUseHTMLString:Boolean,duration:{type:Number,default:5e3},id:{type:String,default:""},message:{type:j([String,Object,Function]),default:""},offset:{type:Number,default:0},onClick:{type:j(Function),default:()=>{}},onClose:{type:j(Function),required:!0},position:{type:String,values:["top-right","top-left","bottom-right","bottom-left"],default:"top-right"},showClose:{type:Boolean,default:!0},showProgress:{type:Boolean,default:!0},size:{type:String,values:Te,default:"md"},type:{type:String,values:J,required:!0},zIndex:Number}),Ge={destroy:()=>!0},Ce=["id"],Pe={key:0},Be=["innerHTML"],z=ee({name:"GToast",__name:"toast",props:be,emits:Ge,setup(e,{expose:s}){const t=e,{nextZIndex:c,currentZIndex:d}=me(),r=fe("toast"),n=oe(!1);let p;const u={success:"solid check-circle",info:"solid info-circle",warning:"solid exclamation-triangle",error:"solid times-circle"},l=b(()=>u[t.type]),f=b(()=>t.position.endsWith("right")?"right":"left"),h=b(()=>t.position.startsWith("top")?"top":"bottom"),I=b(()=>({[h.value]:`${t.offset}px`,zIndex:t.zIndex??d.value}));function A(){if(t.duration>0){const{stop:a}=he(()=>{n.value&&v()},t.duration);p=a}}function V(){p?.()}function v(){n.value=!1}function Y({code:a}){a===q.delete||a===q.backspace?V():a===q.esc?n.value&&v():A()}return te(()=>{A(),c(),n.value=!0}),le(document,"keydown",Y),s({visible:n,close:v}),(a,T)=>(w(),W(ie,{name:i(r).b("fade"),onBeforeLeave:a.onClose,onAfterLeave:T[1]||(T[1]=U=>a.$emit("destroy"))},{default:se(()=>[$(G("div",{id:a.id,class:g([i(r).b(),i(r).m(t.type),i(r).m(t.size),a.customClass,f.value]),style:F(I.value),role:"alert",onMouseenter:V,onMouseleave:A,onClick:T[0]||(T[0]=(...U)=>a.onClick&&a.onClick(...U))},[H(i(_),{class:g([i(r).e("icon"),i(r).m(t.type)]),name:l.value},null,8,["class","name"]),G("div",{class:g(i(r).e("group"))},[$(G("div",{class:g(i(r).e("content"))},[ae(a.$slots,"default",{},()=>[a.dangerouslyUseHTMLString?(w(),E("p",{key:1,innerHTML:a.message},null,8,Be)):(w(),E("p",Pe,re(a.message),1))])],2),[[Q,a.message]])],2),a.showClose?(w(),W(i(_),{key:0,class:g(i(r).e("closeBtn")),onClick:ne(v,["stop"]),name:"solid times"},null,8,["class"])):R("",!0),a.showProgress&&a.duration>0?(w(),E("div",{key:1,class:g(i(r).e("progress"))},[G("div",{class:g([i(r).e("progress-bar"),i(r).m(t.type)]),style:F({animationDuration:`${a.duration}ms`})},null,6)],2)):R("",!0)],46,Ce),[[Q,n.value]])]),_:3},8,["name","onBeforeLeave"]))}});z.__docgenInfo={name:"GToast",exportName:"default",displayName:"toast",description:"",tags:{},expose:[{name:"visible"},{name:"close",tags:[{title:"description",content:"close notification"}]}],events:[{name:"destroy"}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/toast/src/toast.vue"]};const L={"top-left":[],"top-right":[],"bottom-left":[],"bottom-right":[]},O=16;let xe=1;const o=function(e={},s){if(!ge)return{close:()=>{}};(N(e)||D(e))&&(e={message:e});const t=e.position||"top-right";let c=e.offset||0;L[t].forEach(({vm:h})=>{c+=(h.el?.offsetHeight||0)+O}),c+=O;const d=`toast_${xe++}`,r=e.onClose,n={...e,offset:c,id:d,onClose:()=>{Se(d,t,r)}};let p=document.body;X(e.appendTo)?p=e.appendTo:N(e.appendTo)&&(p=document.querySelector(e.appendTo)),X(p)||(p=document.body);const u=document.createElement("div"),l=H(z,n,ce(n.message)?n.message:D(n.message)?()=>n.message:null),f=H(m,{},{default:()=>l});return f.appContext=ye(s)?o._context:s,f.props.onDestroy=()=>{Z(null,u)},Z(f,u),L[t].push({vm:l}),p.appendChild(u.firstElementChild),{close:()=>{l.component.exposed.visible.value=!1}}};J.forEach(e=>{o[e]=(s={},t)=>((N(s)||D(s))&&(s={message:s}),o({...s,type:e},t))});function Se(e,s,t){const c=L[s],d=c.findIndex(({vm:l})=>l.component?.props.id===e);if(d===-1)return;const{vm:r}=c[d];if(!r)return;t?.(r);const n=r.el.offsetHeight,p=s.split("-")[0];c.splice(d,1);const u=c.length;if(!(u<1))for(let l=d;l<u;l++){const{el:f,component:h}=c[l].vm,I=Number.parseInt(f.style[p],10)-n-O;h.props.offset=I}}function Me(){for(const e of Object.values(L))e.forEach(({vm:s})=>{s.component.exposed.visible.value=!1})}o.closeAll=Me;o._context=null;const ke=de(z,{Toast:z});ue(o,"$toastify");const ze="1.1.0",K={"@flash-global66/g-icon-font":"^0.10.0","@vueuse/core":"^12.4.0","element-plus":"^2.9.0",vue:"^3.2.0"},_e={title:"Feedback/Toast",component:ke,parameters:{docs:{description:{component:`
...
toast({ type: 'error', message: 'Inferior izquierda', position: 'bottom-left' })`}}},render:()=>({components:{GButton:y,GConfigProvider:m},setup(){return{positions:[{key:"top-left",label:"Arriba Izquierda"},{key:"top-right",label:"Arriba Derecha"},{key:"bottom-left",label:"Abajo Izquierda"},{key:"bottom-right",label:"Abajo Derecha"}],showToast:t=>{o({type:"info",message:`Toast desde ${t}`,position:t,duration:4e3})}}},template:`
    ...
    `})},S={name:"Control de Duración",parameters:{docs:{description:{story:"Controla cuánto tiempo permanecen visibles los toasts. La duración de 0 hace que el toast permanezca hasta que el usuario lo cierre manualmente."},source:{code:`toast({ type: 'info', message: 'Rápido', duration: 2000 })
...
toast({ type: 'error', message: 'Persistente', duration: 0 })`}}},render:()=>({components:{GButton:y,GConfigProvider:m},setup(){return{showQuick:()=>{o.success({message:"Toast rápido (2s)",duration:2e3})},showNormal:()=>{o.info("Toast normal (5s por defecto)")},showLong:()=>{o.warning({message:"Toast largo (10s)",duration:1e4})},showPersistent:()=>{o.error({message:"Toast persistente (cierre manual)",duration:0})}}},template:`
    ...
    `})},M={name:"Configuración Avanzada",parameters:{docs:{description:{story:"Opciones avanzadas: contenido HTML, offset personalizado y sin botón de cerrar."},source:{code:`// Contenido HTML
toast({
  type: 'info',
...
}`,...k.parameters?.docs?.source}}};const Xe=["Playground","Primary","AllTypes","Positions","DurationControl","AdvancedUsage","Sizes"];export{M as AdvancedUsage,B as AllTypes,S as DurationControl,C as Playground,x as Positions,P as Primary,k as Sizes,Xe as __namedExportsOrder,_e as default};
