import{l as re,d as te,r as s,c as D,t as se,ax as ie,o as i,a as $,w as h,b as z,T as le,u as e,e as de,f as I,m as N,R as ce,g as l,y as d,j as c,z as P,i as G,F as pe,A as me,B as ue,v as ve}from"./iframe-Dct5CHxr.js";import{G as fe}from"./index-B1cyEMyk.js";import{L as be,b as ge}from"./index-DxlLUiSm.js";import{R as we,V as ye,G as xe}from"./index-Bl0NARfw.js";import{c as he}from"./index-QAcBYSVr.js";import{t as Ce}from"./index-BgdLHs-h.js";import{u as De,c as ze}from"./useEmptyValues-BnYvcW4O.js";import{w as Ee}from"./install.util-cBz1HN_T.js";import{G as w}from"./index-BeqF1NXI.js";import{G as y}from"./ConfigProvider-7dg58IlU.js";import{G as Fe}from"./index-5OiSV4ne.js";import{G as ke}from"./index-XrXeeEoZ.js";import{a as je,b as U}from"./documentation-stories-DmJzCMmf.js";import"./preload-helper-Dch09mLN.js";import"./event.constant-LtAI3-H4.js";import"./index-CZoNQBHQ.js";import"./useId-MLHLvdkG.js";import"./index-pMiYc9r3.js";import"./index-1T7U7QlS.js";import"./refs.util-D3l8TA3E.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-GU5Cqqg3.js";const Ae=re({...we,direction:{type:String,default:"rtl",values:["ltr","rtl","ttb","btt"]},size:{type:[String,Number],default:"400px"},description:{type:String,default:""},modalFade:{type:Boolean,default:!0},headerAriaLevel:{type:String,default:"2"},withHeader:{type:Boolean,default:!0},showClose:{type:Boolean,default:!0},responsiveSize:{type:[Object,Boolean],default:!1,validator:o=>{if(typeof o=="boolean")return!0;if(typeof o=="object"){const r=["sm","md","lg"];return Object.keys(o).every(n=>r.includes(n))}return!1}}}),Te=ye,Se=["aria-label","aria-labelledby","aria-describedby"],Oe=["id","aria-level"],Pe=["id"],g="400px",Ge=te({name:"GDrawer",inheritAttrs:!1,__name:"drawer",props:Ae,emits:Te,setup(o,{expose:r}){const n=o,p=s(),v=s(),t=De("drawer"),f=D(()=>n.direction==="rtl"||n.direction==="ltr"),x=D(()=>n.closeOnPressEscape),m=D(()=>n.closeOnClickModal),C=s(window.innerWidth),R=D(()=>{let a=n.size;const b=typeof n.responsiveSize=="object"&&n.responsiveSize!==null;return C.value<576?a="100%":C.value<768?a=b&&n.responsiveSize.sm||g:C.value<992?a=b&&n.responsiveSize.md||g:a=b?n.responsiveSize.lg||n.size||g:n.size||g,ze(a)}),V=()=>{C.value=window.innerWidth};se(()=>{window.addEventListener("resize",V)}),ie(()=>{window.removeEventListener("resize",V)});const{afterEnter:H,afterLeave:q,beforeLeave:J,visible:S,rendered:X,titleId:M,bodyId:W,zIndex:Z,onModalClick:K,onOpenAutoFocus:Q,onCloseAutoFocus:Y,onFocusoutPrevented:_,onCloseRequested:ee,handleClose:L,displayButtons:ae,buttonLayoutClass:ne}=xe(n,p,{closeOnClickModal:m,closeOnPressEscape:x});return r({handleClose:L,afterEnter:H,afterLeave:q}),(a,b)=>(i(),$(e(ge),{to:a.appendTo,disabled:a.appendTo!=="body"?!1:!a.appendToBody},{default:h(()=>[z(le,{name:e(t).b("fade"),onAfterEnter:e(H),onAfterLeave:e(q),onBeforeLeave:e(J)},{default:h(()=>[de(z(e(fe),{mask:a.modal,"overlay-class":a.modalClass,"z-index":e(Z),onClick:e(K)},{default:h(()=>[z(e(be),{loop:"",trapped:e(S),"focus-trap-el":p.value,"focus-start-el":v.value,onFocusAfterTrapped:e(Q),onFocusAfterReleased:e(Y),onFocusoutPrevented:e(_),onReleaseRequested:e(ee)},{default:h(()=>[I("div",N({ref_key:"drawerRef",ref:p,"aria-modal":"true","aria-label":a.title||void 0,"aria-labelledby":a.title?void 0:e(M),"aria-describedby":e(W)},a.$attrs,{class:[e(t).b(),a.direction,e(S)&&"open"],style:f.value?"width: "+R.value:"height: "+R.value,role:"dialog",onClick:b[0]||(b[0]=ce(()=>{},["stop"]))}),[I("span",{ref_key:"focusStartRef",ref:v,class:l(e(t).e("sr-focus")),tabindex:"-1"},null,2),n.withHeader?(i(),d("header",{key:0,class:l([e(t).e("header"),a.headerClass])},[n.showClose?(i(),d("div",{key:0,class:l(e(t).em("header","container-close"))},[z(e(Ce),{icon:"regular times",onClick:e(L)},null,8,["onClick"])],2)):c("",!0),a.$slots.customHeader||a.title||a.description?(i(),d("div",{key:1,class:l(e(t).em("header","container-title"))},[a.title||a.description?(i(),d("div",{key:0,class:l(e(t).em("header","title-description"))},[a.title?(i(),d("h5",{key:0,id:e(M),role:"heading","aria-level":a.headerAriaLevel,class:l(e(t).e("title"))},P(a.title),11,Oe)):c("",!0),a.description?(i(),d("span",{key:1,class:l(e(t).e("description"))},P(a.description),3)):c("",!0)],2)):c("",!0),a.$slots.customHeader?G(a.$slots,"customHeader",{key:1}):c("",!0)],2)):c("",!0)],2)):c("",!0),e(X)?(i(),d("div",{key:1,id:e(W),class:l([e(t).e("body"),a.bodyClass])},[G(a.$slots,"default")],10,Pe)):c("",!0),a.$slots.footer||n.footerButtons?.length?(i(),d("div",{key:2,class:l([e(t).e("footer"),a.footerClass])},[G(a.$slots,"footer",{},()=>[n.footerButtons?.length?(i(),d("div",{key:0,class:l([e(t).em("footer","buttons"),e(ne)])},[(i(!0),d(pe,null,me(e(ae),(O,oe)=>(i(),$(e(he),N({key:oe,full:"",onClick:O.onClick},{ref_for:!0},{...O,onClick:void 0}),{default:h(()=>[ue(P(O.text),1)]),_:2},1040,["onClick"]))),128))],2)):c("",!0)])],2)):c("",!0)],16,Se)]),_:3},8,["trapped","focus-trap-el","focus-start-el","onFocusAfterTrapped","onFocusAfterReleased","onFocusoutPrevented","onReleaseRequested"])]),_:3},8,["mask","overlay-class","z-index","onClick"]),[[ve,e(S)]])]),_:3},8,["name","onAfterEnter","onAfterLeave","onBeforeLeave"])]),_:3},8,["to","disabled"]))}}),u=Ee(Ge),Be="0.3.25",B={"@flash-global66/g-button":"^0.1.0","@flash-global66/g-dialog":"^0.0.8","@flash-global66/g-focus-trap":"^0.0.7","@flash-global66/g-icon-font":"^0.0.8","@flash-global66/g-overlay":"^0.0.7","@flash-global66/g-teleport":"^0.0.6",vue:"^3.2.0"},ra={title:"Feedback/Drawer",component:u,parameters:{docs:{description:{component:`
...
- Variante de botones
- Organización de botones en el footer`}}},render:()=>({components:{GDrawer:u,GConfigProvider:y,GButton:w},setup(){const o=s(!1),r=s([]),n=()=>{o.value=!1},p=f=>{o.value=!0,r.value=t(f)},v={1:{text:"Guardar",onClick:n,variant:"primary"},2:{text:"Cancelar",onClick:n,variant:"secondary"},3:{text:"Eliminar",onClick:n,variant:"tertiary"}},t=f=>{const x=[];for(let m=0;m<f;m++)x.push(v[m+1]);return x};return{drawer:o,handleClose:n,handleOpen:p,buttons:r}},template:`
      <g-config-provider>
    ...
    `})},k={name:"Direcciones",parameters:{docs:{description:{story:`Este ejemplo muestra cómo se ven los drawers en todas las direcciones.

- Dirección de apertura
- Título y descripción`}}},render:()=>({components:{GDrawer:u,GConfigProvider:y,GButton:w,GRadioGroup:ke},setup(){const o=s(!1),r=s("rtl");return{drawer:o,directions:[{value:"ltr",label:"Izquierda a derecha"},{value:"rtl",label:"Derecha a izquierda"},{value:"ttb",label:"Arriba a abajo"},{value:"btt",label:"Abajo a arriba"}],direction:r}},template:`
      <g-config-provider>
...
- Título y descripción`}}},render:()=>({components:{GDrawer:u,GConfigProvider:y,GButton:w,GTag:Fe},setup(){const o=s(!1),r=Array(12).fill({send:"$100.000,00 CLP",convert:"$87.000,00 CLP"});return{drawer:o,items:r}},template:`
      <g-config-provider>
        <g-button @click="drawer = true">
          Abrir drawer
        </g-button>
...
<\/script>
`,language:"html"}}},render:()=>({components:{GDrawer:u,GConfigProvider:y,GButton:w},setup(){const o=s(!1),r=s(!1),n=s("30%");return{fixedDrawer:o,responsiveDrawer:r,currentWidth:n,widthOptions:[{label:"Pequeño (30%)",value:"30%"},{label:"Medio (50%)",value:"50%"},{label:"Grande (80%)",value:"80%"},{label:"Fijo (400px)",value:"400px"}],openFixedDrawer:m=>{n.value=m,o.value=!0},openResponsiveDrawer:()=>{r.value=!0},handleCloseFixed:()=>{o.value=!1},handleCloseResponsive:()=>{r.value=!1},window}},template:`
      <g-config-provider>
...
responsiveSize: {
  ...
  lg: '40%'    // 992px+ (sobrescribe el valor de 'size')
    ...
    `})},T={name:"Opciones de Header",parameters:{docs:{description:{story:"El componente Drawer ofrece flexibilidad para personalizar el header con las propiedades `showClose` y `withHeader`. Esta historia muestra las distintas combinaciones posibles."},source:{code:`
<template>
...
`,language:"html"}}},render:()=>({components:{GDrawer:u,GConfigProvider:y,GButton:w},setup(){const o=s("default"),r=s(!1);return{drawer:r,selectedOption:o,options:[{value:"default",label:"Header completo (por defecto)"},{value:"noClose",label:"Sin botón de cierre"},{value:"noHeader",label:"Sin header"}],openDrawer:()=>{r.value=!0},closeDrawer:()=>{r.value=!1}}},template:`
      <g-config-provider>
        <div class="space-y-6">
          <div class="bg-gray-50 rounded-md p-4">
    ...
    `})},ta=["Primary","FooterButtonsTypes","Directions","CustomHeader","Sizes","HeaderOptions"];E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  name: 'Básico',
  parameters: {
    docs: {
      description: {
...
}`,...T.parameters?.docs?.source}}};export{j as CustomHeader,k as Directions,F as FooterButtonsTypes,T as HeaderOptions,E as Primary,A as Sizes,ta as __namedExportsOrder,ra as default};
