import{r as o,k as S,w as x,l as w,z as p,m as G,U as K,h as j,c as I,n as C,J as B,u as m,K as M,T as U,D as A,L as J,H as Y,C as Z,Y as Q,Z as R}from"./vue.esm-bundler-ENg2wqJc.js";import{F as W}from"./index.es-B5q-6M42.js";import{_ as X}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{G as q}from"./ConfigProvider-C0wXp6tN.js";const ee={active:o(null),count:o(0),accordion:o(!1),disabled:o(!1),hideIcon:o(!1),setActiveItem:()=>console.log},N=Symbol("GCollapse"),te={class:"gui-accordion"},ae={name:"GCollapseContent"},V=S({...ae,props:{modelValue:{type:Number,default:null},default:{type:Number,default:null},disabled:{type:Boolean,default:!1},accordion:{type:Boolean,default:!1},hideIcon:{type:Boolean,default:!1}},emits:["update:modelValue","click-collapse"],setup(c,{emit:d}){const e=c,i=d,g=o(0),n=o(e.modelValue||e.default),s=o(e.accordion),v=o(e.disabled),b=o(e.hideIcon);return!e.accordion&&e.modelValue!==void 0&&!Array.isArray(e.modelValue)&&console.error("El v-model no es un array. Envuelva su referencia en un array."),e.accordion&&Array.isArray(e.modelValue)&&console.error("El v-model es un array. Su referencia debe ser en un tipo primitivo."),e.modelValue||(s.value?n.value=e.default:n.value=e.default!==null?[e.default]:[]),x(()=>e.modelValue,a=>{Array.isArray(a)&&console.log(a[0],typeof a),n.value=a},{deep:!0,immediate:!0}),x(()=>e.disabled,a=>{v.value=a}),x(()=>e.hideIcon,a=>{b.value=a}),K(N,{count:g,active:n,accordion:s,disabled:v,hideIcon:b,setActiveItem:(a,l)=>{let r=a;const _=n.value;if(s.value&&l&&(n.value=a),!s.value&&Array.isArray(n.value)){const u=n.value,y=u.findIndex(h=>h===a);y!==-1?u.splice(y,1):u.push(a),r=u,n.value=u}i("click-collapse",{itemOld:_,itemNew:r,itemCurrent:a,visible:l}),i("update:modelValue",r)}}),(a,l)=>(G(),w("div",te,[p(a.$slots,"default")]))}});V.__docgenInfo={exportName:"default",displayName:"Collapse",description:"",tags:{},props:[{name:"modelValue",type:{name:"ValueCollapse"},defaultValue:{func:!1,value:"null"}},{name:"default",type:{name:"number | string"},defaultValue:{func:!1,value:"null"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"accordion",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"hideIcon",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],events:[{name:"update:modelValue",type:{names:["ValueCollapse"]}},{name:"click-collapse",type:{names:["ChangeCollapse"]}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/collapse/Collapse.vue"]};const le=["aria-disabled"],ne={class:"flex"},oe={name:"GCollapseItem"},H=S({...oe,props:{classHead:{type:String,default:""},classIcon:{type:String,default:""},classContent:{type:String,default:""},disabled:{type:Boolean,default:!1},name:{type:String},title:{type:String,default:""},hideIcon:{type:Boolean,default:!1}},emits:["open","close","opened","closed","click-item"],setup(c,{emit:d}){const e=c,i=d,{count:g,active:n,disabled:s,accordion:v,setActiveItem:b,hideIcon:T}=j(N,ee),a=o(e.name?e.name:g.value++),l=o(!1),r=I(()=>s.value||e.disabled),_=I(()=>T.value||e.hideIcon),u=I(()=>[e.classHead.length?e.classHead:"flex w-full justify-between border-solid border-2 border-gray-18 px-4 sm:px-6 py-3 rounded-md flex-1 items-center",!e.classHead.length&&r.value?"bg-gray-18 text-gray-4":"bg-white text-gray-1 font-medium",r.value?"cursor-not-allowed select-none":"cursor-pointer"]),y=I(()=>[e.classIcon.length?e.classIcon:"flex items-center text-6",r.value?"text-gray-5":"text-gray-3",{"active-icon":l.value}]);x(n,()=>{h()});function h(){v.value&&Array.isArray(n.value)?l.value=n.value.includes(a.value):l.value=n.value===a.value}h();function $(t){t.preventDefault(),!r.value&&(l.value=!l.value,b(a.value,l.value),i("click-item",{event:t,itemKey:a.value,visible:l.value,disabled:s.value}))}function E(t){t.style.height="0px"}function F(t){i("open"),requestAnimationFrame(()=>{t.style.height=t.scrollHeight+"px"})}function P(t){i("opened"),t.style.height="auto"}function L(t){t.style.height=t.scrollHeight+"px"}function O(t){i("close"),requestAnimationFrame(()=>{t.style.height="0"})}function z(t){i("close"),requestAnimationFrame(()=>{t.style.height="0"})}return(t,ce)=>(G(),w("section",null,[C("div",{onClick:$},[p(t.$slots,"head",{active:l.value,disabled:m(s)},()=>[C("button",{class:A([u.value,{active:l.value}]),"aria-disabled":m(s)},[p(t.$slots,"title",{active:l.value,disabled:m(s)},()=>[J(Y(c.title),1)],!0),C("div",ne,[p(t.$slots,"icon",{active:l.value,disabled:m(s)},()=>[_.value?Z("",!0):(G(),w("div",{key:0,class:A([...y.value,"duration-200"])},[B(m(W),{icon:["far","chevron-down"]})],2))],!0),p(t.$slots,"right",{active:l.value,disabled:m(s)},void 0,!0)])],10,le)],!0)]),B(U,{name:"gui-collapse",onBeforeEnter:E,onEnter:F,onAfterEnter:P,onBeforeLeave:L,onLeave:O,onAfterLeave:z},{default:M(()=>[Q(C("div",{class:A(c.classContent)},[p(t.$slots,"content",{active:l.value,disabled:m(s)},void 0,!0)],2),[[R,l.value]])]),_:3})]))}}),D=X(H,[["__scopeId","data-v-a90d8bf8"]]);H.__docgenInfo={exportName:"default",displayName:"CollapseItem",description:"",tags:{},props:[{name:"classHead",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"classIcon",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"classContent",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"disabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"name",type:{name:"string"}},{name:"title",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"hideIcon",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],events:[{name:"open"},{name:"close"},{name:"opened"},{name:"closed"},{name:"click-item"}],slots:[{name:"head",scoped:!0,bindings:[{name:"active",title:"binding"},{name:"disabled",title:"binding"}]},{name:"title",scoped:!0,bindings:[{name:"active",title:"binding"},{name:"disabled",title:"binding"}]},{name:"icon",scoped:!0,bindings:[{name:"active",title:"binding"},{name:"disabled",title:"binding"}]},{name:"right",scoped:!0,bindings:[{name:"active",title:"binding"},{name:"disabled",title:"binding"}]},{name:"content",scoped:!0,bindings:[{name:"active",title:"binding"},{name:"disabled",title:"binding"}]}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/collapse/CollapseItem.vue"]};const pe={title:"Data/Collapse",component:V,subcomponents:{GCollapseItem:D},argTypes:{animated:{defaultValue:!0},count:{defaultValue:1},rows:{defaultValue:3}},parameters:{docs:{description:{component:"The collapse component will help us to compress the information, to be able to make it work like an accordion, this means that only one can be open"}}}},se=c=>({components:{GCollapse:V,GConfigProvider:q,GCollapseItem:D},template:`
    <g-config-provider>
