import{r as t,H as w}from"./vue.esm-bundler-BCWWDzSy.js";import{G as o}from"./index-WtKkelXH.js";import{G as l}from"./ConfigProvider-BAdTAJXu.js";import{g as O}from"./documentation-stories-DH-Utv5z.js";import"./index-ccEuFv3G.js";import"./index-DL4FoQEl.js";import"./index-tMAtNoGV.js";import"./index-AiuvB28q.js";import"./install-CHjgJfcB.js";import"./index-CU2PSoyO.js";import"./index-DJArRuUx.js";import"./index-B9DYlcmC.js";import"./_arrayPush-DXBsyDbg.js";import"./index-Chx1QtW8.js";import"./index-lV95ywNu.js";import"./aria-BUADUvnR.js";import"./index-BoOdRfEY.js";import"./index-CAlYKJ_p.js";import"./index-Bz0y6LhV.js";import"./use-form-item-CSfUVDVI.js";import"./constants-Dnj8X3EN.js";import"./index-aQeg2A3h.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./event-BB_Ol6Sd.js";import"./content-Bz3Uvqen.js";import"./index-CAxa7STg.js";import"./index-CkP4L3ZS.js";import"./debounce-BvJzZWWn.js";import"./findLastIndex-DGNMGNI8.js";import"./isEqual-6LQK51M6.js";import"./icon-DXn4vc2S.js";import"./index-Cl_t7jnR.js";import"./error-Cq9Fpw4b.js";import"./index-BJegEf0h.js";import"./index-DCbSzXKS.js";import"./index-CNqC7f2T.js";const ce={title:"Form/Select",component:o,parameters:{docs:{description:{component:`✨ \`GSelect\` - Componente de selección interactivo y personalizable
...
\`\`\`
`}}},argTypes:{modelValue:{name:"v-model",description:"Valor del select (v-model)",control:{type:void 0},table:{category:"Enlace de Datos",type:{summary:"string | number | boolean | array | object"}}},automaticDropdown:{name:"automatic-dropdown",description:"Muestra el menú de opciones al enfocar el select",control:"boolean",table:{category:"Comportamiento e Interacción",type:{summary:"boolean"},defaultValue:{summary:"false"}}},clearable:{description:"Permite limpiar el valor del select",control:"boolean",table:{category:"Comportamiento e Interacción",type:{summary:"boolean"},defaultValue:{summary:"false"}}},filterable:{description:"Activa la búsqueda de opciones",control:"boolean",table:{category:"Comportamiento e Interacción",type:{summary:"boolean"},defaultValue:{summary:"false"}}},persistent:{description:"Mantiene el menú en el DOM cuando está inactivo",control:"boolean",table:{category:"Comportamiento e Interacción",type:{summary:"boolean"},defaultValue:{summary:"true"}}},scrollbarAlwaysOn:{name:"scrollbar-always-on",description:"Muestra siempre la barra de desplazamiento",control:"boolean",table:{category:"Comportamiento e Interacción",type:{summary:"boolean"},defaultValue:{summary:"false"}}},height:{description:"Altura del menú de opciones",control:"number",table:{category:"Apariencia y Estilos",type:{summary:"number"},defaultValue:{summary:"274"}}},itemHeight:{name:"item-height",description:"Altura de cada opción",control:"number",table:{category:"Apariencia y Estilos",type:{summary:"number"},defaultValue:{summary:"55"}}},titleLines:{name:"title-lines",description:"Número máximo de líneas para el título (0 = sin límite, 1 o 2 = trunca con ellipsis)",control:{type:"select",options:[0,1,2]},table:{category:"Apariencia y Estilos",type:{summary:"number"},defaultValue:{summary:"1"}}},descriptionLines:{name:"description-lines",description:"Número máximo de líneas para la descripción (0 = sin límite, 1 o 2 = trunca con ellipsis)",control:{type:"select",options:[0,1,2]},table:{category:"Apariencia y Estilos",type:{summary:"number"},defaultValue:{summary:"0"}}},prefixIcon:{name:"prefix-icon",description:"Ícono al inicio del select",control:"select",options:["",...O()],table:{category:"Apariencia y Estilos",type:{summary:"string"},defaultValue:{summary:""}}},popperClass:{name:"popper-class",description:"Clase personalizada para el menú",control:"text",table:{category:"Apariencia y Estilos",type:{summary:"string"},defaultValue:{summary:"''"}}},offset:{description:"Desplazamiento del menú",control:"number",table:{category:"Apariencia y Estilos",type:{summary:"number"},defaultValue:{summary:"12"}}},options:{description:"Opciones del select",control:"object",table:{category:"Manejo de Datos",type:{summary:"OptionType[]",detail:`
            type OptionType = {
value: any
title: string
description?: string
...
- Evita desajustes de espacio/scroll al abrir y cerrar el dropdown con listas grandes.`}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){const a=["a","b","c","d","e","f","g","h","i","j"],e=t(),s=t(),n=Array.from({length:1e3}).map((E,i)=>({value:`Option ${i+1}`,title:`${a[i%10]}${i} - option ${i+1}`,description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris in enim elementum, sagittis velit eu, feugiat sem. Sed lacinia tincidunt lacinia.",icon:i%2===0?"regular bolt":"regular user",disabled:i%3===0&&i!==0}));return{value:e,options:n,value2:s}},template:`
      <g-config-provider>
...
- Búsqueda de opciones
- Mapeo de propiedades`}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){const a=t(),e=t(!1),s=t([]),n={title:"title",description:"body",value:"id"},E=async c=>{try{return e.value=!0,await(await fetch(`https://jsonplaceholder.typicode.com/posts?q=${c}`)).json()}catch(C){return console.error("Error fetching data:",C),[]}finally{e.value=!1}};return{value:a,options:s,handleSearch:async c=>{s.value=await E(c)},loading:e,mappingProps:n}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
...
- Uso de slots como prefix, default y selectedLabel`}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){const a=t(),e=t(!1),s=t([]),n=async()=>{try{return e.value=!0,(await(await fetch("https://restcountries.com/v3.1/all?fields=name,flags")).json()).map(r=>({value:{id:r.cca2,image:r.flags.svg,countryName:r.name.common},title:r.name.common,country:`${r.name.common} ${r.idd.root??""}`}))}catch(i){return console.error("Error fetching data:",i),[]}finally{e.value=!1}};return{value:a,countries:s,onFocusSelect:async()=>{s.value=await n()},loadingCountries:e}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
...
- Permite borrar la selección actual`}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){return{value:t(),options:[{value:"1",title:"Opción 1"},{value:"2",title:"Opción 2"},{value:"3",title:"Opción 3"},{value:"4",title:"Opción 4"},{value:"5",title:"Opción 5"},{value:"6",title:"Opción 6"},{value:"7",title:"Opción 7"}]}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
    ...
    `})},P=a=>{alert("Click en el input")},v={name:"Estados",parameters:{docs:{description:{story:`Los selects pueden tener diferentes estados que indican su comportamiento y apariencia:
...
- **Loading**: Estado de carga durante operaciones asíncronas`}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){return{states:w({enabled:"",completed:"2",disabled:"Select deshabilitado",event:"",error:"",loading:""}),handleClick:P,options:[{value:"1",title:"Opción 1",description:"Descripción de la opción 1",icon:"regular bolt"},{value:"2",title:"Opción 2",description:"Descripción de la opción 2",icon:"regular user"},{value:"3",title:"Opción 3",description:"Descripción de la opción 3",icon:"regular bolt"},{value:"4",title:"Opción 4",description:"Descripción de la opción 4",icon:"regular user"},{value:"5",title:"Opción 5",description:"Descripción de la opción 5",icon:"regular bolt"}]}},template:`
      <g-config-provider>
    ...
    `})},f={name:"Selección múltiple con tags colapsados",parameters:{docs:{description:{story:"Cuando hay muchos valores seleccionados, los tags se pueden colapsar en uno solo.\n\n- `collapseTags`: muestra un solo tag con el número de seleccionados\n- `collapseTagsTooltip`: al hacer hover se ven todos los tags\n- `maxCollapseTags`: cuántos tags mostrar antes de colapsar (por defecto 1)"}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){return{value:t(["react","vue","angular"]),options:[{value:"react",title:"React"},{value:"vue",title:"Vue"},{value:"angular",title:"Angular"},{value:"svelte",title:"Svelte"},{value:"solid",title:"Solid"}]}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
    ...
    `})},x={name:"Agrupación + selección múltiple",parameters:{docs:{description:{story:"Combinación de opciones agrupadas con selección múltiple. Ideal para elegir varios ítems de distintas categorías."}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){return{value:t([]),optionsWithGroups:[{title:"Frontend",options:[{value:"html",title:"HTML"},{value:"css",title:"CSS"},{value:"js",title:"JavaScript"}]},{title:"Backend",options:[{value:"node",title:"Node.js"},{value:"python",title:"Python"},{value:"go",title:"Go"}]},{title:"Database",options:[{value:"mysql",title:"MySQL"},{value:"postgresql",title:"PostgreSQL"},{value:"mongodb",title:"MongoDB"}]},{title:"DevOps",options:[{value:"docker",title:"Docker"},{value:"kubernetes",title:"Kubernetes"},{value:"terraform",title:"Terraform"}]}]}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
          label="Tecnologías"
    ...
    `})},S={name:"Límite de líneas en opciones",parameters:{docs:{description:{story:`Las props title-lines y description-lines permiten controlar cuántas líneas se muestran en el título y la descripción de cada opción del dropdown.
...
- Si el contenido ocupa más altura, recuerda ajustar item-height para evitar cortes visuales durante la virtualización.`}}},render:()=>({components:{GSelect:o,GConfigProvider:l},setup(){const a=t(),e=t(),s=t();return{value0:a,value1:e,value2:s,longDescriptionOptions:[{value:"1",title:"Transporte de carga nacional e internacional con servicios complementarios",description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris in enim elementum, sagittis velit eu, feugiat sem. Sed lacinia tincidunt lacinia. Donec molestie lacus nec risus semper lobortis.",icon:"regular bolt"},{value:"2",title:"Servicios de asesoría tributaria y contable para empresas medianas y grandes",description:"Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, rhoncus id, erat. Fusce rhoncus, massa sed semper.",icon:"regular user"},{value:"3",title:"Comercialización y distribución de equipos tecnológicos para operaciones críticas",description:"Aenean ut eros et nisl sagittis vestibulum. Nullam nulla eros, ultricies sit amet, nonummy ac, gravida a, est. Proin eget sem. Sed viverra viverra nisl. Curabitur suscipit suscipit tellus.",icon:"regular bolt"},{value:"4",title:"Gestión logística integral para abastecimiento, almacenamiento y última milla",description:"Phasellus lacinia, magna a ullamcorper laoreet, lectus arcu pulvinar risus, vitae facilisis libero dolor a purus. Sed dignissim, metus nec consectetuer malesuada, ipsum augue molestie justo, sed accumsan nisi nunc sit amet erat.",icon:"regular user"}]}},template:`
      <g-config-provider>
        <div class="flex flex-col gap-6">
          <div>
...
- Útil para categorías, regiones, tipos, etc.\`
  ...
  parameters: {
    docs: {
      description: {
        story: 'Las props title-lines y description-lines permiten controlar cuántas líneas se muestran en el título y la descripción de cada opción del dropdown.' + '\\n\\n' + '**Casos de uso:**\\n\\n' + '- **0 (sin límite):** muestra todo el contenido disponible.\\n' + '- **1 línea:** prioriza densidad visual y truncado rápido con ellipsis.\\n' + '- **2 líneas:** da más contexto sin dejar que cada opción crezca demasiado.\\n\\n' + '**Consideraciones:**\\n\\n' + '- Estas props afectan el contenido del dropdown, no el valor ya seleccionado en el input.\\n' + '- Esta story compara el comportamiento con títulos y descripciones largas para visualizar mejor la diferencia entre 0, 1 y 2 líneas.\\n' + '- Si el contenido ocupa más altura, recuerda ajustar item-height para evitar cortes visuales durante la virtualización.'
      }
    }
  },
  render: () => ({
...
}`,...S.parameters?.docs?.source}}};const pe=["Basic","withAllProps","remoteSearch","selectorCountries","clearable","states","multiple","multipleEmptyDisplay","multipleCollapseTags","grouped","groupedMultiple","optionLinesLimit"];export{p as Basic,pe as __namedExportsOrder,g as clearable,ce as default,h as grouped,x as groupedMultiple,y as multiple,f as multipleCollapseTags,b as multipleEmptyDisplay,S as optionLinesLimit,u as remoteSearch,m as selectorCountries,v as states,d as withAllProps};
