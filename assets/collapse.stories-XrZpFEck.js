import{r as v,w as Ge,c as r,B as $e,d as ee,a as O,b as f,e as V,q as L,m as G,ab as Ne,u as n,T as Se,s as je,t as C,j as D,f as Re,l as ne,k as g,F as Y,y as Z,$ as oe,a0 as He,a1 as we,N as Q,x as se,h as qe,v as ze,C as de}from"./vue.esm-bundler-C6DRpX4R.js";import{C as me,U as pe}from"./event.constant-LtAI3-H4.js";import{a as ue,h as Fe,b as ge,d as I,e as te,m as ie,i as Oe}from"./props.util-DQIcYPkU.js";import{c as fe}from"./useEmptyValues-8bO_IQ4-.js";import{m as le}from"./useAttrs-Dmae7bQW.js";import{u as K}from"./useNamespace-D200ZTkz.js";import{t as Ve}from"./error.util-CtUs3PUB.js";import{w as ve,a as Be}from"./install.util-cBz1HN_T.js";import{R as B}from"./index-DEGGxn4j.js";import{a as Ke}from"./useId-BGX2ZA7H.js";import{G as _e}from"./index-iu8P1TTk.js";import{G as be,a as ye}from"./index-DqZLG4Y7.js";import{G as he}from"./index-BYG7qvIZ.js";import{G as Me}from"./index-CZcmyKtl.js";import{G as Ue}from"./index-B6Y6j_tm.js";import{G as P}from"./ConfigProvider-CHVLgL_2.js";import{a as Je,b as re}from"./documentation-stories-0qKiiCdD.js";import"./index-BnOtqFZS.js";import"./index-OmpdNH0g.js";import"./index-CRx4dHSJ.js";import"./index-B8Dg1tZU.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-fKX7T4ju.js";const ce=a=>fe(a)||ue(a)||Fe(a),We=ge({accordion:Boolean,modelValue:{type:I([Array,String,Number]),default:()=>le([])},expandIconPosition:{type:I([String]),default:"right"},beforeCollapse:{type:I(Function)},items:{type:I(Array),default:()=>le([])}}),Qe={[pe]:ce,[me]:ce,"header-click":a=>ue(a)||fe(a)},xe=Symbol.for("collapseContextKey"),Xe="GCollapse",Ye=(a,s)=>{const o=v(te(a.modelValue)),t=i=>{o.value=i;const c=a.accordion?o.value[0]:o.value;s(pe,c),s(me,c)},e=i=>{if(a.accordion)t([o.value[0]===i?"":i]);else{const c=[...o.value],d=c.indexOf(i);d>-1?c.splice(d,1):c.push(i),t(c)}},l=async i=>{const{beforeCollapse:c}=a;if(!c){e(i);return}const d=c(i);[ie(d),Oe(d)].includes(!0)||Ve(Xe,"beforeCollapse must return type `Promise<boolean>` or `boolean`"),ie(d)?d.then(u=>{u!==!1&&e(i)}).catch(u=>{}):d&&e(i)},p=i=>{s("header-click",i)};return Ge(()=>a.modelValue,()=>o.value=te(a.modelValue),{deep:!0}),$e(xe,{activeNames:o,handleItemClick:l,handleHeaderOnlyClick:p}),{activeNames:o,setActiveNames:t}},Ze=a=>{const s=K("collapse");return{rootKls:r(()=>[s.b()]),expandIconPosition:r(()=>a.expandIconPosition)}},ea=ee({name:"GCollapseTransition",__name:"collapse-transition",setup(a){const s=K("collapse-transition"),o=e=>{e.style.maxHeight="",e.style.overflow=e.dataset.oldOverflow,e.style.paddingTop=e.dataset.oldPaddingTop,e.style.paddingBottom=e.dataset.oldPaddingBottom},t={beforeEnter(e){e.dataset||(e.dataset={}),e.dataset.oldPaddingTop=e.style.paddingTop,e.dataset.oldPaddingBottom=e.style.paddingBottom,e.style.height&&(e.dataset.elExistsHeight=e.style.height),e.style.maxHeight=0,e.style.paddingTop=0,e.style.paddingBottom=0},enter(e){requestAnimationFrame(()=>{e.dataset.oldOverflow=e.style.overflow,e.dataset.elExistsHeight?e.style.maxHeight=e.dataset.elExistsHeight:e.scrollHeight!==0?e.style.maxHeight=`${e.scrollHeight}px`:e.style.maxHeight=0,e.style.paddingTop=e.dataset.oldPaddingTop,e.style.paddingBottom=e.dataset.oldPaddingBottom,e.style.overflow="hidden"})},afterEnter(e){e.style.maxHeight="",e.style.overflow=e.dataset.oldOverflow},enterCancelled(e){o(e)},beforeLeave(e){e.dataset||(e.dataset={}),e.dataset.oldPaddingTop=e.style.paddingTop,e.dataset.oldPaddingBottom=e.style.paddingBottom,e.dataset.oldOverflow=e.style.overflow,e.style.maxHeight=`${e.scrollHeight}px`,e.style.overflow="hidden"},leave(e){e.scrollHeight!==0&&(e.style.maxHeight=0,e.style.paddingTop=0,e.style.paddingBottom=0)},afterLeave(e){o(e)},leaveCancelled(e){o(e)}};return(e,l)=>(f(),O(Se,G({name:n(s).b()},Ne(t)),{default:V(()=>[L(e.$slots,"default")]),_:3},16,["name"]))}}),aa=ve(ea),na=ge({title:{type:String,default:""},name:{type:I([String,Number]),default:void 0},disabled:Boolean,iconsRight:{type:I(Array),default:()=>[]},iconsLeft:{type:I(Array),default:()=>[]},description:{type:String,default:""},content:{type:I([String,Function]),default:""},expandIconPosition:{type:I(String),default:"right"},headerOnly:{type:Boolean,default:!1},hideIcon:{type:Boolean,default:!1}}),oa=a=>{const s=je(xe),{namespace:o}=K("collapse"),t=v(!1),e=v(!1),l=Ke(),p=r(()=>l.current++),i=r(()=>a.name??`${o.value}-id-${l.prefix}-${n(p)}`),c=r(()=>s?.activeNames.value.includes(n(i))),d=r(()=>[...a.expandIconPosition==="left"&&!a.hideIcon?[{icon:"regular angle-right",onClick:()=>{s?.handleItemClick(n(i))}}]:[],...a.iconsLeft||[]]),y=r(()=>[...a.expandIconPosition==="right"&&!a.hideIcon?[{icon:"regular angle-right",onClick:()=>{s?.handleItemClick(n(i))}}]:[],...a.iconsRight||[]].slice().reverse()),u=r(()=>typeof a.content=="string"?a.content:a.content?.()||""),h=r(()=>({isActive:c.value,name:i.value,title:a.title,description:a.description,disabled:a.disabled,headerOnly:a.headerOnly,expandIconPosition:a.expandIconPosition,hideIcon:a.hideIcon,iconsLeft:d.value,iconsRight:y.value,focusing:t.value}));return{focusing:t,id:p,isActive:c,handleFocus:()=>{setTimeout(()=>{e.value?e.value=!1:t.value=!0},50)},handleHeaderClick:()=>{a.disabled||(a.headerOnly?s?.handleHeaderOnlyClick?.(n(i)):s?.handleItemClick(n(i)),t.value=!1,e.value=!0)},handleEnterClick:()=>{a.headerOnly?s?.handleHeaderOnlyClick?.(n(i)):s?.handleItemClick(n(i))},iconsLeft:d,iconsRight:y,content:u,name:i,slotProps:h}},sa=(a,{focusing:s,isActive:o,id:t})=>{const e=K("collapse"),l=r(()=>[e.b("item"),e.is("active",n(o)),e.is("disabled",a.disabled)]),p=r(()=>[e.be("item","header"),e.is("active",n(o)),{focusing:n(s)&&!a.disabled}]),i=r(()=>[e.bem("item","header","icon-left")]),c=r(()=>[e.bem("item","header","icon-right")]),d=r(()=>[e.bem("item","header","content")]),y=r(()=>[e.be("item","arrow"),e.is("active",n(o))]),u=r(()=>[e.be("item","title")]),h=r(()=>[e.be("item","description")]),x=r(()=>[e.bem("item","header","text")]),A=r(()=>e.be("item","wrap")),$=r(()=>e.be("item","content")),M=r(()=>e.b(`content-${n(t)}`)),U=r(()=>e.b(`head-${n(t)}`));return{itemTitleKls:u,arrowKls:y,headKls:p,rootKls:l,itemWrapperKls:A,itemContentKls:$,scopedContentId:M,scopedHeadId:U,itemDescriptionKls:h,iconsLeftKls:i,iconsRightKls:c,contentHeaderKls:d,contentHeaderTextKls:x}},ta=["id","aria-expanded","aria-controls","aria-describedby","tabindex"],ia=["id","aria-hidden","aria-labelledby"],la=["innerHTML"],_=ee({name:"GCollapseItem",__name:"collapse-item",props:na,setup(a,{expose:s}){const o=a,{focusing:t,id:e,isActive:l,handleFocus:p,handleHeaderClick:i,handleEnterClick:c,content:d,iconsLeft:y,iconsRight:u,name:h,slotProps:x}=oa(o),{arrowKls:A,headKls:$,rootKls:M,itemTitleKls:U,itemWrapperKls:Ie,itemContentKls:Pe,scopedContentId:J,scopedHeadId:ae,contentHeaderKls:ke,iconsLeftKls:Ee,iconsRightKls:Te,contentHeaderTextKls:De,itemDescriptionKls:Le}=sa(o,{focusing:t,isActive:l,id:e});return s({isActive:l}),(T,k)=>(f(),C("div",{class:g(n(M))},[D("button",{id:n(ae),class:g(n($)),"aria-expanded":n(l),"aria-controls":n(J),"aria-describedby":n(J),tabindex:T.disabled?-1:0,type:"button",onClick:k[0]||(k[0]=(...m)=>n(i)&&n(i)(...m)),onKeydown:k[1]||(k[1]=we(Q((...m)=>n(c)&&n(c)(...m),["stop","prevent"]),["space","enter"])),onFocus:k[2]||(k[2]=(...m)=>n(p)&&n(p)(...m)),onBlur:k[3]||(k[3]=m=>t.value=!1)},[D("div",{class:g(n(ke))},[n(y).length>0?(f(),C("div",{key:0,class:g(n(Ee))},[(f(!0),C(Y,null,Z(n(y),(m,W)=>(f(),O(n(B),{key:W,name:m.icon,class:g(m.icon==="regular angle-right"?n(A):""),onClick:Q(Ae=>!T.disabled&&m?.onClick&&m?.onClick(n(h),m.icon,n(l)),["stop"]),spin:m.spin},null,8,["name","class","onClick","spin"]))),128))],2)):ne("",!0),D("div",{class:g(n(De))},[L(T.$slots,"header",oe(He(n(x))),()=>[D("h5",{class:g(n(U))},se(T.title),3),D("span",{class:g(n(Le))},se(T.description),3)])],2)],2),n(u).length>0?(f(),C("div",{key:0,class:g(n(Te))},[(f(!0),C(Y,null,Z(n(u),(m,W)=>(f(),O(n(B),{key:W,name:m.icon,class:g(m.icon==="regular angle-right"?n(A):""),onClick:Q(Ae=>!T.disabled&&m?.onClick&&m.onClick(n(h),m.icon,n(l)),["stop"]),spin:m.spin},null,8,["name","class","onClick","spin"]))),128))],2)):ne("",!0)],42,ta),Re(n(aa),null,{default:V(()=>[qe(D("div",{id:n(J),role:"region",class:g(n(Ie)),"aria-hidden":!n(l),"aria-labelledby":n(ae)},[D("div",{class:g(n(Pe))},[n(d)?(f(),C("div",{key:0,innerHTML:n(d)},null,8,la)):L(T.$slots,"default",oe(G({key:1},n(x))))],2)],10,ia),[[ze,n(l)]])]),_:3})],2))}});_.__docgenInfo={name:"GCollapseItem",exportName:"default",displayName:"collapse-item",description:"",tags:{},expose:[{name:"isActive",tags:[{title:"description",content:"current collapse-item whether active"}]}],slots:[{name:"header",scoped:!0,bindings:[]},{name:"default",scoped:!0,bindings:[]}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/collapse/src/collapse-item.vue"]};const Ce=ee({name:"GCollapse",__name:"collapse",props:We,emits:Qe,setup(a,{expose:s,emit:o}){const t=a,e=o,{activeNames:l,setActiveNames:p}=Ye(t,e),{rootKls:i,expandIconPosition:c}=Ze(t);return s({activeNames:l,setActiveNames:p}),(d,y)=>(f(),C("div",{class:g(n(i))},[t.items.length>0?(f(),C("div",{key:0,class:g(n(i))},[(f(!0),C(Y,null,Z(t.items,(u,h)=>(f(),O(_,G({key:u.name||h},{ref_for:!0},u,{name:u.name||h,"expand-icon-position":n(c)}),{default:V(x=>[L(d.$slots,"default",G({ref_for:!0},x,{item:u}))]),header:V(x=>[L(d.$slots,"header",G({ref_for:!0},x,{item:u}))]),_:2},1040,["name","expand-icon-position"]))),128))],2)):L(d.$slots,"dynamic",{key:1})],2))}});Ce.__docgenInfo={name:"GCollapse",exportName:"default",displayName:"collapse",description:"",tags:{},expose:[{name:"activeNames",tags:[{title:"description",content:"active names"}]},{name:"setActiveNames",tags:[{title:"description",content:"set active names"}]}],slots:[{name:"default",scoped:!0,bindings:[{name:"item",title:"binding"}]},{name:"header",scoped:!0,bindings:[{name:"item",title:"binding"}]},{name:"dynamic"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/collapse/src/collapse.vue"]};const b=ve(Ce,{CollapseItem:_}),E=Be(_),ra="0.5.13",X={vue:"^3.2.0"},Na={title:"Data/Collapse",component:b,parameters:{docs:{description:{component:`\`GCollapse\` - Componente de colapso para mostrar u ocultar contenido de manera dinámica.
...
Props disponibles:
{
  ...
  focusing: boolean;
    ...
    `})},q={name:"Collapse item con formularios",parameters:{docs:{description:{story:"Ejemplo de uso de GCollapseItem con un formulario."}}},render:()=>({components:{GConfigProvider:P,GCollapse:b,GCollapseItem:E,GForm:ye,GFormItem:be,GInput:he},setup(){const a=v(1),s=de({name:"Pepito",lastName:"Perez",phone:"999888777",email:"pepito@ejemplo.com",city:"Lima",address:""});return{activeNames:a,formData:s}},template:`
      <g-config-provider>
    ...
    `})},F={name:"Slot default con props",parameters:{docs:{description:{story:"Ejemplo que demuestra las props disponibles en el slot default de GCollapseItem: isActive, name, title, description, disabled, headerOnly, expandIconPosition, hideIcon, iconsLeft, iconsRight, focusing."}}},render:()=>({components:{GConfigProvider:P,GCollapse:b,GCollapseItem:E,GIconFont:B},setup(){return{activeNames:v(["1"])}},template:`
      <g-config-provider>
...
}`,...F.parameters?.docs?.source}}};const Sa=["Basic","accordionExample","CustomIcons","positionIcon","preventCollpsing","slotDefault","simpleDifferentContent","headerOnlyExample","slotDefaultWithProps"];export{N as Basic,j as CustomIcons,Sa as __namedExportsOrder,S as accordionExample,Na as default,z as headerOnlyExample,R as positionIcon,H as preventCollpsing,q as simpleDifferentContent,w as slotDefault,F as slotDefaultWithProps};
