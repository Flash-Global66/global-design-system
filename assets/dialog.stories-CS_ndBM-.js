import{o as ue,B as De,C as xe,g as Ve,r as c,c as A,w as ie,D as ke,d as pe,a as ne,x as M,e as D,m as O,k as _,l as h,u as a,s as I,h as ae,y as re,F as Ae,z as Be,b as te,f as z,A as Ee,n as me,T as we,j as ze,p as Se,q as Te,v as Me,E as Ie}from"./vue.esm-bundler-C43JrhH2.js";import{a as Fe,O as Ge,G as Pe}from"./index-DXzFbLVr.js";import{u as Le,G as je,a as Oe}from"./index-DMmjmuhB.js";import{b as fe,d as de}from"./install-CfJGiCvs.js";import{m as Ne,i as $e,u as qe}from"./index-IKXR5Yi8.js";import{U as be}from"./event-HEVJa2N9.js";import{u as We,f as Re,G as F}from"./ConfigProvider-Bm0JlQoM.js";import{u as ce}from"./index-3IKRmSQk.js";import{b as le}from"./style-CdZiB5si.js";import{i as Ue}from"./index-D_KVKhvv.js";import{u as ge}from"./index-DmfABaPz.js";import{x as Xe}from"./index-9_Ea-5iB.js";import{m as Ye}from"./index-CinV_OuW.js";import{c as Ke}from"./refs-BXlkjTcd.js";import{G}from"./index-BhV2snQH.js";import"./aria-BUADUvnR.js";import"./error-Cq9Fpw4b.js";import"./vnode-Bc34_Ya7.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-fhkPmQjX.js";import"./_arrayPush-Bf091UU2.js";const He=(e,o,i,l)=>{const g={offsetX:0,offsetY:0},r=(p,d)=>{if(e.value){const{offsetX:v,offsetY:C}=g,m=e.value.getBoundingClientRect(),f=m.left,b=m.top,E=m.width,s=m.height,w=document.documentElement.clientWidth,k=document.documentElement.clientHeight,L=-f+v,Z=-b+C,J=w-f-E+v,N=k-b-(s<k?s:0)+C;l?.value||(p=Math.min(Math.max(p,L),J),d=Math.min(Math.max(d,Z),N)),g.offsetX=p,g.offsetY=d,e.value.style.transform=`translate(${le(p)}, ${le(d)})`}},x=p=>{const d=p.clientX,v=p.clientY,{offsetX:C,offsetY:m}=g,f=E=>{const s=C+E.clientX-d,w=m+E.clientY-v;r(s,w)},b=()=>{document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",b)};document.addEventListener("mousemove",f),document.addEventListener("mouseup",b)},V=()=>{o.value&&e.value&&(o.value.addEventListener("mousedown",x),window.addEventListener("resize",u))},n=()=>{o.value&&e.value&&(o.value.removeEventListener("mousedown",x),window.removeEventListener("resize",u))},P=()=>{g.offsetX=0,g.offsetY=0,e.value&&(e.value.style.transform="")},u=()=>{const{offsetX:p,offsetY:d}=g;r(p,d)};return ue(()=>{De(()=>{i.value?V():n()})}),xe(()=>{n()}),{resetPosition:P,updatePosition:u}},ve=Symbol("dialogInjectionKey"),Ce=fe({fullscreen:Boolean,draggable:Boolean,overflow:{type:Boolean,default:!0},alignCenter:{type:Boolean,default:!1},sizeMode:{type:String,values:["default","fixed","adaptive"],default:"default"},title:{type:String,default:""},headerClass:String,bodyClass:String,footerClass:String,showClose:{type:Boolean,default:!0},width:{type:[String,Number]},ariaLevel:{type:String,default:"2"},footerButtons:{type:Array,default:()=>[]}}),Ze=e=>{const{sizeMode:o,width:i}=e;o==="fixed"&&(!i||i==="")&&console.warn('[g-dialog] When sizeMode is set to "fixed", width must be defined.')},Je={close:()=>!0},Qe=fe({...Ce,appendToBody:{type:Boolean,default:!1},appendTo:{type:de([String,Object]),default:"body"},beforeClose:{type:de(Function)},destroyOnClose:{type:Boolean,default:!1},closeOnClickModal:{type:Boolean,default:!0},closeOnPressEscape:{type:Boolean,default:!0},lockScroll:{type:Boolean,default:!0},modal:{type:Boolean,default:!0},openDelay:{type:Number,default:0},closeDelay:{type:Number,default:0},top:{type:String},modelValue:Boolean,modalClass:String,headerClass:String,bodyClass:String,footerClass:String,width:{type:[String,Number]},zIndex:{type:Number},trapFocus:{type:Boolean,default:!0},ariaLevel:{type:String,default:"2"}}),_e={open:()=>!0,opened:()=>!0,close:()=>!0,closed:()=>!0,[be]:e=>Ne(e),openAutoFocus:()=>!0,closeAutoFocus:()=>!0},eo=(e,o,{closeOnClickModal:i,closeOnPressEscape:l})=>{const r=Ve().emit,{nextZIndex:x}=We();let V="";const n=ce(),P=ce(),u=c(!1),p=c(!1),d=c(!1),v=c(e.zIndex??x()),C=A(()=>e.footerButtons?.slice(0,3)||[]),m=A(()=>C.value.length===3?"layout-dual-row":"layout-single-column");let f,b;const s=Re("namespace","gui"),w=A(()=>{const y={},se=`--${s.value}-dialog`;return e.fullscreen||(e.top&&(y[`${se}-margin-top`]=e.top),e.width&&(y[`${se}-width`]=le(e.width))),y}),k=A(()=>e.alignCenter?{display:"flex"}:{});function L(){r("opened")}function Z(){r("closed"),r(be,!1),e.destroyOnClose&&(d.value=!1)}function J(){r("close")}function N(){b?.(),f?.(),e.openDelay&&e.openDelay>0?{stop:f}=ge(()=>oe(),e.openDelay):oe()}function ee(){f?.(),b?.(),e.closeDelay&&e.closeDelay>0?{stop:b}=ge(()=>$(),e.closeDelay):$()}const Q=()=>{e.showClose&&(e.beforeClose?e.beforeClose($):$())};function S(){i.value&&Q()}function oe(){$e&&(u.value=!0)}function $(){u.value=!1}function t(){r("openAutoFocus")}function T(){r("closeAutoFocus")}function j(y){y.detail?.focusReason==="pointer"&&y.preventDefault()}e.lockScroll&&Le(u);function he(){l.value&&Q()}return ie(()=>e.modelValue,y=>{y?(p.value=!1,N(),d.value=!0,v.value=Ue(e.zIndex)?x():v.value++,ke(()=>{r("open"),o.value&&(o.value.parentElement.scrollTop=0,o.value.parentElement.scrollLeft=0,o.value.scrollTop=0)})):u.value&&ee()}),ie(()=>e.fullscreen,y=>{o.value&&(y?(V=o.value.style.transform,o.value.style.transform=""):o.value.style.transform=V)}),ue(()=>{e.modelValue&&(u.value=!0,d.value=!0,N())}),{afterEnter:L,afterLeave:Z,beforeLeave:J,handleClose:Q,onModalClick:S,close:ee,doClose:$,onOpenAutoFocus:t,onCloseAutoFocus:T,onCloseRequested:he,onFocusoutPrevented:j,titleId:n,bodyId:P,closed:p,style:w,overlayDialogStyle:k,rendered:d,visible:u,zIndex:v,displayButtons:C,buttonLayoutClass:m}},oo={key:0,class:"header-content"},ao=["id"],to=["aria-level"],ye=pe({__name:"dialog-content",props:Ce,emits:Je,setup(e,{expose:o,emit:i}){const l=e,g=i;Ze(l);const{dialogRef:r,headerRef:x,bodyId:V,ns:n,style:P,displayButtons:u,buttonLayoutClass:p}=ne(ve),{focusTrapRef:d}=ne(Fe,{focusTrapRef:r,onKeydown:()=>{}}),v=A(()=>{const s=l.fullscreen?"fullscreen":l.sizeMode||"default";return[n.b(),n.is("draggable",l.draggable),n.is("align-center",l.alignCenter),n.is(s)]}),C=Ke(d,r),m=A(()=>l.draggable&&!l.fullscreen),f=A(()=>l.overflow),{resetPosition:b}=He(r,r,m,f);o({resetPosition:b});const E=()=>{g("close")};return(s,w)=>(D(),M("div",{ref:a(C),class:h(v.value),style:me(a(P)),tabindex:"-1"},[s.showClose||s.$slots.header?(D(),M("header",{key:0,ref_key:"headerRef",ref:x,class:h([a(n).e("header"),s.headerClass])},[s.$slots.header?(D(),M("div",oo,[I(s.$slots,"header")])):O("",!0),s.showClose?(D(),M("button",{key:1,"aria-label":"Close",class:h(a(n).e("headerbtn")),type:"button",onClick:E},[ae(a(Xe),{name:"regular times",class:h(a(n).e("close"))},null,8,["class"])],2)):O("",!0)],2)):O("",!0),_("div",{id:a(V),class:h([a(n).e("body"),s.bodyClass])},[_("div",null,[s.$slots.image?(D(),M("div",{key:0,class:h(a(n).e("image"))},[I(s.$slots,"image")],2)):O("",!0),s.title?(D(),M("span",{key:1,class:h(a(n).e("title")),role:"heading","aria-level":s.ariaLevel},re(s.title),11,to)):O("",!0),_("div",{class:h(a(n).e("content"))},[I(s.$slots,"default")],2)])],10,ao),_("footer",{class:h([a(n).e("footer"),s.footerClass])},[I(s.$slots,"footer",{},()=>[l.footerButtons?.length?(D(),M("div",{key:0,class:h([a(n).e("footer-buttons"),a(p)])},[(D(!0),M(Ae,null,Be(a(u),(k,L)=>(D(),te(a(Ye),{key:L,variant:k.variant,full:"",onClick:k.onClick},{default:z(()=>[Ee(re(k.text),1)]),_:2},1032,["variant","onClick"]))),128))],2)):O("",!0)])],2)],6))}});ye.__docgenInfo={exportName:"default",displayName:"dialog-content",description:"",tags:{},expose:[{name:"resetPosition"}],slots:[{name:"header"},{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog-content.vue"]};const lo=["aria-label","aria-labelledby","aria-describedby"],B=pe({__name:"dialog",props:Qe,emits:_e,setup(e,{expose:o,emit:i}){const l=e,g=qe("dialog"),r=c(),x=c(),V=c(),n=A(()=>l.showClose&&l.closeOnClickModal),P=A(()=>l.showClose&&l.closeOnPressEscape),{visible:u,titleId:p,bodyId:d,style:v,overlayDialogStyle:C,rendered:m,zIndex:f,afterEnter:b,afterLeave:E,beforeLeave:s,handleClose:w,onModalClick:k,onOpenAutoFocus:L,onCloseAutoFocus:Z,onCloseRequested:J,onFocusoutPrevented:N,displayButtons:ee,buttonLayoutClass:Q}=eo(l,r,{closeOnClickModal:n,closeOnPressEscape:P});Ie(ve,{dialogRef:r,headerRef:x,bodyId:d,ns:g,rendered:m,style:v,displayButtons:ee,buttonLayoutClass:Q});const S=Oe(k),oe=A(()=>l.draggable&&!l.fullscreen);return o({visible:u,dialogContentRef:V,resetPosition:()=>{V.value?.resetPosition()}}),(t,T)=>(D(),te(a(Pe),{to:t.appendTo,disabled:t.appendTo!=="body"?!1:!t.appendToBody},{default:z(()=>[ae(we,{name:"dialog-fade",onAfterEnter:a(b),onAfterLeave:a(E),onBeforeLeave:a(s)},{default:z(()=>[ze(ae(a(je),{"custom-mask-event":"",mask:t.modal,"overlay-class":t.modalClass,"z-index":a(f)},{default:z(()=>[_("div",{role:"dialog","aria-modal":"true","aria-label":t.title||void 0,"aria-labelledby":t.title?void 0:a(p),"aria-describedby":a(d),class:h(`${a(g).namespace.value}-overlay-dialog`),style:me(a(C)),onClick:T[0]||(T[0]=(...j)=>a(S).onClick&&a(S).onClick(...j)),onMousedown:T[1]||(T[1]=(...j)=>a(S).onMousedown&&a(S).onMousedown(...j)),onMouseup:T[2]||(T[2]=(...j)=>a(S).onMouseup&&a(S).onMouseup(...j))},[ae(a(Ge),{loop:"",trapped:a(u),"focus-start-el":"container",onFocusAfterTrapped:a(L),onFocusAfterReleased:a(Z),onFocusoutPrevented:a(N),onReleaseRequested:a(J)},{default:z(()=>[a(m)?(D(),te(ye,Se({key:0,ref_key:"dialogContentRef",ref:V},t.$attrs,{"align-center":t.alignCenter,draggable:oe.value,overflow:t.overflow,fullscreen:t.fullscreen,"header-class":t.headerClass,"body-class":t.bodyClass,"footer-class":t.footerClass,"show-close":t.showClose,title:t.title,"aria-level":t.ariaLevel,width:t.width,"size-mode":t.sizeMode,"footer-buttons":t.footerButtons,onClose:a(w)}),Te({default:z(()=>[I(t.$slots,"default")]),_:2},[t.$slots.header?{name:"header",fn:z(()=>[I(t.$slots,"header")]),key:"0"}:void 0,t.$slots.image?{name:"image",fn:z(()=>[I(t.$slots,"image")]),key:"1"}:void 0,t.$slots.footer?{name:"footer",fn:z(()=>[I(t.$slots,"footer")]),key:"2"}:void 0]),1040,["align-center","draggable","overflow","fullscreen","header-class","body-class","footer-class","show-close","title","aria-level","width","size-mode","footer-buttons","onClose"])):O("",!0)]),_:3},8,["trapped","onFocusAfterTrapped","onFocusAfterReleased","onFocusoutPrevented","onReleaseRequested"])],46,lo)]),_:3},8,["mask","overlay-class","z-index"]),[[Me,a(u)]])]),_:3},8,["onAfterEnter","onAfterLeave","onBeforeLeave"])]),_:3},8,["to","disabled"]))}});B.__docgenInfo={exportName:"default",displayName:"dialog",description:"",tags:{},expose:[{name:"visible",tags:[{title:"description",content:"whether the dialog is visible"}]},{name:"dialogContentRef"},{name:"resetPosition"}],slots:[{name:"header"},{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog.vue"]};const so="1.1.4",Po={title:"Data/Dialog",component:B,argTypes:{modelValue:{control:"boolean",description:"Controla la visibilidad del dialog",table:{defaultValue:{summary:"false"}}},title:{control:"text",description:"Título del dialog",table:{defaultValue:{summary:""}}},width:{control:"text",description:"Ancho del dialog. Requiere size-mode='fixed'.",table:{defaultValue:{summary:"undefined"}}},sizeMode:{control:"select",options:["default","fixed","adaptive"],description:`Controla el comportamiento del ancho del dialog:
...
<\/script>`,language:"html",type:"auto"}}};const no=e=>({components:{GDialog:B,GConfigProvider:F,GButton:G},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`}}};const ro=e=>({components:{GDialog:B,GConfigProvider:F,GButton:G},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const co=e=>({components:{GDialog:B,GConfigProvider:F,GButton:G},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const go=e=>({components:{GDialog:B,GConfigProvider:F,GButton:G},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const uo=e=>({components:{GDialog:B,GConfigProvider:F,GButton:G},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const po=e=>({components:{GDialog:B,GConfigProvider:F,GButton:G},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
    <g-config-provider>
...
<\/script>`,language:"html",type:"auto"}}};const mo=e=>({components:{GDialog:B,GConfigProvider:F,GButton:G},setup(){const o=c(!1),i=c(!1),l=c(!1);return{args:e,defaultDialogVisible:o,fixedDialogVisible:i,adaptiveDialogVisible:l,closeDefaultDialog:()=>{o.value=!1},closeFixedDialog:()=>{i.value=!1},closeAdaptiveDialog:()=>{l.value=!1}}},template:`
    <g-config-provider>
...
>
  ...
  \`
})`,...H.parameters?.docs?.source}}};const Lo=["Basic","WithImage","NoCloseButton","CustomWidth","WithLargeImage","TwoButtonsStacked","ThreeButtonsLayout","SizeModeComparison"];export{q as Basic,U as CustomWidth,R as NoCloseButton,H as SizeModeComparison,K as ThreeButtonsLayout,Y as TwoButtonsStacked,W as WithImage,X as WithLargeImage,Lo as __namedExportsOrder,Po as default};
