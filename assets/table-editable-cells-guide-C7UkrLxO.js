import{u as s,j as e,M as i}from"./blocks-D_LOSK-J.js";import"./preload-helper-Dch09mLN.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-Dct5CHxr.js";function c(l){const n={br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...l.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Componentes/Tablas/Celdas editables en Table"}),`
...
`]}),`
`,e.jsxs(n.p,{children:["Para ver ejemplos en vivo, en Storybook consulta las historias de ",e.jsx(n.strong,{children:"Table"})," relacionadas con celdas editables (input, select, GCellEdit, eventos y expansión)."]})]})}function t(l={}){const{wrapper:n}={...s(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(c,{...l})}):c(l)}export{t as default};
