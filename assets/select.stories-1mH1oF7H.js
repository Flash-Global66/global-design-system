import{r as a,b as f}from"./vue.esm-bundler-ENg2wqJc.js";import{G as r}from"./index-BEix_42p.js";import{G as n}from"./ConfigProvider-C0wXp6tN.js";import{generateIconOptions as h}from"./icon-font.stories-u5VhJLLZ.js";import"./index-C1wWa6aY.js";import"./Icon-FXFhsub2.js";import"./index.es-B5q-6M42.js";import"./index-DDVpgGx_.js";import"./index-DPhcbnwv.js";import"./error-Cq9Fpw4b.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./event-BB_Ol6Sd.js";import"./index-vXs6_7_J.js";import"./index-B9rbiiWl.js";import"./index-DmEqgNbd.js";import"./plugin-vue_export-helper-CqGSI99y.js";import"./index-CTdwgwru.js";import"./index-Dl3p_Mv0.js";import"./index-BCRuVW3W.js";import"./constants-Dnj8X3EN.js";import"./raf-BqBYAqpb.js";import"./index-DnTzjMUA.js";import"./debounce-COZYpILh.js";import"./_initCloneObject-CdrlhK9a.js";import"./isEqual-DzP_ncWK.js";import"./typescript-Bp3YSIOJ.js";import"./util-B2mB0_6C.js";import"./index-BvcaQ_JV.js";import"./index-7iQn0g8-.js";import"./castArray-BELTYCwk.js";import"./index-Dqz3uMBK.js";import"./icon-BYzgUmV9.js";import"./index-DMnPzEbW.js";import"./index-BqY1QUfJ.js";import"./index-GIS5GJip.js";import"./use-form-common-props-BOb29c3_.js";import"./index-BirDoDwW.js";import"./use-form-common-props-DRD3TCcZ.js";import"./index-BXey_ta_.js";import"./Button-BVCxNWl8.js";const re={title:"Form/Select",component:r,parameters:{docs:{description:{component:`✨ \`GSelect\` - Componente de selección interactivo y personalizable
...
- Largo de opciones personalizado`}}},render:()=>({components:{GSelect:r,GConfigProvider:n},setup(){const o=["a","b","c","d","e","f","g","h","i","j"],e=a(),s=a(),l=Array.from({length:1e3}).map((b,t)=>({value:`Option ${t+1}`,title:`${o[t%10]}${t} - option ${t+1}`,description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris in enim elementum, sagittis velit eu, feugiat sem. Sed lacinia tincidunt lacinia.",icon:t%2===0?"regular bolt":"regular user",disabled:t%3===0&&t!==0}));return{value:e,options:l,value2:s}},template:`
      <g-config-provider>
...
- Búsqueda de opciones
- Mapeo de propiedades`}}},render:()=>({components:{GSelect:r,GConfigProvider:n},setup(){const o=a(),e=a(!1),s=a([]),l={title:"title",description:"body",value:"id"},b=async c=>{try{return e.value=!0,await(await fetch(`https://jsonplaceholder.typicode.com/posts?q=${c}`)).json()}catch(v){return console.error("Error fetching data:",v),[]}finally{e.value=!1}};return{value:o,options:s,handleSearch:async c=>{s.value=await b(c)},loading:e,mappingProps:l}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
...
- Uso de slots como prefix, default y selectedLabel`}}},render:()=>({components:{GSelect:r,GConfigProvider:n},setup(){const o=a(),e=a(!1),s=a([]),l=async()=>{try{return e.value=!0,(await(await fetch("https://restcountries.com/v3.1/all")).json()).map(i=>({value:{id:i.cca2,image:i.flags.svg,countryName:i.name.common},title:i.name.common,country:`${i.name.common} ${i.idd.root??""}`}))}catch(t){return console.error("Error fetching data:",t),[]}finally{e.value=!1}};return{value:o,countries:s,onFocusSelect:async()=>{s.value=await l()},loadingCountries:e}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
...
- Permite borrar la selección actual`}}},render:()=>({components:{GSelect:r,GConfigProvider:n},setup(){return{value:a(),options:[{value:"1",title:"Opción 1"},{value:"2",title:"Opción 2"},{value:"3",title:"Opción 3"},{value:"4",title:"Opción 4"},{value:"5",title:"Opción 5"},{value:"6",title:"Opción 6"},{value:"7",title:"Opción 7"}]}},template:`
      <g-config-provider>
        <g-select
          v-model="value"
...
}`,...y.parameters?.docs?.source}}};const le=["Basic","withAllProps","remoteSearch","selectorCountries","clearable","states"];export{p as Basic,le as __namedExportsOrder,g as clearable,re as default,m as remoteSearch,u as selectorCountries,y as states,d as withAllProps};
