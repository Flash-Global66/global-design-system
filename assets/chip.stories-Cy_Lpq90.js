import{l as W,p as c,d as K,r as R,c as L,o as g,a as Y,w as T,f as $,ac as O,g as u,i as x,y,u as r,b as h,j as C,z as Z,R as J,m as Q,E as S}from"./iframe-Dct5CHxr.js";import{R as b}from"./index-1T7U7QlS.js";import{y as X,E as _,T as ee}from"./index--vN8FzlQ.js";import{u as ne}from"./useEmptyValues-BnYvcW4O.js";import{w as ie}from"./install.util-cBz1HN_T.js";import{G as p}from"./ConfigProvider-7dg58IlU.js";import{g as B,a as te,b as U}from"./documentation-stories-DmJzCMmf.js";import"./preload-helper-Dch09mLN.js";import"./index-BpP4et0s.js";import"./index-DWhPhD7W.js";import"./index-pMiYc9r3.js";import"./index-CZoNQBHQ.js";import"./useId-MLHLvdkG.js";import"./index-DxlLUiSm.js";import"./event.constant-LtAI3-H4.js";import"./index-BgdLHs-h.js";import"./index-Bx14T361.js";import"./index-DalCjv79.js";import"./useLocale-pH4k1Kvj.js";import"./refs.util-D3l8TA3E.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-GU5Cqqg3.js";const oe="close",ae="click",re="command",le="visible-change",se=["primary","secondary"],ce=["solid","outline"],de=["sm","md"],pe=W({type:{type:c(String),values:se,default:"primary"},variant:{type:c(String),values:ce,default:"solid"},size:{type:c(String),values:de,default:"md"},iconLeft:{type:c(String),default:void 0},iconRight:{type:c(String),default:void 0},closable:Boolean,text:{type:String,default:void 0},selected:Boolean,disabled:Boolean,dropdownEnabled:Boolean,actions:{type:c(Array),default:void 0},trigger:{type:c(String),default:"click"},placement:{type:c(String),default:"bottom-start"}}),me={[oe]:n=>n instanceof MouseEvent,[ae]:n=>n instanceof Event,[re]:n=>typeof n=="string"||typeof n=="number"||typeof n=="object"&&n!==null,[le]:n=>typeof n=="boolean"},fe=["tabindex","aria-pressed","aria-disabled","title"],ge={key:0},ue=["aria-label"],N=K({name:"GChip",__name:"chip",props:pe,emits:me,setup(n,{emit:i}){const m=n,l=i,t=ne("chip"),I=R(!1),a=L(()=>{const{type:e,variant:P,size:V,iconLeft:j,iconRight:M,closable:ve,text:xe,selected:he,disabled:Ce,dropdownEnabled:be,...H}=m;return H}),o=L(()=>{const{variant:e,size:P,selected:V,disabled:j,type:M}=m;return[t.b(),t.m(M),t.m(e),t.e(P),t.is("selected",V),t.is("disabled",j)]}),s=e=>{l("close",e)},f=e=>{m.disabled||l("click",e)},v=e=>{l("command",e)},q=e=>{I.value=e,l("visible-change",e)};return(e,P)=>(g(),Y(r(X),Q(a.value,{disabled:e.disabled||!e.dropdownEnabled,onCommand:v,onVisibleChange:q}),{dropdown:T(()=>[x(e.$slots,"dropdown")]),default:T(()=>[$("span",{class:u(o.value),tabindex:e.disabled?-1:0,onClick:f,onKeydown:[O(f,["enter"]),O(f,["space"])],role:"button","aria-pressed":e.selected?"true":"false","aria-disabled":e.disabled?"true":"false",title:e.text},[e.$slots.prefix||e.iconLeft?x(e.$slots,"prefix",{key:0},()=>[e.iconLeft?(g(),y("span",{key:0,class:u(r(t).em(e.size,"prefix-icon"))},[h(r(b),{name:e.iconLeft},null,8,["name"])],2)):C("",!0)]):C("",!0),$("span",{class:u(r(t).e("content"))},[e.text?(g(),y("span",ge,Z(e.text),1)):x(e.$slots,"default",{key:1})],2),e.$slots.suffix||e.iconRight||e.closable||e.dropdownEnabled?x(e.$slots,"suffix",{key:1},()=>[e.iconRight&&!e.closable&&!e.dropdownEnabled?(g(),y("span",{key:0,class:u(r(t).em(e.size,"suffix-icon"))},[h(r(b),{name:e.iconRight},null,8,["name"])],2)):e.dropdownEnabled&&!e.closable?(g(),y("span",{key:1,class:u([r(t).em(e.size,"suffix-icon"),r(t).e("dropdown-icon")])},[h(r(b),{name:I.value?"regular chevron-up":"regular chevron-down"},null,8,["name"])],2)):e.closable?(g(),y("span",{key:2,onClick:J(s,["stop"]),class:u([r(t).em(e.size,"suffix-icon"),r(t).e("close")]),"aria-label":`Remove ${e.text}`},[h(r(b),{name:"regular times"})],10,ue)):C("",!0)]):C("",!0)],42,fe)]),_:3},16,["disabled"]))}}),d=ie(N,{Chip:N}),ye="1.1.24",G={"@flash-global66/g-dropdown":"^0.1.0","@flash-global66/g-icon-font":"^0.11.0","@flash-global66/g-popover":"^0.0.7",vue:"^3.2.0"},qe={title:"Data/Chip",component:d,parameters:{docs:{description:{component:`
...
`}}},argTypes:{size:{description:"Tamaño del chip: md (30px) incluye más padding, sm (26px) es más compacto",control:"select",options:["sm","md"],table:{category:"Apariencia",type:{summary:"string"},defaultValue:{summary:"md"}}},type:{description:"Tipo que controla el border radius: primary (redondeado completo), secondary (esquinas suaves)",control:"select",options:["primary","secondary"],table:{category:"Apariencia",type:{summary:"string"},defaultValue:{summary:"primary"}}},variant:{description:"Variante visual: solid (fondo gris para tags), outline (solo borde para filtros)",control:"select",options:["solid","outline"],table:{category:"Apariencia",type:{summary:"string"},defaultValue:{summary:"solid"}}},iconLeft:{name:"icon-left",description:"Ícono a la izquierda",control:"select",options:["",...B()],table:{category:"Iconos",type:{summary:"string"},defaultValue:{summary:"undefined"}}},iconRight:{name:"icon-right",description:"Ícono a la derecha",control:"select",options:["",...B()],table:{category:"Iconos",type:{summary:"string"},defaultValue:{summary:"undefined"}}},text:{description:"Texto a mostrar en el chip",control:"text",table:{category:"Contenido",type:{summary:"string"},defaultValue:{summary:"undefined"}}},closable:{description:"Habilita el botón de cerrar",control:"boolean",table:{category:"Comportamiento",type:{summary:"boolean"},defaultValue:{summary:"false"}}},selected:{description:"Estado seleccionado: para outline cambia a fondo azul, para solid mantiene apariencia",control:"boolean",table:{category:"Estado",type:{summary:"boolean"},defaultValue:{summary:"false"}}},disabled:{description:"Estado deshabilitado: evita interacciones y aplica estilos visuales de disabled",control:"boolean",table:{category:"Estado",type:{summary:"boolean"},defaultValue:{summary:"false"}}},dropdownEnabled:{description:"Habilita el dropdown integrado. Automáticamente muestra un icono chevron-down en el sufijo cuando está habilitado. Para configurar el dropdown, usa las props estándar de GDropdown.",control:"boolean",table:{category:"Dropdown",type:{summary:"boolean"},defaultValue:{summary:"false"}}},actions:{description:"Acciones del dropdown (array de objetos { title: string, command: any }). Para más opciones de configuración, consulta la documentación de GDropdown.",control:"object",table:{category:"Dropdown",type:{summary:"Array<object>"}}},trigger:{description:"Cómo se activa el dropdown: 'hover', 'click', 'contextmenu'. Para más opciones, consulta la documentación de GDropdown.",control:"select",options:["hover","click","contextmenu"],table:{category:"Dropdown",type:{summary:"string"},defaultValue:{summary:"hover"}}},placement:{description:"Posición del dropdown. Para todas las opciones de posicionamiento disponibles, consulta la documentación de GDropdown.",control:"select",options:["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end"],table:{category:"Dropdown",type:{summary:"string"},defaultValue:{summary:"bottom"},description:"**Nota:** Todas las demás props de GDropdown se pasan directamente al componente. Para configuración avanzada (triggerKeys, popperOptions, hideOnClick, timeouts, etc.), consulta la documentación de GDropdown."}},close:{description:"Evento emitido al cerrar",action:"close",table:{category:"Eventos",type:{summary:"Event",detail:"() => void"},defaultValue:{summary:"() => void"}},control:!1},click:{description:"Evento emitido al hacer clic",action:"click",table:{category:"Eventos",type:{summary:"Event",detail:"() => void"},defaultValue:{summary:"() => void"}},control:!1},command:{description:"Evento emitido al seleccionar un elemento del dropdown",action:"command",table:{category:"Eventos",type:{summary:"any",detail:"(command: any) => void"},defaultValue:{summary:"() => void"}},control:!1},prefix:{description:"slot para el inicio del chip",table:{category:"Slots",type:{summary:"slot"}},control:!1},default:{description:"slot para el contenido del chip",table:{category:"Slots",type:{summary:"slot"}},control:!1},suffix:{description:"slot para el final del chip",table:{category:"Slots",type:{summary:"slot"}},control:!1},dropdown:{description:"slot para el contenido personalizado del dropdown",table:{category:"Slots",type:{summary:"slot"}},control:!1}},args:{text:"Chip",size:"md",type:"primary",variant:"solid",iconLeft:"",iconRight:"",closable:!1,selected:!1,disabled:!1,dropdownEnabled:!1,actions:[],trigger:"hover",placement:"bottom"}},F={name:"Básico",render:n=>({components:{GChip:d,GConfigProvider:p},setup(){return{args:n}},template:`
    ...
    `})},z={name:"Chips con iconos",render:()=>({components:{GChip:d,GConfigProvider:p},setup(){return{iconExamples:[{iconLeft:"solid check",text:"Verificado"},{iconRight:"regular chevron-down",text:"Dropdown"},{iconLeft:"solid user",iconRight:"solid check",text:"Usuario activo"},{iconLeft:"regular heart",text:"Favorito",variant:"outline"},{iconLeft:"regular bell",text:"Notificación",type:"secondary"},{iconRight:"solid arrow-right",text:"Siguiente",variant:"outline",type:"secondary"}]}},template:`
      <g-config-provider>
    ...
    `})},D={name:"Chips eliminables",render:()=>({components:{GChip:d,GConfigProvider:p},setup(){const n=[{text:"Chip 1",type:"primary",variant:"solid"},{text:"Chip 2",type:"secondary",variant:"solid"},{text:"Chip 3",type:"primary",variant:"outline"},{text:"Chip 4",type:"secondary",variant:"outline"}],i=S([...n]);return{dynamicChips:i,handleClose:l=>{if(i.length===1){i.splice(-1,1,...n);return}i.splice(i.findIndex(t=>t.text===l),1)}}},template:`
      <g-config-provider>
    ...
    `})},E={name:"Tipos y variantes (separados)",render:()=>({components:{GChip:d,GConfigProvider:p},setup(){return{}},template:`
      <g-config-provider>
    ...
    `})},k={name:"Sistema de filtros en cascada",parameters:{docs:{source:{code:`<script setup lang="ts">
...
</template>`}}},render:()=>({components:{GChip:d,GConfigProvider:p},setup(){const n=S([{id:"year",text:"Año",selected:!1,options:["2015","2016","2017","2018","2019","2020"]},{id:"category",text:"Categoría",selected:!1,options:["Importaciones","Exportaciones","Balanza comercial"]},{id:"country",text:"País",selected:!1,options:["Chile","Argentina","Brasil","Colombia","Perú"]},{id:"currency",text:"Moneda",selected:!1,options:["USD","EUR","CLP","ARS"]}]),i=R([]);return{mainFilters:n,appliedFilters:i,toggleMainFilter:a=>{const o=n.find(s=>s.id===a);if(o&&(o.selected=!o.selected,!o.selected)){const s=i.value.filter(f=>f.category!==a);i.value.splice(0,i.value.length),i.value.push(...s)}},addAppliedFilter:(a,o,s)=>{i.value.find(v=>v.category===a&&v.value===o)||i.value.push({id:`${a}-${o}`,category:a,value:o,text:`${s}: ${o}`})},removeAppliedFilter:a=>{const o=i.value.findIndex(s=>s.id===a);o>-1&&i.value.splice(o,1)},clearAllFilters:()=>{i.value.splice(0),n.forEach(a=>a.selected=!1)}}},template:`
      <g-config-provider>
...
<div>
  ...
  />
...
</template>`}}},render:()=>({components:{GChip:d,GConfigProvider:p,GDropdownMenu:ee,GDropdownItem:_},setup(){const n=S([{title:"Pesos colombianos",command:"COP",flag:"🇨🇴"},{title:"Dólar estadounidense",command:"USD",flag:"🇺🇸"},{title:"Pesos argentinos",command:"ARS",flag:"🇦🇷"},{title:"Pesos chilenos",command:"CLP",flag:"🇨🇱"},{title:"Euro",command:"EUR",flag:"🇪🇺"},{title:"Real brasileño",command:"BRL",flag:"🇧🇷"}]),i=R(n[0]);return{currencies:n,selectedCurrency:i,handleCurrencyCommand:l=>{i.value=n.find(t=>t.command===l)||n[0]}}},template:`
      <g-config-provider>
    ...
    `})},He=["Basic","AllCombinations","WithIcons","ClosableDynamic","TypesWithAutomaticRadius","SelectableFilters","WithIntegratedDropdown"];F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  name: 'Básico',
  render: args => ({
    components: {
      GChip,
...
}`,...A.parameters?.docs?.source}}};export{w as AllCombinations,F as Basic,D as ClosableDynamic,k as SelectableFilters,E as TypesWithAutomaticRadius,z as WithIcons,A as WithIntegratedDropdown,He as __namedExportsOrder,qe as default};
