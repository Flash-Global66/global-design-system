import{o as ue,B as De,C as xe,g as Ve,r as d,c as x,w as ie,D as ke,d as pe,a as ne,x as I,e as y,m as q,k as oe,l as C,u as a,s as F,h as ae,y as re,F as Ae,z as Be,b as te,f as w,A as Ee,n as me,T as we,j as Se,p as ze,q as Te,v as Me,E as Ie}from"./vue.esm-bundler-BiLMJBXK.js";import{a as Fe,O as Ge,G as Pe}from"./index-D4Nj_xQj.js";import{u as Le,G as je,a as Oe}from"./index-hASKpdd7.js";import{b as fe,d as de}from"./install-BOOPtfBD.js";import{m as Ne,a as $e,u as qe}from"./index-BzJBbEF1.js";import{U as be}from"./event-BB_Ol6Sd.js";import{u as We,f as Xe,G}from"./ConfigProvider-qZNzJU0u.js";import{u as ce}from"./index-4o8CGBx3.js";import{b as le}from"./style-BQnuaMmt.js";import{i as Re}from"./index-BnpPYVuG.js";import{u as ge}from"./index-BBJ4PQcT.js";import{S as Ue}from"./index-jZ5CM1us.js";import{y as Ye}from"./index-67NZVayx.js";import{c as Ke}from"./refs-BpMu8tqy.js";import{G as P}from"./index-DGYrpcrX.js";import"./aria-BUADUvnR.js";import"./error-Cq9Fpw4b.js";import"./vnode-MzjhXOHY.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-Bc6e4lZJ.js";import"./_arrayPush-DTRztRsG.js";const He=(e,o,i,l)=>{let p={offsetX:0,offsetY:0};const n=S=>{const c=S.clientX,z=S.clientY,{offsetX:g,offsetY:f}=p,b=e.value.getBoundingClientRect(),A=b.left,h=b.top,B=b.width,W=b.height,s=document.documentElement.clientWidth,L=document.documentElement.clientHeight,D=-A+g,j=-h+f,_=s-A-B+g,ee=L-h-W+f,O=T=>{let u=g+T.clientX-c,E=f+T.clientY-z;l?.value||(u=Math.min(Math.max(u,D),_),E=Math.min(Math.max(E,j),ee)),p={offsetX:u,offsetY:E},e.value&&(e.value.style.transform=`translate(${le(u)}, ${le(E)})`)},N=()=>{document.removeEventListener("mousemove",O),document.removeEventListener("mouseup",N)};document.addEventListener("mousemove",O),document.addEventListener("mouseup",N)},k=()=>{o.value&&e.value&&o.value.addEventListener("mousedown",n)},m=()=>{o.value&&e.value&&o.value.removeEventListener("mousedown",n)},r=()=>{p={offsetX:0,offsetY:0},e.value&&(e.value.style.transform="none")};return ue(()=>{De(()=>{i.value?k():m()})}),xe(()=>{m()}),{resetPosition:r}},ve=Symbol("dialogInjectionKey"),Ce=fe({fullscreen:Boolean,draggable:Boolean,overflow:{type:Boolean,default:!0},alignCenter:{type:Boolean,default:!1},sizeMode:{type:String,values:["default","fixed","adaptive"],default:"default"},title:{type:String,default:""},headerClass:String,bodyClass:String,footerClass:String,showClose:{type:Boolean,default:!0},width:{type:[String,Number]},ariaLevel:{type:String,default:"2"},footerButtons:{type:Array,default:()=>[]}}),Ze=e=>{const{sizeMode:o,width:i}=e;o==="fixed"&&(!i||i==="")&&console.warn('[g-dialog] When sizeMode is set to "fixed", width must be defined.')},Je={close:()=>!0},Qe=fe({...Ce,appendToBody:{type:Boolean,default:!1},appendTo:{type:de([String,Object]),default:"body"},beforeClose:{type:de(Function)},destroyOnClose:{type:Boolean,default:!1},closeOnClickModal:{type:Boolean,default:!0},closeOnPressEscape:{type:Boolean,default:!0},lockScroll:{type:Boolean,default:!0},modal:{type:Boolean,default:!0},openDelay:{type:Number,default:0},closeDelay:{type:Number,default:0},top:{type:String},modelValue:Boolean,modalClass:String,headerClass:String,bodyClass:String,footerClass:String,width:{type:[String,Number]},zIndex:{type:Number},trapFocus:{type:Boolean,default:!0},ariaLevel:{type:String,default:"2"}}),_e={open:()=>!0,opened:()=>!0,close:()=>!0,closed:()=>!0,[be]:e=>Ne(e),openAutoFocus:()=>!0,closeAutoFocus:()=>!0},eo=(e,o,{closeOnClickModal:i,closeOnPressEscape:l})=>{const n=Ve().emit,{nextZIndex:k}=We();let m="";const r=ce(),S=ce(),c=d(!1),z=d(!1),g=d(!1),f=d(e.zIndex??k()),b=x(()=>e.footerButtons?.slice(0,3)||[]),A=x(()=>b.value.length===3?"layout-dual-row":"layout-single-column");let h,B;const s=Xe("namespace","gui"),L=x(()=>{const v={},se=`--${s.value}-dialog`;return e.fullscreen||(e.top&&(v[`${se}-margin-top`]=e.top),e.width&&(v[`${se}-width`]=le(e.width))),v}),D=x(()=>e.alignCenter?{display:"flex"}:{});function j(){n("opened")}function _(){n("closed"),n(be,!1),e.destroyOnClose&&(g.value=!1)}function ee(){n("close")}function O(){B?.(),h?.(),e.openDelay&&e.openDelay>0?{stop:h}=ge(()=>E(),e.openDelay):E()}function N(){h?.(),B?.(),e.closeDelay&&e.closeDelay>0?{stop:B}=ge(()=>X(),e.closeDelay):X()}const T=()=>{e.showClose&&(e.beforeClose?e.beforeClose(X):X())};function u(){i.value&&T()}function E(){$e&&(c.value=!0)}function X(){c.value=!1}function t(){n("openAutoFocus")}function M(){n("closeAutoFocus")}function $(v){v.detail?.focusReason==="pointer"&&v.preventDefault()}e.lockScroll&&Le(c);function he(){l.value&&T()}return ie(()=>e.modelValue,v=>{v?(z.value=!1,O(),g.value=!0,f.value=Re(e.zIndex)?k():f.value++,ke(()=>{n("open"),o.value&&(o.value.parentElement.scrollTop=0,o.value.parentElement.scrollLeft=0,o.value.scrollTop=0)})):c.value&&N()}),ie(()=>e.fullscreen,v=>{o.value&&(v?(m=o.value.style.transform,o.value.style.transform=""):o.value.style.transform=m)}),ue(()=>{e.modelValue&&(c.value=!0,g.value=!0,O())}),{afterEnter:j,afterLeave:_,beforeLeave:ee,handleClose:T,onModalClick:u,close:N,doClose:X,onOpenAutoFocus:t,onCloseAutoFocus:M,onCloseRequested:he,onFocusoutPrevented:$,titleId:r,bodyId:S,closed:z,style:L,overlayDialogStyle:D,rendered:g,visible:c,zIndex:f,displayButtons:b,buttonLayoutClass:A}},oo={key:0,class:"header-content"},ao=["id"],to=["aria-level"],ye=pe({__name:"dialog-content",props:Ce,emits:Je,setup(e,{expose:o,emit:i}){const l=e,p=i;Ze(l);const{dialogRef:n,headerRef:k,bodyId:m,ns:r,style:S,displayButtons:c,buttonLayoutClass:z}=ne(ve),{focusTrapRef:g}=ne(Fe,{focusTrapRef:n,onKeydown:()=>{}}),f=x(()=>{const s=l.fullscreen?"fullscreen":l.sizeMode||"default";return[r.b(),r.is("draggable",l.draggable),r.is("align-center",l.alignCenter),r.is(s)]}),b=Ke(g,n),A=x(()=>l.draggable&&!l.fullscreen),h=x(()=>l.overflow),{resetPosition:B}=He(n,n,A,h);o({resetPosition:B});const W=()=>{p("close")};return(s,L)=>(y(),I("div",{ref:a(b),class:C(f.value),style:me(a(S)),tabindex:"-1"},[s.showClose||s.$slots.header?(y(),I("header",{key:0,ref_key:"headerRef",ref:k,class:C([a(r).e("header"),s.headerClass])},[s.$slots.header?(y(),I("div",oo,[F(s.$slots,"header")])):q("",!0),s.showClose?(y(),I("button",{key:1,"aria-label":"Close",class:C(a(r).e("headerbtn")),type:"button",onClick:W},[ae(a(Ue),{name:"regular times",class:C(a(r).e("close"))},null,8,["class"])],2)):q("",!0)],2)):q("",!0),oe("div",{id:a(m),class:C([a(r).e("body"),s.bodyClass])},[oe("div",null,[s.$slots.image?(y(),I("div",{key:0,class:C(a(r).e("image"))},[F(s.$slots,"image")],2)):q("",!0),s.title?(y(),I("span",{key:1,class:C(a(r).e("title")),role:"heading","aria-level":s.ariaLevel},re(s.title),11,to)):q("",!0),oe("div",{class:C(a(r).e("content"))},[F(s.$slots,"default")],2)])],10,ao),oe("footer",{class:C([a(r).e("footer"),s.footerClass])},[F(s.$slots,"footer",{},()=>[l.footerButtons?.length?(y(),I("div",{key:0,class:C([a(r).e("footer-buttons"),a(z)])},[(y(!0),I(Ae,null,Be(a(c),(D,j)=>(y(),te(a(Ye),{key:j,variant:D.variant,disabled:D.disabled,full:"",onClick:D.onClick},{default:w(()=>[Ee(re(D.text),1)]),_:2},1032,["variant","disabled","onClick"]))),128))],2)):q("",!0)])],2)],6))}});ye.__docgenInfo={exportName:"default",displayName:"dialog-content",description:"",tags:{},expose:[{name:"resetPosition"}],slots:[{name:"header"},{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog-content.vue"]};const lo=["aria-label","aria-labelledby","aria-describedby"],V=pe({__name:"dialog",props:Qe,emits:_e,setup(e,{expose:o,emit:i}){const l=e,p=qe("dialog"),n=d(),k=d(),m=d(),r=x(()=>l.showClose&&l.closeOnClickModal),S=x(()=>l.showClose&&l.closeOnPressEscape),{visible:c,titleId:z,bodyId:g,style:f,overlayDialogStyle:b,rendered:A,zIndex:h,afterEnter:B,afterLeave:W,beforeLeave:s,handleClose:L,onModalClick:D,onOpenAutoFocus:j,onCloseAutoFocus:_,onCloseRequested:ee,onFocusoutPrevented:O,displayButtons:N,buttonLayoutClass:T}=eo(l,n,{closeOnClickModal:r,closeOnPressEscape:S});Ie(ve,{dialogRef:n,headerRef:k,bodyId:g,ns:p,rendered:A,style:f,displayButtons:N,buttonLayoutClass:T});const u=Oe(D),E=x(()=>l.draggable&&!l.fullscreen);return o({visible:c,dialogContentRef:m,resetPosition:()=>{m.value?.resetPosition()}}),(t,M)=>(y(),te(a(Pe),{to:t.appendTo,disabled:t.appendTo!=="body"?!1:!t.appendToBody},{default:w(()=>[ae(we,{name:"dialog-fade",onAfterEnter:a(B),onAfterLeave:a(W),onBeforeLeave:a(s)},{default:w(()=>[Se(ae(a(je),{"custom-mask-event":"",mask:t.modal,"overlay-class":t.modalClass,"z-index":a(h)},{default:w(()=>[oe("div",{role:"dialog","aria-modal":"true","aria-label":t.title||void 0,"aria-labelledby":t.title?void 0:a(z),"aria-describedby":a(g),class:C(`${a(p).namespace.value}-overlay-dialog`),style:me(a(b)),onClick:M[0]||(M[0]=(...$)=>a(u).onClick&&a(u).onClick(...$)),onMousedown:M[1]||(M[1]=(...$)=>a(u).onMousedown&&a(u).onMousedown(...$)),onMouseup:M[2]||(M[2]=(...$)=>a(u).onMouseup&&a(u).onMouseup(...$))},[ae(a(Ge),{loop:"",trapped:a(c),"focus-start-el":"container",onFocusAfterTrapped:a(j),onFocusAfterReleased:a(_),onFocusoutPrevented:a(O),onReleaseRequested:a(ee)},{default:w(()=>[a(A)?(y(),te(ye,ze({key:0,ref_key:"dialogContentRef",ref:m},t.$attrs,{"align-center":t.alignCenter,draggable:E.value,overflow:t.overflow,fullscreen:t.fullscreen,"header-class":t.headerClass,"body-class":t.bodyClass,"footer-class":t.footerClass,"show-close":t.showClose,title:t.title,"aria-level":t.ariaLevel,width:t.width,"size-mode":t.sizeMode,"footer-buttons":t.footerButtons,onClose:a(L)}),Te({default:w(()=>[F(t.$slots,"default")]),_:2},[t.$slots.header?{name:"header",fn:w(()=>[F(t.$slots,"header")]),key:"0"}:void 0,t.$slots.image?{name:"image",fn:w(()=>[F(t.$slots,"image")]),key:"1"}:void 0,t.$slots.footer?{name:"footer",fn:w(()=>[F(t.$slots,"footer")]),key:"2"}:void 0]),1040,["align-center","draggable","overflow","fullscreen","header-class","body-class","footer-class","show-close","title","aria-level","width","size-mode","footer-buttons","onClose"])):q("",!0)]),_:3},8,["trapped","onFocusAfterTrapped","onFocusAfterReleased","onFocusoutPrevented","onReleaseRequested"])],46,lo)]),_:3},8,["mask","overlay-class","z-index"]),[[Me,a(c)]])]),_:3},8,["onAfterEnter","onAfterLeave","onBeforeLeave"])]),_:3},8,["to","disabled"]))}});V.__docgenInfo={exportName:"default",displayName:"dialog",description:"",tags:{},expose:[{name:"visible",tags:[{title:"description",content:"whether the dialog is visible"}]},{name:"dialogContentRef"},{name:"resetPosition"}],slots:[{name:"header"},{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog.vue"]};const so="1.2.0",Po={title:"Data/Dialog",component:V,argTypes:{modelValue:{control:"boolean",description:"Controla la visibilidad del dialog",table:{defaultValue:{summary:"false"}}},title:{control:"text",description:"Título del dialog",table:{defaultValue:{summary:""}}},width:{control:"text",description:"Ancho del dialog. Requiere size-mode='fixed'.",table:{defaultValue:{summary:"undefined"}}},sizeMode:{control:"select",options:["default","fixed","adaptive"],description:`Controla el comportamiento del ancho del dialog:
