import{E as f}from"./iframe-Dct5CHxr.js";import{H as n}from"./index-pWeg55FS.js";import{G as r}from"./ConfigProvider-7dg58IlU.js";import{g}from"./documentation-stories-DmJzCMmf.js";import"./preload-helper-Dch09mLN.js";import"./index-1T7U7QlS.js";import"./install.util-cBz1HN_T.js";import"./useEmptyValues-BnYvcW4O.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-GU5Cqqg3.js";const w={title:"Data/Tag",component:n,parameters:{docs:{description:{component:`✨ \`GTag\` - Componente de etiqueta personalizable con íconos y opciones avanzadas.
...
/>`;try{await navigator.clipboard.writeText(d)}catch(m){console.error("Failed to copy: ",m)}}}},template:`
    ...
    `})},o={name:"Banderas como slots al inicio y al final",parameters:{docs:{description:{story:"Banderas como slots al inicio y al final del tag."}}},render:()=>({components:{GTag:n,GConfigProvider:r},setup(){return{}},template:`
    <g-config-provider>
    ...
    `})},E=["Basic","allCombination","prefixAndSuffix","closableDynamic"];a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  name: 'Básico',
  render: args => ({
    components: {
      GTag,
...
}`,...i.parameters?.docs?.source}}};export{a as Basic,E as __namedExportsOrder,s as allCombination,i as closableDynamic,w as default,o as prefixAndSuffix};
