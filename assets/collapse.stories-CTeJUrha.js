import{l as de,p as I,L as me,a4 as Ae,r as v,W as ne,s as $e,c as r,D as Ge,aB as oe,k as Se,a0 as Ne,d as Z,o as f,a as O,w as V,i as L,m as $,aD as je,u as n,T as Re,x as He,y as C,f as T,g,F as X,A as Y,R as J,j as se,z as te,aa as ie,ab as Fe,ac as we,b as qe,e as ze,v as Oe,E as pe}from"./iframe-Dct5CHxr.js";import{C as ue,U as ge}from"./event.constant-LtAI3-H4.js";import{m as le}from"./useAttrs-BZi71rd1.js";import{f as fe,u as K}from"./useEmptyValues-BnYvcW4O.js";import{w as ve,a as Ve}from"./install.util-cBz1HN_T.js";import{R as B}from"./index-1T7U7QlS.js";import{a as Be}from"./useId-MLHLvdkG.js";import{G as Ke}from"./index-XrXeeEoZ.js";import{G as be,a as ye}from"./index-DOcpSnVP.js";import{G as he}from"./index-CiBki8_N.js";import{G as _e}from"./index-BeqF1NXI.js";import{G as Me}from"./index-5OiSV4ne.js";import{G as P}from"./ConfigProvider-7dg58IlU.js";import{a as Ue,b as re}from"./documentation-stories-DmJzCMmf.js";import"./preload-helper-Dch09mLN.js";import"./index-CZoNQBHQ.js";import"./index-pMiYc9r3.js";import"./index-CRx4dHSJ.js";import"./index-DWhPhD7W.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-GU5Cqqg3.js";const ce=a=>fe(a)||me(a)||Ae(a),We=de({accordion:Boolean,modelValue:{type:I([Array,String,Number]),default:()=>le([])},expandIconPosition:{type:I([String]),default:"right"},beforeCollapse:{type:I(Function)},items:{type:I(Array),default:()=>le([])}}),Je={[ge]:ce,[ue]:ce,"header-click":a=>me(a)||fe(a)},xe=Symbol.for("collapseContextKey"),Qe="GCollapse",Xe=(a,s)=>{const o=v(ne(a.modelValue)),t=i=>{o.value=i;const c=a.accordion?o.value[0]:o.value;s(ge,c),s(ue,c)},e=i=>{if(a.accordion)t([o.value[0]===i?"":i]);else{const c=[...o.value],d=c.indexOf(i);d>-1?c.splice(d,1):c.push(i),t(c)}},l=async i=>{const{beforeCollapse:c}=a;if(!c){e(i);return}const d=c(i);[oe(d),Se(d)].includes(!0)||Ne(Qe,"beforeCollapse must return type `Promise<boolean>` or `boolean`"),oe(d)?d.then(u=>{u!==!1&&e(i)}).catch(u=>{}):d&&e(i)},p=i=>{s("header-click",i)};return $e(()=>a.modelValue,()=>o.value=ne(a.modelValue),{deep:!0}),Ge(xe,{activeNames:o,handleItemClick:l,handleHeaderOnlyClick:p}),{activeNames:o,setActiveNames:t}},Ye=a=>{const s=K("collapse");return{rootKls:r(()=>[s.b()]),expandIconPosition:r(()=>a.expandIconPosition)}},Ze=Z({name:"GCollapseTransition",__name:"collapse-transition",setup(a){const s=K("collapse-transition"),o=e=>{e.style.maxHeight="",e.style.overflow=e.dataset.oldOverflow,e.style.paddingTop=e.dataset.oldPaddingTop,e.style.paddingBottom=e.dataset.oldPaddingBottom},t={beforeEnter(e){e.dataset||(e.dataset={}),e.dataset.oldPaddingTop=e.style.paddingTop,e.dataset.oldPaddingBottom=e.style.paddingBottom,e.style.height&&(e.dataset.elExistsHeight=e.style.height),e.style.maxHeight=0,e.style.paddingTop=0,e.style.paddingBottom=0},enter(e){requestAnimationFrame(()=>{e.dataset.oldOverflow=e.style.overflow,e.dataset.elExistsHeight?e.style.maxHeight=e.dataset.elExistsHeight:e.scrollHeight!==0?e.style.maxHeight=`${e.scrollHeight}px`:e.style.maxHeight=0,e.style.paddingTop=e.dataset.oldPaddingTop,e.style.paddingBottom=e.dataset.oldPaddingBottom,e.style.overflow="hidden"})},afterEnter(e){e.style.maxHeight="",e.style.overflow=e.dataset.oldOverflow},enterCancelled(e){o(e)},beforeLeave(e){e.dataset||(e.dataset={}),e.dataset.oldPaddingTop=e.style.paddingTop,e.dataset.oldPaddingBottom=e.style.paddingBottom,e.dataset.oldOverflow=e.style.overflow,e.style.maxHeight=`${e.scrollHeight}px`,e.style.overflow="hidden"},leave(e){e.scrollHeight!==0&&(e.style.maxHeight=0,e.style.paddingTop=0,e.style.paddingBottom=0)},afterLeave(e){o(e)},leaveCancelled(e){o(e)}};return(e,l)=>(f(),O(Re,$({name:n(s).b()},je(t)),{default:V(()=>[L(e.$slots,"default")]),_:3},16,["name"]))}}),ea=ve(Ze),aa=de({title:{type:String,default:""},name:{type:I([String,Number]),default:void 0},disabled:Boolean,iconsRight:{type:I(Array),default:()=>[]},iconsLeft:{type:I(Array),default:()=>[]},description:{type:String,default:""},content:{type:I([String,Function]),default:""},expandIconPosition:{type:I(String),default:"right"},headerOnly:{type:Boolean,default:!1},hideIcon:{type:Boolean,default:!1}}),na=a=>{const s=He(xe),{namespace:o}=K("collapse"),t=v(!1),e=v(!1),l=Be(),p=r(()=>l.current++),i=r(()=>a.name??`${o.value}-id-${l.prefix}-${n(p)}`),c=r(()=>s?.activeNames.value.includes(n(i))),d=r(()=>[...a.expandIconPosition==="left"&&!a.hideIcon?[{icon:"regular angle-right",onClick:()=>{s?.handleItemClick(n(i))}}]:[],...a.iconsLeft||[]]),y=r(()=>[...a.expandIconPosition==="right"&&!a.hideIcon?[{icon:"regular angle-right",onClick:()=>{s?.handleItemClick(n(i))}}]:[],...a.iconsRight||[]].slice().reverse()),u=r(()=>typeof a.content=="string"?a.content:a.content?.()||""),h=r(()=>({isActive:c.value,name:i.value,title:a.title,description:a.description,disabled:a.disabled,headerOnly:a.headerOnly,expandIconPosition:a.expandIconPosition,hideIcon:a.hideIcon,iconsLeft:d.value,iconsRight:y.value,focusing:t.value}));return{focusing:t,id:p,isActive:c,handleFocus:()=>{setTimeout(()=>{e.value?e.value=!1:t.value=!0},50)},handleHeaderClick:()=>{a.disabled||(a.headerOnly?s?.handleHeaderOnlyClick?.(n(i)):s?.handleItemClick(n(i)),t.value=!1,e.value=!0)},handleEnterClick:()=>{a.headerOnly?s?.handleHeaderOnlyClick?.(n(i)):s?.handleItemClick(n(i))},iconsLeft:d,iconsRight:y,content:u,name:i,slotProps:h}},oa=(a,{focusing:s,isActive:o,id:t})=>{const e=K("collapse"),l=r(()=>[e.b("item"),e.is("active",n(o)),e.is("disabled",a.disabled)]),p=r(()=>[e.be("item","header"),e.is("active",n(o)),{focusing:n(s)&&!a.disabled}]),i=r(()=>[e.bem("item","header","icon-left")]),c=r(()=>[e.bem("item","header","icon-right")]),d=r(()=>[e.bem("item","header","content")]),y=r(()=>[e.be("item","arrow"),e.is("active",n(o))]),u=r(()=>[e.be("item","title")]),h=r(()=>[e.be("item","description")]),x=r(()=>[e.bem("item","header","text")]),A=r(()=>e.be("item","wrap")),G=r(()=>e.be("item","content")),_=r(()=>e.b(`content-${n(t)}`)),M=r(()=>e.b(`head-${n(t)}`));return{itemTitleKls:u,arrowKls:y,headKls:p,rootKls:l,itemWrapperKls:A,itemContentKls:G,scopedContentId:_,scopedHeadId:M,itemDescriptionKls:h,iconsLeftKls:i,iconsRightKls:c,contentHeaderKls:d,contentHeaderTextKls:x}},sa=["id","aria-expanded","aria-controls","aria-describedby","tabindex"],ta=["id","aria-hidden","aria-labelledby"],ia=["innerHTML"],ee=Z({name:"GCollapseItem",__name:"collapse-item",props:aa,setup(a,{expose:s}){const o=a,{focusing:t,id:e,isActive:l,handleFocus:p,handleHeaderClick:i,handleEnterClick:c,content:d,iconsLeft:y,iconsRight:u,name:h,slotProps:x}=na(o),{arrowKls:A,headKls:G,rootKls:_,itemTitleKls:M,itemWrapperKls:Ce,itemContentKls:Ie,scopedContentId:U,scopedHeadId:ae,contentHeaderKls:Pe,iconsLeftKls:Ee,iconsRightKls:ke,contentHeaderTextKls:De,itemDescriptionKls:Te}=oa(o,{focusing:t,isActive:l,id:e});return s({isActive:l}),(D,E)=>(f(),C("div",{class:g(n(_))},[T("button",{id:n(ae),class:g(n(G)),"aria-expanded":n(l),"aria-controls":n(U),"aria-describedby":n(U),tabindex:D.disabled?-1:0,type:"button",onClick:E[0]||(E[0]=(...m)=>n(i)&&n(i)(...m)),onKeydown:E[1]||(E[1]=we(J((...m)=>n(c)&&n(c)(...m),["stop","prevent"]),["space","enter"])),onFocus:E[2]||(E[2]=(...m)=>n(p)&&n(p)(...m)),onBlur:E[3]||(E[3]=m=>t.value=!1)},[T("div",{class:g(n(Pe))},[n(y).length>0?(f(),C("div",{key:0,class:g(n(Ee))},[(f(!0),C(X,null,Y(n(y),(m,W)=>(f(),O(n(B),{key:W,name:m.icon,class:g(m.icon==="regular angle-right"?n(A):""),onClick:J(Le=>!D.disabled&&m?.onClick&&m?.onClick(n(h),m.icon,n(l)),["stop"]),spin:m.spin},null,8,["name","class","onClick","spin"]))),128))],2)):se("",!0),T("div",{class:g(n(De))},[L(D.$slots,"header",ie(Fe(n(x))),()=>[T("h5",{class:g(n(M))},te(D.title),3),T("span",{class:g(n(Te))},te(D.description),3)])],2)],2),n(u).length>0?(f(),C("div",{key:0,class:g(n(ke))},[(f(!0),C(X,null,Y(n(u),(m,W)=>(f(),O(n(B),{key:W,name:m.icon,class:g(m.icon==="regular angle-right"?n(A):""),onClick:J(Le=>!D.disabled&&m?.onClick&&m.onClick(n(h),m.icon,n(l)),["stop"]),spin:m.spin},null,8,["name","class","onClick","spin"]))),128))],2)):se("",!0)],42,sa),qe(n(ea),null,{default:V(()=>[ze(T("div",{id:n(U),role:"region",class:g(n(Ce)),"aria-hidden":!n(l),"aria-labelledby":n(ae)},[T("div",{class:g(n(Ie))},[n(d)?(f(),C("div",{key:0,innerHTML:n(d)},null,8,ia)):L(D.$slots,"default",ie($({key:1},n(x))))],2)],10,ta),[[Oe,n(l)]])]),_:3})],2))}}),la=Z({name:"GCollapse",__name:"collapse",props:We,emits:Je,setup(a,{expose:s,emit:o}){const t=a,e=o,{activeNames:l,setActiveNames:p}=Xe(t,e),{rootKls:i,expandIconPosition:c}=Ye(t);return s({activeNames:l,setActiveNames:p}),(d,y)=>(f(),C("div",{class:g(n(i))},[t.items.length>0?(f(),C("div",{key:0,class:g(n(i))},[(f(!0),C(X,null,Y(t.items,(u,h)=>(f(),O(ee,$({key:u.name||h},{ref_for:!0},u,{name:u.name||h,"expand-icon-position":n(c)}),{default:V(x=>[L(d.$slots,"default",$({ref_for:!0},x,{item:u}))]),header:V(x=>[L(d.$slots,"header",$({ref_for:!0},x,{item:u}))]),_:2},1040,["name","expand-icon-position"]))),128))],2)):L(d.$slots,"dynamic",{key:1})],2))}}),b=ve(la,{CollapseItem:ee}),k=Ve(ee),ra="0.5.13",Q={vue:"^3.2.0"},$a={title:"Data/Collapse",component:b,parameters:{docs:{description:{component:`\`GCollapse\` - Componente de colapso para mostrar u ocultar contenido de manera dinámica.
        
> La versión de este componente es \`${ra}\`.
...
Props disponibles:
{
  ...
  focusing: boolean;
    ...
    `})},w={name:"Collapse item con formularios",parameters:{docs:{description:{story:"Ejemplo de uso de GCollapseItem con un formulario."}}},render:()=>({components:{GConfigProvider:P,GCollapse:b,GCollapseItem:k,GForm:ye,GFormItem:be,GInput:he},setup(){const a=v(1),s=pe({name:"Pepito",lastName:"Perez",phone:"999888777",email:"pepito@ejemplo.com",city:"Lima",address:""});return{activeNames:a,formData:s}},template:`
      <g-config-provider>
    ...
    `})},q={name:"Header solo click",parameters:{docs:{description:{story:"Ejemplo de uso de las props `headerOnly` y `hideIcon` en GCollapseItem. \n        \n- **headerOnly**: El item solo ejecuta un evento sin expandirse, pero mantiene el icono de flecha.\n- **hideIcon**: Solo oculta el icono de flecha, el collapse sigue funcionando normalmente."}}},render:()=>({components:{GConfigProvider:P,GCollapse:b,GCollapseItem:k,GIconFont:B},setup(){const a=v(["1"]),s=v("");return{activeNames:a,message:s,handleHeaderClick:t=>{s.value=`Se hizo clic en el header: ${t} a las ${new Date().toLocaleTimeString()}`,console.log("Header clickeado:",t)}}},template:`
      <g-config-provider>
        <div class="space-y-4">
    ...
    `})},z={name:"Slot default con props",parameters:{docs:{description:{story:"Ejemplo que demuestra las props disponibles en el slot default de GCollapseItem: isActive, name, title, description, disabled, headerOnly, expandIconPosition, hideIcon, iconsLeft, iconsRight, focusing."}}},render:()=>({components:{GConfigProvider:P,GCollapse:b,GCollapseItem:k,GIconFont:B},setup(){return{activeNames:v(["1"])}},template:`
      <g-config-provider>
    ...
    `})},Ga=["Basic","accordionExample","CustomIcons","positionIcon","preventCollpsing","slotDefault","simpleDifferentContent","headerOnlyExample","slotDefaultWithProps"];S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  name: 'Básico',
  render: args => ({
    components: {
      GCollapse,
...
}`,...z.parameters?.docs?.source}}};export{S as Basic,j as CustomIcons,Ga as __namedExportsOrder,N as accordionExample,$a as default,q as headerOnlyExample,R as positionIcon,H as preventCollpsing,w as simpleDifferentContent,F as slotDefault,z as slotDefaultWithProps};
