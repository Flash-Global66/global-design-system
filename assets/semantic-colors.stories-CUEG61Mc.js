import{G as t}from"./ConfigProvider-CHVLgL_2.js";import"./vue.esm-bundler-C6DRpX4R.js";import"./useEmptyValues-8bO_IQ4-.js";import"./props.util-DQIcYPkU.js";import"./useNamespace-D200ZTkz.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const p={title:"Colores/Semantic",parameters:{docs:{description:{component:`
...
> **Nota**: Click en cualquier color copia su nombre semántico al portapapeles. 📋
        `}}}},i=()=>({components:{GConfigProvider:t},template:`
  <g-config-provider>
  ...
  `,setup(){return{handleColorClick:async e=>{try{await navigator.clipboard.writeText(e)}catch(r){console.error("Error al copiar:",r)}}}}}),l=i.bind({});l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`() => ({
  components: {
    GConfigProvider
  },
  template: \`
...
})`,...l.parameters?.docs?.source}}};const f=["Default"];export{l as Default,f as __namedExportsOrder,p as default};
