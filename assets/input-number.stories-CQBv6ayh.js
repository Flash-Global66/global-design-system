import{d as Re,r as i,C as Te,c as N,t as ae,w as se,o as Me,S as Ue,b as h,h as ce,l as pe,f as _e,u as l,a1 as fe,k as E,q as z,a as A,p as we,e as ge,j as ve,N as ke}from"./vue.esm-bundler-C6DRpX4R.js";import{Y as Fe}from"./index-D3Qnyw_e.js";import{R}from"./index-DEGGxn4j.js";import{i as I,B as Be,M as $e,L as qe,a as T}from"./index-BnOtqFZS.js";import{c as b}from"./useEmptyValues-8bO_IQ4-.js";import{u as je}from"./useLocale-DkPZC-Li.js";import{U as x,E as Y,I as X,C as he}from"./event.constant-LtAI3-H4.js";import{a as Le}from"./index-OmpdNH0g.js";import{w as Oe}from"./install.util-cBz1HN_T.js";import{u as We}from"./useNamespace-D200ZTkz.js";import{v as be}from"./repeatClick.directive-DSSs_E1e.js";import{d as te,t as Ke}from"./error.util-CtUs3PUB.js";import{a as Xe}from"./props.util-DQIcYPkU.js";import{G as v}from"./ConfigProvider-CHVLgL_2.js";import{a as Ye,b as ye}from"./documentation-stories-0qKiiCdD.js";import"./index-B8Dg1tZU.js";import"./useAttrs-Dmae7bQW.js";import"./useId-BGX2ZA7H.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-fKX7T4ju.js";const He=()=>Le&&/android/i.test(window.navigator.userAgent),Je=n=>{if(n.code&&n.code!=="Unidentified")return n.code;const s=xe(n);if(s){if(Object.values(Y).includes(s))return s;switch(s){case" ":return Y.space;default:return""}}return""},xe=n=>{let s=n.key&&n.key!=="Unidentified"?n.key:"";if(!s&&n.type==="keyup"&&He()){const m=n.target;s=m.value.charAt(m.selectionStart-1)}return s},Qe={[he]:(n,s)=>s!==n,blur:n=>n instanceof FocusEvent,focus:n=>n instanceof FocusEvent,[X]:n=>b(n)||I(n),[x]:n=>b(n)||I(n)},Ze=["aria-label"],en=["aria-label"],nn=Re({name:"GInputNumber",__name:"input-number",props:{id:{default:void 0},step:{default:1},stepStrictly:{type:Boolean,default:!1},max:{default:Number.MAX_SAFE_INTEGER},min:{default:Number.MIN_SAFE_INTEGER},modelValue:{},readonly:{type:Boolean,default:!1},disabled:{type:Boolean,default:void 0},size:{},controls:{type:Boolean,default:!0},controlsPosition:{default:""},valueOnClear:{default:null},name:{},placeholder:{},precision:{},validateEvent:{type:Boolean,default:!0},ariaLabel:{},inputmode:{default:void 0},align:{default:"center"},disabledScientific:{type:Boolean}},emits:Qe,setup(n,{expose:s,emit:m}){const a=n,c=m,{t:P}=je(),p=We("input-number"),y=i(),u=Te({currentValue:a.modelValue,userInput:null}),{formItem:le}=qe(),ie=N(()=>b(a.modelValue)&&a.modelValue<=a.min),ue=N(()=>b(a.modelValue)&&a.modelValue>=a.max),Ve=N(()=>{const e=me(a.step);return T(a.precision)?Math.max(me(a.modelValue),e):(e>a.precision&&te(),a.precision)}),H=N(()=>a.controls&&a.controlsPosition==="right"),Se=Be(),S=$e(),J=N(()=>{if(u.userInput!==null)return u.userInput;let e=u.currentValue;if(I(e))return"";if(b(e)){if(Number.isNaN(e))return"";T(a.precision)||(e=e.toFixed(a.precision))}return e}),D=(e,r)=>{if(T(r)&&(r=Ve.value),r===0)return Math.round(e);let t=String(e);const o=t.indexOf(".");if(o===-1||!t.replace(".","").split("")[o+r])return e;const f=t.length;return t.charAt(f-1)==="5"&&(t=`${t.slice(0,Math.max(0,f-1))}6`),Number.parseFloat(Number(t).toFixed(r))},me=e=>{if(I(e))return 0;const r=e.toString(),t=r.indexOf(".");let o=0;return t!==-1&&(o=r.length-t-1),o},de=(e,r=1)=>b(e)?e>=Number.MAX_SAFE_INTEGER&&r===1||e<=Number.MIN_SAFE_INTEGER&&r===-1?e:D(e+a.step*r):u.currentValue,Ne=e=>{const r=Je(e),t=xe(e);if(a.disabledScientific&&["e","E"].includes(t)){e.preventDefault();return}switch(r){case Y.up:{e.preventDefault(),Q();break}case Y.down:{e.preventDefault(),Z();break}}},Q=()=>{if(a.readonly||S.value||ue.value)return;const e=Number(J.value)||0,r=de(e);C(r),c(X,u.currentValue),ne()},Z=()=>{if(a.readonly||S.value||ie.value)return;const e=Number(J.value)||0,r=de(e,-1);C(r),c(X,u.currentValue),ne()},ee=(e,r)=>{const{max:t,min:o,step:f,precision:re,stepStrictly:Ae,valueOnClear:G}=a;t<o&&Ke("InputNumber","min should not be greater than max.");let d=Number(e);if(I(e)||Number.isNaN(d))return null;if(e===""){if(G===null)return null;d=Xe(G)?{min:o,max:t}[G]:G}return Ae&&(d=D(Math.round(D(d/f))*f,re),d!==e&&r&&c(x,d)),T(re)||(d=D(d,re)),(d>t||d<o)&&(d=d>t?t:o,r&&c(x,d)),d},C=(e,r=!0)=>{const t=u.currentValue,o=ee(e);if(!r){c(x,o);return}u.userInput=null,!(t===o&&e)&&(c(x,o),t!==o&&c(he,o,t),a.validateEvent&&le?.validate?.("change").catch(f=>te()),u.currentValue=o)},Ee=e=>{u.userInput=e;const r=e===""?null:Number(e);c(X,r),C(r,!1)},Ie=e=>{const r=e!==""?Number(e):"";(b(r)&&!Number.isNaN(r)||e==="")&&C(r),ne(),u.userInput=null},Pe=()=>{y.value?.focus?.()},De=()=>{y.value?.blur?.()},Ce=e=>{c("focus",e)},Ge=e=>{u.userInput=null,u.currentValue===null&&y.value?.ref&&(y.value.ref.value=""),c("blur",e),a.validateEvent&&le?.validate?.("blur").catch(r=>te())},ne=()=>{u.currentValue!==a.modelValue&&(u.currentValue=a.modelValue)},ze=e=>{document.activeElement===e.target&&e.preventDefault()};return se(()=>a.modelValue,(e,r)=>{const t=ee(e,!0);u.userInput===null&&t!==r&&(u.currentValue=t)},{immediate:!0}),se(()=>a.precision,()=>{u.currentValue=ee(a.modelValue)}),Me(()=>{const{min:e,max:r,modelValue:t}=a,o=y.value?.ref;if(o){if(o.setAttribute("role","spinbutton"),Number.isFinite(r)?o.setAttribute("aria-valuemax",String(r)):o.removeAttribute("aria-valuemax"),Number.isFinite(e)?o.setAttribute("aria-valuemin",String(e)):o.removeAttribute("aria-valuemin"),o.setAttribute("aria-valuenow",u.currentValue||u.currentValue===0?String(u.currentValue):""),o.setAttribute("aria-disabled",String(S.value)),!b(t)&&t!=null){let f=Number(t);Number.isNaN(f)&&(f=null),c(x,f)}o.addEventListener("wheel",ze,{passive:!1})}}),Ue(()=>{y.value?.ref?.setAttribute("aria-valuenow",`${u.currentValue??""}`)}),s({focus:Pe,blur:De}),(e,r)=>(h(),ae("div",{class:E([l(p).b(),l(p).m(l(Se)),l(p).is("disabled",l(S)),l(p).is("without-controls",!e.controls),l(p).is("controls-right",H.value),l(p).is(e.align,!!e.align)]),onDragstart:r[0]||(r[0]=ke(()=>{},["prevent"]))},[e.controls?ce((h(),ae("span",{key:0,role:"button","aria-label":l(P)("el.inputNumber.decrease"),class:E([l(p).e("decrease"),l(p).is("disabled",ie.value)]),onKeydown:fe(Z,["enter"])},[z(e.$slots,"decrease-icon",{},()=>[H.value?(h(),A(l(R),{key:0,name:"regular chevron-down"})):(h(),A(l(R),{key:1,name:"regular minus"}))])],42,Ze)),[[l(be),Z]]):pe("",!0),e.controls?ce((h(),ae("span",{key:1,role:"button","aria-label":l(P)("el.inputNumber.increase"),class:E([l(p).e("increase"),l(p).is("disabled",ue.value)]),onKeydown:fe(Q,["enter"])},[z(e.$slots,"increase-icon",{},()=>[H.value?(h(),A(l(R),{key:0,name:"regular chevron-up"})):(h(),A(l(R),{key:1,name:"regular plus"}))])],42,en)),[[l(be),Q]]):pe("",!0),_e(l(Fe),{id:e.id,ref_key:"input",ref:y,type:"number",step:e.step,"model-value":J.value,placeholder:e.placeholder,readonly:e.readonly,disabled:l(S),max:e.max,min:e.min,name:e.name,"aria-label":e.ariaLabel,"validate-event":!1,inputmode:e.inputmode,onKeydown:Ne,onBlur:Ge,onFocus:Ce,onInput:Ee,onChange:Ie},we({_:2},[e.$slots.prefix?{name:"prefix",fn:ge(()=>[ve("span",{class:E(l(p).e("prefix"))},[z(e.$slots,"prefix")],2)]),key:"0"}:void 0,e.$slots.suffix?{name:"suffix",fn:ge(()=>[ve("span",{class:E(l(p).e("suffix"))},[z(e.$slots,"suffix")],2)]),key:"1"}:void 0]),1032,["id","step","model-value","placeholder","readonly","disabled","max","min","name","aria-label","inputmode"])],34))}}),g=Oe(nn),rn="0.2.15",oe={"lodash-unified":"^1.0.3",vue:"^3.2.0"},En={title:"Form/Input Number",component:g,parameters:{docs:{description:{component:`
...
`}}},argTypes:{modelValue:{control:"number",description:"Valor vinculado (v-model)",table:{type:{summary:"number | null"},defaultValue:{summary:"null"}}},step:{control:"number",description:"Paso incremental",table:{type:{summary:"number"},defaultValue:{summary:"1"}}},stepStrictly:{control:"boolean",description:"Solo permite múltiplos del paso",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},max:{control:"number",description:"Valor máximo permitido",table:{type:{summary:"number"},defaultValue:{summary:"Number.MAX_SAFE_INTEGER"}}},min:{control:"number",description:"Valor mínimo permitido",table:{type:{summary:"number"},defaultValue:{summary:"Number.MIN_SAFE_INTEGER"}}},readonly:{control:"boolean",description:"Modo solo lectura",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},disabled:{control:"boolean",description:"Deshabilitar componente",table:{type:{summary:"boolean"},defaultValue:{summary:"undefined"}}},size:{control:"select",options:["large","default","small"],description:"Tamaño del componente",table:{type:{summary:"ComponentSize"},defaultValue:{summary:"default"}}},controls:{control:"boolean",description:"Mostrar botones de control",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}},controlsPosition:{control:"select",options:["","right"],description:"Posición de los controles",table:{type:{summary:'"" | "right"'},defaultValue:{summary:'""'}}},valueOnClear:{control:"select",options:["min","max",0,null],description:"Valor al limpiar el input",table:{type:{summary:'"min" | "max" | number | null'},defaultValue:{summary:"null"}}},name:{control:"text",description:"Atributo name nativo",table:{type:{summary:"string"},defaultValue:{summary:"undefined"}}},placeholder:{control:"text",description:"Texto de ayuda (placeholder)",table:{type:{summary:"string"},defaultValue:{summary:"undefined"}}},precision:{control:"number",description:"Precisión de decimales",table:{type:{summary:"number"},defaultValue:{summary:"undefined"}}},validateEvent:{control:"boolean",description:"Activar validación de formulario",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}},ariaLabel:{control:"text",description:"Etiqueta aria-label nativa",table:{type:{summary:"string"},defaultValue:{summary:"undefined"}}},inputmode:{control:"text",description:"Modo de entrada nativo",table:{type:{summary:"string"},defaultValue:{summary:"undefined"}}},align:{control:"select",options:["left","right","center"],description:"Alineación del texto",table:{type:{summary:'"left" | "right" | "center"'},defaultValue:{summary:"center"}}},disabledScientific:{control:"boolean",description:"Deshabilitar notación científica (e.g. 'e', 'E')",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},prefix:{description:"Contenido personalizado al inicio del input",table:{category:"Slots",type:{summary:"slot"}}},suffix:{description:"Contenido personalizado al final del input",table:{category:"Slots",type:{summary:"slot"}}},onChange:{action:"change",description:"Se dispara cuando el valor cambia",table:{category:"Eventos",type:{summary:"(cur: number | undefined, prev: number | undefined) => void"}}},onInput:{action:"input",description:"Se dispara cuando el input cambia",table:{category:"Eventos",type:{summary:"(val: number | null | undefined) => void"}}},onFocus:{action:"focus",description:"Se dispara cuando el input obtiene foco",table:{category:"Eventos",type:{summary:"(event: FocusEvent) => void"}}},onBlur:{action:"blur",description:"Se dispara cuando el input pierde foco",table:{category:"Eventos",type:{summary:"(event: FocusEvent) => void"}}}}},V=n=>({components:{GInputNumber:g,GConfigProvider:v},setup(){const s=i(n.modelValue??1);return se(()=>n.modelValue,m=>{s.value=m??1}),{args:n,modelValue:s}},template:`
  ...
  `}),M={name:"Por defecto",parameters:{docs:{description:{story:"Ejemplo de uso del componente `g-input-number` con sus propiedades por defecto."}}},render:V,args:{modelValue:1,placeholder:"Ingresa un número"}},U={name:"Deshabilitado",parameters:{docs:{description:{story:"Ejemplo de uso del componente `g-input-number` deshabilitado."}}},render:V,args:{modelValue:1,disabled:!0,placeholder:"Input deshabilitado"}},_={name:"Solo lectura",parameters:{docs:{description:{story:"Si no se requiere que el valor pueda ser modificado, activa esta propiedad."}}},render:V,args:{modelValue:1,readonly:!0,placeholder:"Input solo lectura"}},w={name:"Controles a la derecha",parameters:{docs:{description:{story:"Ejemplo de uso del componente `g-input-number` con los controles a la derecha."}}},render:V,args:{modelValue:1,controlsPosition:"right"}},k={name:"Paso estricto",parameters:{docs:{description:{story:"Si necesitas que el valor sea siempre múltiplo del paso, activa esta propiedad."}}},render:V,args:{modelValue:2,step:2,stepStrictly:!0}},F={name:"Min/Max",parameters:{docs:{description:{story:"Si necesitas limitar el valor mínimo y máximo, limita el valor con las propiedades `min` y `max`."}}},render:V,args:{modelValue:5,min:0,max:10}},B={name:"Tamaño",parameters:{docs:{description:{story:"Usa el atributo `size` para configurar tamaños adicionales `large`, `default` o `small`."}}},render:()=>({components:{GInputNumber:g,GConfigProvider:v},setup(){const n=i(1),s=i(3),m=i(7);return{defaultValue:n,smallValue:s,largeValue:m}},template:`
      <g-config-provider>
...
}`,...K.parameters?.docs?.source}}};const In=["Default","Disabled","Readonly","ControlsRight","StepStrictly","MinMax","Size","Alignment","WithoutControls","CustomStep","DecimalPrecision","WithPlaceholder","AllSizes","WithPrefixSuffix"];export{$ as Alignment,W as AllSizes,w as ControlsRight,j as CustomStep,L as DecimalPrecision,M as Default,U as Disabled,F as MinMax,_ as Readonly,B as Size,k as StepStrictly,O as WithPlaceholder,K as WithPrefixSuffix,q as WithoutControls,In as __namedExportsOrder,En as default};
