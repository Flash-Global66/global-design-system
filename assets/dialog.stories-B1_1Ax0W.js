import{o as ue,B as De,C as xe,g as Ve,r as c,c as k,w as ie,D as ke,d as pe,a as ne,x as L,e as V,m as N,k as _,l as h,u as a,h as ae,s as H,y as re,F as Ae,z as Be,b as te,f as T,A as Ee,n as me,T as we,j as ze,p as Se,q as Te,v as Ie,E as Me}from"./vue.esm-bundler-DNj4lB-B.js";import{a as Fe,O as Ge,G as Pe}from"./index-DwSrO8lq.js";import{u as Le,G as je,a as Oe}from"./index-BTYE5co3.js";import{o as fe,q as Ne,l as de,a as qe,u as $e}from"./install-B47IWttr.js";import{U as be}from"./event-HEVJa2N9.js";import{u as We,f as Re,G as I}from"./ConfigProvider-Dyindn-M.js";import{u as ce}from"./index-CKHqQBpj.js";import{b as le}from"./style-DaKCY8yC.js";import{i as Ue}from"./index-C250A6Bf.js";import{u as ge}from"./index-BkReybPT.js";import{x as Xe}from"./index-BbXnaqKc.js";import{y as Ye}from"./index-kyV-7f56.js";import{c as Ke}from"./refs-DjqKERfo.js";import{G as M}from"./index-Yv_bRTCK.js";import"./aria-BUADUvnR.js";import"./error-Cq9Fpw4b.js";import"./vnode-CPDT7u0G.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-C0ZH0EVy.js";import"./_arrayPush-BERo1YoZ.js";const He=(e,o,i,l)=>{const g={offsetX:0,offsetY:0},r=(p,d)=>{if(e.value){const{offsetX:v,offsetY:C}=g,m=e.value.getBoundingClientRect(),f=m.left,b=m.top,B=m.width,s=m.height,E=document.documentElement.clientWidth,w=document.documentElement.clientHeight,G=-f+v,Z=-b+C,J=E-f-B+v,j=w-b-s+C;l?.value||(p=Math.min(Math.max(p,G),J),d=Math.min(Math.max(d,Z),j)),g.offsetX=p,g.offsetY=d,e.value.style.transform=`translate(${le(p)}, ${le(d)})`}},D=p=>{const d=p.clientX,v=p.clientY,{offsetX:C,offsetY:m}=g,f=B=>{const s=C+B.clientX-d,E=m+B.clientY-v;r(s,E)},b=()=>{document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",b)};document.addEventListener("mousemove",f),document.addEventListener("mouseup",b)},x=()=>{o.value&&e.value&&(o.value.addEventListener("mousedown",D),window.addEventListener("resize",u))},n=()=>{o.value&&e.value&&(o.value.removeEventListener("mousedown",D),window.removeEventListener("resize",u))},F=()=>{g.offsetX=0,g.offsetY=0,e.value&&(e.value.style.transform="")},u=()=>{const{offsetX:p,offsetY:d}=g;r(p,d)};return ue(()=>{De(()=>{i.value?x():n()})}),xe(()=>{n()}),{resetPosition:F,updatePosition:u}},ve=Symbol("dialogInjectionKey"),Ce=fe({fullscreen:Boolean,draggable:Boolean,overflow:{type:Boolean,default:!0},alignCenter:{type:Boolean,default:!1},sizeMode:{type:String,values:["default","fixed","adaptive"],default:"default"},title:{type:String,default:""},headerClass:String,bodyClass:String,footerClass:String,showClose:{type:Boolean,default:!0},width:{type:[String,Number]},ariaLevel:{type:String,default:"2"},footerButtons:{type:Array,default:()=>[]}}),Ze=e=>{const{sizeMode:o,width:i}=e;o==="fixed"&&(!i||i==="")&&console.warn('[g-dialog] When sizeMode is set to "fixed", width must be defined.')},Je={close:()=>!0},Qe=fe({...Ce,appendToBody:{type:Boolean,default:!1},appendTo:{type:de([String,Object]),default:"body"},beforeClose:{type:de(Function)},destroyOnClose:{type:Boolean,default:!1},closeOnClickModal:{type:Boolean,default:!0},closeOnPressEscape:{type:Boolean,default:!0},lockScroll:{type:Boolean,default:!0},modal:{type:Boolean,default:!0},openDelay:{type:Number,default:0},closeDelay:{type:Number,default:0},top:{type:String},modelValue:Boolean,modalClass:String,headerClass:String,bodyClass:String,footerClass:String,width:{type:[String,Number]},zIndex:{type:Number},trapFocus:{type:Boolean,default:!0},ariaLevel:{type:String,default:"2"}}),_e={open:()=>!0,opened:()=>!0,close:()=>!0,closed:()=>!0,[be]:e=>Ne(e),openAutoFocus:()=>!0,closeAutoFocus:()=>!0},eo=(e,o,{closeOnClickModal:i,closeOnPressEscape:l})=>{const r=Ve().emit,{nextZIndex:D}=We();let x="";const n=ce(),F=ce(),u=c(!1),p=c(!1),d=c(!1),v=c(e.zIndex??D()),C=k(()=>e.footerButtons?.slice(0,3)||[]),m=k(()=>C.value.length===3?"layout-dual-row":"layout-single-column");let f,b;const s=Re("namespace","gui"),E=k(()=>{const y={},se=`--${s.value}-dialog`;return e.fullscreen||(e.top&&(y[`${se}-margin-top`]=e.top),e.width&&(y[`${se}-width`]=le(e.width))),y}),w=k(()=>e.alignCenter?{display:"flex"}:{});function G(){r("opened")}function Z(){r("closed"),r(be,!1),e.destroyOnClose&&(d.value=!1)}function J(){r("close")}function j(){b?.(),f?.(),e.openDelay&&e.openDelay>0?{stop:f}=ge(()=>oe(),e.openDelay):oe()}function ee(){f?.(),b?.(),e.closeDelay&&e.closeDelay>0?{stop:b}=ge(()=>O(),e.closeDelay):O()}const Q=()=>{e.showClose&&(e.beforeClose?e.beforeClose(O):O())};function z(){i.value&&Q()}function oe(){qe&&(u.value=!0)}function O(){u.value=!1}function t(){r("openAutoFocus")}function S(){r("closeAutoFocus")}function P(y){y.detail?.focusReason==="pointer"&&y.preventDefault()}e.lockScroll&&Le(u);function he(){l.value&&Q()}return ie(()=>e.modelValue,y=>{y?(p.value=!1,j(),d.value=!0,v.value=Ue(e.zIndex)?D():v.value++,ke(()=>{r("open"),o.value&&(o.value.parentElement.scrollTop=0,o.value.parentElement.scrollLeft=0,o.value.scrollTop=0)})):u.value&&ee()}),ie(()=>e.fullscreen,y=>{o.value&&(y?(x=o.value.style.transform,o.value.style.transform=""):o.value.style.transform=x)}),ue(()=>{e.modelValue&&(u.value=!0,d.value=!0,j())}),{afterEnter:G,afterLeave:Z,beforeLeave:J,handleClose:Q,onModalClick:z,close:ee,doClose:O,onOpenAutoFocus:t,onCloseAutoFocus:S,onCloseRequested:he,onFocusoutPrevented:P,titleId:n,bodyId:F,closed:p,style:E,overlayDialogStyle:w,rendered:d,visible:u,zIndex:v,displayButtons:C,buttonLayoutClass:m}},oo=["id"],ao=["aria-level"],ye=pe({__name:"dialog-content",props:Ce,emits:Je,setup(e,{expose:o,emit:i}){const l=e,g=i;Ze(l);const{dialogRef:r,headerRef:D,bodyId:x,ns:n,style:F,displayButtons:u,buttonLayoutClass:p}=ne(ve),{focusTrapRef:d}=ne(Fe,{focusTrapRef:r,onKeydown:()=>{}}),v=k(()=>{const s=l.fullscreen?"fullscreen":l.sizeMode||"default";return[n.b(),n.is("draggable",l.draggable),n.is("align-center",l.alignCenter),n.is(s)]}),C=Ke(d,r),m=k(()=>l.draggable&&!l.fullscreen),f=k(()=>l.overflow),{resetPosition:b}=He(r,r,m,f);o({resetPosition:b});const B=()=>{g("close")};return(s,E)=>(V(),L("div",{ref:a(C),class:h(v.value),style:me(a(F)),tabindex:"-1"},[s.showClose?(V(),L("header",{key:0,ref_key:"headerRef",ref:D,class:h([a(n).e("header"),s.headerClass])},[s.showClose?(V(),L("button",{key:0,"aria-label":"Close",class:h(a(n).e("headerbtn")),type:"button",onClick:B},[ae(a(Xe),{name:"regular times",class:h(a(n).e("close"))},null,8,["class"])],2)):N("",!0)],2)):N("",!0),_("div",{id:a(x),class:h([a(n).e("body"),s.bodyClass])},[_("div",null,[s.$slots.image?(V(),L("div",{key:0,class:h(a(n).e("image"))},[H(s.$slots,"image")],2)):N("",!0),s.title?(V(),L("span",{key:1,class:h(a(n).e("title")),role:"heading","aria-level":s.ariaLevel},re(s.title),11,ao)):N("",!0),_("div",{class:h(a(n).e("content"))},[H(s.$slots,"default")],2)])],10,oo),_("footer",{class:h([a(n).e("footer"),s.footerClass])},[H(s.$slots,"footer",{},()=>[l.footerButtons?.length?(V(),L("div",{key:0,class:h([a(n).e("footer-buttons"),a(p)])},[(V(!0),L(Ae,null,Be(a(u),(w,G)=>(V(),te(a(Ye),{key:G,variant:w.variant,full:"",onClick:w.onClick},{default:T(()=>[Ee(re(w.text),1)]),_:2},1032,["variant","onClick"]))),128))],2)):N("",!0)])],2)],6))}});ye.__docgenInfo={exportName:"default",displayName:"dialog-content",description:"",tags:{},expose:[{name:"resetPosition"}],slots:[{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog-content.vue"]};const to=["aria-label","aria-labelledby","aria-describedby"],A=pe({__name:"dialog",props:Qe,emits:_e,setup(e,{expose:o,emit:i}){const l=e,g=$e("dialog"),r=c(),D=c(),x=c(),n=k(()=>l.showClose&&l.closeOnClickModal),F=k(()=>l.showClose&&l.closeOnPressEscape),{visible:u,titleId:p,bodyId:d,style:v,overlayDialogStyle:C,rendered:m,zIndex:f,afterEnter:b,afterLeave:B,beforeLeave:s,handleClose:E,onModalClick:w,onOpenAutoFocus:G,onCloseAutoFocus:Z,onCloseRequested:J,onFocusoutPrevented:j,displayButtons:ee,buttonLayoutClass:Q}=eo(l,r,{closeOnClickModal:n,closeOnPressEscape:F});Me(ve,{dialogRef:r,headerRef:D,bodyId:d,ns:g,rendered:m,style:v,displayButtons:ee,buttonLayoutClass:Q});const z=Oe(w),oe=k(()=>l.draggable&&!l.fullscreen);return o({visible:u,dialogContentRef:x,resetPosition:()=>{x.value?.resetPosition()}}),(t,S)=>(V(),te(a(Pe),{to:t.appendTo,disabled:t.appendTo!=="body"?!1:!t.appendToBody},{default:T(()=>[ae(we,{name:"dialog-fade",onAfterEnter:a(b),onAfterLeave:a(B),onBeforeLeave:a(s)},{default:T(()=>[ze(ae(a(je),{"custom-mask-event":"",mask:t.modal,"overlay-class":t.modalClass,"z-index":a(f)},{default:T(()=>[_("div",{role:"dialog","aria-modal":"true","aria-label":t.title||void 0,"aria-labelledby":t.title?void 0:a(p),"aria-describedby":a(d),class:h(`${a(g).namespace.value}-overlay-dialog`),style:me(a(C)),onClick:S[0]||(S[0]=(...P)=>a(z).onClick&&a(z).onClick(...P)),onMousedown:S[1]||(S[1]=(...P)=>a(z).onMousedown&&a(z).onMousedown(...P)),onMouseup:S[2]||(S[2]=(...P)=>a(z).onMouseup&&a(z).onMouseup(...P))},[ae(a(Ge),{loop:"",trapped:a(u),"focus-start-el":"container",onFocusAfterTrapped:a(G),onFocusAfterReleased:a(Z),onFocusoutPrevented:a(j),onReleaseRequested:a(J)},{default:T(()=>[a(m)?(V(),te(ye,Se({key:0,ref_key:"dialogContentRef",ref:x},t.$attrs,{"align-center":t.alignCenter,draggable:oe.value,overflow:t.overflow,fullscreen:t.fullscreen,"header-class":t.headerClass,"body-class":t.bodyClass,"footer-class":t.footerClass,"show-close":t.showClose,title:t.title,"aria-level":t.ariaLevel,width:t.width,"size-mode":t.sizeMode,"footer-buttons":t.footerButtons,onClose:a(E)}),Te({default:T(()=>[H(t.$slots,"default")]),_:2},[t.$slots.image?{name:"image",fn:T(()=>[H(t.$slots,"image")]),key:"0"}:void 0,t.$slots.footer?{name:"footer",fn:T(()=>[H(t.$slots,"footer")]),key:"1"}:void 0]),1040,["align-center","draggable","overflow","fullscreen","header-class","body-class","footer-class","show-close","title","aria-level","width","size-mode","footer-buttons","onClose"])):N("",!0)]),_:3},8,["trapped","onFocusAfterTrapped","onFocusAfterReleased","onFocusoutPrevented","onReleaseRequested"])],46,to)]),_:3},8,["mask","overlay-class","z-index"]),[[Ie,a(u)]])]),_:3},8,["onAfterEnter","onAfterLeave","onBeforeLeave"])]),_:3},8,["to","disabled"]))}});A.__docgenInfo={exportName:"default",displayName:"dialog",description:"",tags:{},expose:[{name:"visible",tags:[{title:"description",content:"whether the dialog is visible"}]},{name:"dialogContentRef"},{name:"resetPosition"}],slots:[{name:"image"},{name:"default"},{name:"footer"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/dialog/src/dialog.vue"]};const lo="1.1.2",Fo={title:"Data/Dialog",component:A,argTypes:{modelValue:{control:"boolean",description:"Controla la visibilidad del dialog",table:{defaultValue:{summary:"false"}}},title:{control:"text",description:"Título del dialog",table:{defaultValue:{summary:""}}},width:{control:"text",description:"Ancho del dialog. Requiere size-mode='fixed'.",table:{defaultValue:{summary:"undefined"}}},sizeMode:{control:"select",options:["default","fixed","adaptive"],description:`Controla el comportamiento del ancho del dialog:
...
<\/script>`}}};const no=e=>({components:{GDialog:A,GConfigProvider:I,GButton:M},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
  ...
  `}),W=no.bind({});W.args={title:"Mensaje Importante",showClose:!1,sizeMode:"default"};W.parameters={docs:{description:{story:"Dialog sin botón de cerrar, con texto y un solo botón."},source:{code:`
<template>
  <g-dialog
    v-model="dialogVisible"
    title="Mensaje Importante"
...
<\/script>`,language:"html",type:"auto"}}};const ro=e=>({components:{GDialog:A,GConfigProvider:I,GButton:M},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
  ...
  `}),R=ro.bind({});R.args={title:"Dialog con Ancho Personalizado",showClose:!0,width:"800",sizeMode:"fixed"};R.parameters={docs:{description:{story:"Dialog con ancho personalizado definido a 800px. Requiere size-mode='fixed'"},source:{code:`
<template>
  <g-dialog
    v-model="dialogVisible"
    title="Dialog con Ancho Personalizado"
...
<\/script>`,language:"html",type:"auto"}}};const co=e=>({components:{GDialog:A,GConfigProvider:I,GButton:M},setup(){const o=c(!1);return{args:e,dialogVisible:o,handleClose:()=>{o.value=!1}}},template:`
  ...
  `}),U=co.bind({});U.args={title:"Dialog Adaptable",showClose:!0,sizeMode:"adaptive"};U.parameters={docs:{description:{story:"Dialog que se adapta al contenido, útil para imágenes grandes o contenido variable."},source:{code:`
<template>
  <g-dialog
    v-model="dialogVisible"
    title="Dialog Adaptable"
...
>
  ...
  \`
})`,...$.parameters?.docs?.source}}};W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`args => ({
  components: {
    GDialog,
    GConfigProvider,
    GButton
  ...
  \`
})`,...K.parameters?.docs?.source}}};const Go=["Basic","WithImage","NoCloseButton","CustomWidth","WithLargeImage","TwoButtonsStacked","ThreeButtonsLayout","SizeModeComparison"];export{q as Basic,R as CustomWidth,W as NoCloseButton,K as SizeModeComparison,Y as ThreeButtonsLayout,X as TwoButtonsStacked,$ as WithImage,U as WithLargeImage,Go as __namedExportsOrder,Fo as default};
