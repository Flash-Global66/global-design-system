import{G as t}from"./ConfigProvider-7dg58IlU.js";import"./iframe-Dct5CHxr.js";import"./preload-helper-Dch09mLN.js";import"./useEmptyValues-BnYvcW4O.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const x={title:"Colores/Semantic",parameters:{docs:{description:{component:`
...
> **Nota**: Click en cualquier color copia su nombre semántico al portapapeles. 📋
        `}}}},n=()=>({components:{GConfigProvider:t},template:`
  <g-config-provider>
  ...
  `,setup(){return{handleColorClick:async e=>{try{await navigator.clipboard.writeText(e)}catch(r){console.error("Error al copiar:",r)}}}}}),l=n.bind({}),p=["Default"];l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`() => ({
  components: {
    GConfigProvider
  },
  template: \`
...
})`,...l.parameters?.docs?.source}}};export{l as Default,p as __namedExportsOrder,x as default};
