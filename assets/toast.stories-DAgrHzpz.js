import{d as ee,r as oe,c as b,o as te,b as W,e as w,f as se,j as $,k as G,n as F,l as g,u as i,h as H,m as R,x as A,s as ae,y as re,v as Q,a1 as ne,T as ie,R as N,i as O,G as ce,aj as Z}from"./vue.esm-bundler-C43JrhH2.js";import{u as le}from"./index-BDKGuxIf.js";import{O as _}from"./index-CdzPrvh_.js";import{b as pe,d as E,w as de,a as ue}from"./install-CfJGiCvs.js";import{u as me,G as m}from"./ConfigProvider-DGM6yYEs.js";import{u as fe,a as ge,h as X,v as ye}from"./index-DRaHcUI8.js";import{E as q}from"./aria-BUADUvnR.js";import{u as he}from"./index-DmfABaPz.js";import{G as y}from"./index-m5O_vOKZ.js";import{a as we,b as ve}from"./documentation-stories-BqZmL7Rs.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./error-Cq9Fpw4b.js";import"./index-CRgYr9aG.js";import"./index-fhkPmQjX.js";import"./_arrayPush-C7rDDJbA.js";import"./index-CvPWi8JN.js";import"./index-BYyjWRO2.js";import"./index-kkjQPABY.js";const J=["success","info","warning","error"],Te=["sm","md"],be=pe({customClass:{type:String,default:""},dangerouslyUseHTMLString:Boolean,duration:{type:Number,default:5e3},id:{type:String,default:""},message:{type:E([String,Object,Function]),default:""},offset:{type:Number,default:0},onClick:{type:E(Function),default:()=>{}},onClose:{type:E(Function),required:!0},position:{type:String,values:["top-right","top-left","bottom-right","bottom-left"],default:"top-right"},showClose:{type:Boolean,default:!0},showProgress:{type:Boolean,default:!0},size:{type:String,values:Te,default:"md"},type:{type:String,values:J,required:!0},zIndex:Number}),Ge={destroy:()=>!0},Ce=["id"],Pe={key:0},Be=["innerHTML"],z=ee({name:"GToast",__name:"toast",props:be,emits:Ge,setup(e,{expose:s}){const t=e,{nextZIndex:c,currentZIndex:d}=me(),r=fe("toast"),n=oe(!1);let p;const u={success:"solid check-circle",info:"solid info-circle",warning:"solid exclamation-triangle",error:"solid times-circle"},l=b(()=>u[t.type]),f=b(()=>t.position.endsWith("right")?"right":"left"),h=b(()=>t.position.startsWith("top")?"top":"bottom"),I=b(()=>({[h.value]:`${t.offset}px`,zIndex:t.zIndex??d.value}));function j(){if(t.duration>0){const{stop:a}=he(()=>{n.value&&v()},t.duration);p=a}}function V(){p?.()}function v(){n.value=!1}function Y({code:a}){a===q.delete||a===q.backspace?V():a===q.esc?n.value&&v():j()}return te(()=>{j(),c(),n.value=!0}),le(document,"keydown",Y),s({visible:n,close:v}),(a,T)=>(w(),W(ie,{name:i(r).b("fade"),onBeforeLeave:a.onClose,onAfterLeave:T[1]||(T[1]=U=>a.$emit("destroy"))},{default:se(()=>[$(G("div",{id:a.id,class:g([i(r).b(),i(r).m(t.type),i(r).m(t.size),a.customClass,f.value]),style:F(I.value),role:"alert",onMouseenter:V,onMouseleave:j,onClick:T[0]||(T[0]=(...U)=>a.onClick&&a.onClick(...U))},[H(i(_),{class:g([i(r).e("icon"),i(r).m(t.type)]),name:l.value},null,8,["class","name"]),G("div",{class:g(i(r).e("group"))},[$(G("div",{class:g(i(r).e("content"))},[ae(a.$slots,"default",{},()=>[a.dangerouslyUseHTMLString?(w(),A("p",{key:1,innerHTML:a.message},null,8,Be)):(w(),A("p",Pe,re(a.message),1))])],2),[[Q,a.message]])],2),a.showClose?(w(),W(i(_),{key:0,class:g(i(r).e("closeBtn")),onClick:ne(v,["stop"]),name:"solid times"},null,8,["class"])):R("",!0),a.showProgress&&a.duration>0?(w(),A("div",{key:1,class:g(i(r).e("progress"))},[G("div",{class:g([i(r).e("progress-bar"),i(r).m(t.type)]),style:F({animationDuration:`${a.duration}ms`})},null,6)],2)):R("",!0)],46,Ce),[[Q,n.value]])]),_:3},8,["name","onBeforeLeave"]))}});z.__docgenInfo={name:"GToast",exportName:"default",displayName:"toast",description:"",tags:{},expose:[{name:"visible"},{name:"close",tags:[{title:"description",content:"close notification"}]}],events:[{name:"destroy"}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/global-design-system/global-design-system/components/toast/src/toast.vue"]};const L={"top-left":[],"top-right":[],"bottom-left":[],"bottom-right":[]},D=16;let xe=1;const o=function(e={},s){if(!ge)return{close:()=>{}};(N(e)||O(e))&&(e={message:e});const t=e.position||"top-right";let c=e.offset||0;L[t].forEach(({vm:h})=>{c+=(h.el?.offsetHeight||0)+D}),c+=D;const d=`toast_${xe++}`,r=e.onClose,n={...e,offset:c,id:d,onClose:()=>{Me(d,t,r)}};let p=document.body;X(e.appendTo)?p=e.appendTo:N(e.appendTo)&&(p=document.querySelector(e.appendTo)),X(p)||(p=document.body);const u=document.createElement("div"),l=H(z,n,ce(n.message)?n.message:O(n.message)?()=>n.message:null),f=H(m,{},{default:()=>l});return f.appContext=ye(s)?o._context:s,f.props.onDestroy=()=>{Z(null,u)},Z(f,u),L[t].push({vm:l}),p.appendChild(u.firstElementChild),{close:()=>{l.component.exposed.visible.value=!1}}};J.forEach(e=>{o[e]=(s={},t)=>((N(s)||O(s))&&(s={message:s}),o({...s,type:e},t))});function Me(e,s,t){const c=L[s],d=c.findIndex(({vm:l})=>l.component?.props.id===e);if(d===-1)return;const{vm:r}=c[d];if(!r)return;t?.(r);const n=r.el.offsetHeight,p=s.split("-")[0];c.splice(d,1);const u=c.length;if(!(u<1))for(let l=d;l<u;l++){const{el:f,component:h}=c[l].vm,I=Number.parseInt(f.style[p],10)-n-D;h.props.offset=I}}function Se(){for(const e of Object.values(L))e.forEach(({vm:s})=>{s.component.exposed.visible.value=!1})}o.closeAll=Se;o._context=null;const ke=de(z,{Toast:z});ue(o,"$toastify");const ze="1.1.0",K={"@flash-global66/g-icon-font":"^0.10.0","@vueuse/core":"^12.4.0","element-plus":"^2.9.0",vue:"^3.2.0"},_e={title:"Feedback/Toast",component:ke,parameters:{docs:{description:{component:`
