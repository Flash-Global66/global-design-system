...
<g-switch v-model="value" size="small" />`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=t(!0),n=t(!0),c=t(!0);return{valueLarge:a,valueDefault:n,valueSmall:c}},template:`
    ...
    `})},P={name:"Descripción de texto",parameters:{docs:{description:{story:"Puedes agregar los atributos active-text e inactive-text para mostrar textos. Usa el atributo inline-prompt para controlar si el texto se muestra dentro del punto."},source:{code:`<!-- Con texto -->
<g-switch
  v-model="value"
...
/>`}}},render:()=>({components:{GSwitch:d,GConfigProvider:m},setup(){const a=t(!0),n=t(!0),c=t(!0),i=t(!0);return{value1:a,value2:n,value3:c,value4:i}},template:`
    ...
    `})},I={name:"Iconos personalizados",parameters:{docs:{description:{story:"Puedes agregar los atributos active-icon e inactive-icon para mostrar iconos. Usa el atributo inline-prompt para controlar si el icono se muestra dentro del punto."},source:{code:`<!-- Aprobado/Rechazado -->
<g-switch
  v-model="value"
  active-icon="solid check"
  inactive-icon="solid times"
...
}`,...G.parameters?.docs?.source}}};const wa=["Primary","Sizes","TextDescription","CustomIcons","ExtendedValueTypes","Disabled","Loading","PreventSwitching","CustomActionIcons","CustomActionSlots","CustomWidth","FormValidation"];export{E as CustomActionIcons,O as CustomActionSlots,I as CustomIcons,z as CustomWidth,V as Disabled,T as ExtendedValueTypes,G as FormValidation,k as Loading,F as PreventSwitching,N as Primary,A as Sizes,P as TextDescription,wa as __namedExportsOrder,xa as default};
