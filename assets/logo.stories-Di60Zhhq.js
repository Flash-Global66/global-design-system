...
import { GLogo } from '@flash-global66/g-logo';
<\/script>
`,language:"html"}}}},V={name:"Todos los logos",render:()=>({components:{GLogo:h,GConfigProvider:z,GSegmented:eo},setup(){const o="__natural__",m=_(o),t=[{label:"Original",value:o},...Object.keys(v).map(r=>({label:r.toUpperCase(),value:r}))];return{LOGO_GROUPS:Oo,LOGO_NAMES:A,selectedSize:m,sizeOptions:t,isOnDark:r=>r.endsWith("-on-dark"),logoSizeProps:r=>r===o?{}:{size:r}}},template:`
      <g-config-provider>
...
}`,...j.parameters?.docs?.source}}};const Zo=["Primary","AllLogos","Sizes","SizeCustom","Colors","Filters","ErrorHandling"];export{V as AllLogos,C as Colors,j as ErrorHandling,w as Filters,D as Primary,T as SizeCustom,R as Sizes,Zo as __namedExportsOrder,Ho as default};
