...
const render: Story['render'] = (args) => ({
  ...
  template: '<g-input-number v-bind="args" v-model="modelValue" />',
})
...
export const WithoutControls: Story = {
  ...
  render: () => ({
    ...
    template: '<g-input-number v-model="modelValue" :controls="false" />',
  }),
}
...
export const WithPlaceholder: Story = {
  ...
  render: () => ({
    ...
    template: '<g-input-number v-model="modelValue" placeholder="Ingresa un número" />',
  }),
}
